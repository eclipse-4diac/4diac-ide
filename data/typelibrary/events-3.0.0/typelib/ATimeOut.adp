...
<AdapterType Name="ATimeOut" Comment="Interface for a time out service roughly based on the definitions of ROOM">
	...
	<InterfaceList>
		...
		<EventOutputs>
			<Event Name="START" Type="Event" Comment="start timeout notification">
				<With Var="DT"/>
			</Event>
