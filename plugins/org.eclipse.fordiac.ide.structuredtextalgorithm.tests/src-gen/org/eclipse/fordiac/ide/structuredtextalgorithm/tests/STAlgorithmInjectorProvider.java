...
public class STAlgorithmInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new STAlgorithmStandaloneSetup() {
			@Override
	...
	protected STAlgorithmRuntimeModule createRuntimeModule() {
		...
		return new STAlgorithmRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return STAlgorithmInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
