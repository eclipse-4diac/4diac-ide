...
import org.eclipse.fordiac.ide.structuredtextcore.ide.contentassist.antlr.PartialSTCoreContentAssistParser;
import org.eclipse.fordiac.ide.structuredtextcore.ide.contentassist.antlr.STCoreParser;
import org.eclipse.fordiac.ide.structuredtextcore.ide.contentassist.antlr.lexer.InternalSTCoreLexer;
import org.eclipse.fordiac.ide.structuredtextcore.ui.codemining.STCoreCodeMiningProvider;
...
/**
 * Manual modifications go to {@link STCoreUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractSTCoreUiModule extends DefaultUiModule {

	public AbstractSTCoreUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.eclipse.fordiac.ide.structuredtextcore.parser.antlr.lexer.InternalSTCoreLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalSTCoreLexer.class).toProvider(LexerProvider.create(InternalSTCoreLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return STCoreValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return STCoreLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(STCoreDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return STCoreOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return STCoreQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return STCoreProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialSTCoreContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("STCore Compare");
	}
