...
public class FordiacMarkerResolutionGenerator implements IMarkerResolutionGenerator2 {
	...
	public IMarkerResolution[] getResolutions(final IMarker marker) {
		...
		case LibraryElementValidator.ERROR_MARKER_INTERFACE__VALIDATE_ATTRIBUTES -> Stream.concat(
				Stream.of(new CreateAttributMarkerResolution(marker), new ChangeAttributeMarkerResolution(marker)),
	...
	public boolean hasResolutions(final IMarker marker) {
		...
		return LibraryElementValidator.DIAGNOSTIC_SOURCE.equals(FordiacErrorMarker.getSource(marker))
				&& (LibraryElementValidator.ITYPED_ELEMENT__VALIDATE_TYPE == code
						...
						|| LibraryElementValidator.ERROR_MARKER_INTERFACE__VALIDATE_ATTRIBUTES == code);
	}
}
