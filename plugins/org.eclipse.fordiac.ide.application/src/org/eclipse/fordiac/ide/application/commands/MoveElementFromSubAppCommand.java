...
public class MoveElementFromSubAppCommand extends Command {
	...
	private void positionElement(final FBNetworkElement element, final Position pos) {
		...
		case CONTEXT_MENU:
			...
			final int xOffset = 0;
			final int yOffset = positionBlocks(FB_DISTANCE).y;
	...
	private Point positionBlocks(final int FB_DISTANCE) {
		int yOffset;
	...
	private void handleConnection(final Connection con, final IInterfaceElement opposite,
