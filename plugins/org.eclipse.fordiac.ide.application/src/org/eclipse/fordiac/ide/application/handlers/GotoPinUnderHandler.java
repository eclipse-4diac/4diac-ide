...
public class GotoPinUnderHandler extends AbstractHandler {
	...
	private static IInterfaceElement getFollowingInputPin(final InterfaceEditPart pin,
		...
		if (inputList.indexOf(pin.getModel()) == (inputList.size() - 1)) {
			return (IInterfaceElement) inputList.get(0);
		}
	...
	private static IInterfaceElement getFollowingOutputPin(final InterfaceEditPart pin,
		...
		if (outputList.indexOf(pin.getModel()) == (outputList.size() - 1)) {
			return (IInterfaceElement) outputList.get(0);
		}
