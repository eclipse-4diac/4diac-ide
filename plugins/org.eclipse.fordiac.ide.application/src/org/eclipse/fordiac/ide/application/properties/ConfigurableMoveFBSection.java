...
public class ConfigurableMoveFBSection extends AbstractSection implements CommandStackEventListener {
	...
	private void createDataTypeSelector(final Composite composite) {
		...
		getWidgetFactory().createLabel(structComp, Messages.ConfigurableMoveFBSection_DataType);
	...
	private void createMemberAccessTables(final Composite parent) {
		...
		GridDataFactory.fillDefaults().align(SWT.FILL, SWT.FILL).grab(true, true).applyTo(memberAccessComp);

		inputDataMemberAccessViewer = new MemberAccessViewer(true, this);
		inputDataMemberAccessViewer.createControls(memberAccessComp, getWidgetFactory());

		outputDataMemberAccessViewer = new MemberAccessViewer(false, this);
		outputDataMemberAccessViewer.createControls(memberAccessComp, getWidgetFactory());
	}
