...
public class DemultiplexerFilter implements IFilter {
	...
	public boolean select(final Object toTest) {
		return toTest instanceof DemultiplexerEditPart || (toTest instanceof final StructInterfaceEditPart structIEP
				&& structIEP.getParent() instanceof DemultiplexerEditPart);
	}
}
