...
public interface MonitoringBaseFactory extends EFactory {
	 ...
	 * @generated
	 */
	MonitoringBaseFactory eINSTANCE = org.eclipse.fordiac.ide.deployment.monitoringbase.impl.MonitoringBaseFactoryImpl
			.init();

	/**
	 * Returns a new object of class '<em>Port Element</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
