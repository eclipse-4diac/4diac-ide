 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fordiac.ide.deployment.devResponse.impl.DataTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataTypeImpl extends EObjectImpl implements DataType {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DevResponsePackage.DATA_TYPE__NAME, oldName, name));
		}
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DevResponsePackage.DATA_TYPE__NAME:
				return getName();
			default:
