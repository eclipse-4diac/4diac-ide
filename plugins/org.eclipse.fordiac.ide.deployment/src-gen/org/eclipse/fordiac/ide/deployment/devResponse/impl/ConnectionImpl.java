 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fordiac.ide.deployment.devResponse.impl.ConnectionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.eclipse.fordiac.ide.deployment.devResponse.impl.ConnectionImpl#getDestination <em>Destination</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectionImpl extends EObjectImpl implements Connection {
	...
	public void setSource(String newSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DevResponsePackage.CONNECTION__SOURCE, oldSource, source));
	}
	...
	public void setDestination(String newDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DevResponsePackage.CONNECTION__DESTINATION, oldDestination, destination));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DevResponsePackage.CONNECTION__SOURCE:
				return getSource();
