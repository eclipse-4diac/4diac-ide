 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.deployment.monitoringbase.PortElement#getFb
 * <em>Fb</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.deployment.monitoringbase.PortElement#getInterfaceElement
 * <em>Interface Element</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.deployment.monitoringbase.PortElement#getResource
 * <em>Resource</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.deployment.monitoringbase.PortElement#getHierarchy
 * <em>Hierarchy</em>}</li>
 * </ul>
 *
...
public interface PortElement extends EObject {
	/**
	 * Returns the value of the '<em><b>Fb</b></em>' reference. <!-- begin-user-doc
	 * -->
	 * <p>
	 ...
	 * <em>Fb</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Interface Element</em>}' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Hierarchy</b></em>' attribute list. The list
	 ...
	 *        {\r\n\t\t\thierarchy += element; \r\n\t\t\thierarchy += \".\";
	 *        \r\n\t\t}\r\n\r\n\t\tString adapter = \"\";\r\n\t\tif
	 *        (interfaceElement.eContainer().eContainer() instanceof AdapterFB)
	 *        {\r\n\t\t\tadapter +=
	 *        ((PortElementImpl)eContainer()).interfaceElement.getName();\r\n\t\t\tadapter
	 *        += \".\";\r\n\t\t}\r\n\r\n\t\treturn
	 *        getResource().getDevice().getName() + \".\"\r\n\t\t\t\t+
