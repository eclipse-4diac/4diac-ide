...
public class InternalVarsSectionSimple extends AbstractSection implements I4diacTableUtil {
	...
	public void createInternalVarsControls(final Composite parent) {
		...
		buttons.bindToTableViewer(internalVarsViewer, this,
				...
				ref -> new DeleteInternalVariableCommand((BaseFBType) getType(), (VarDeclaration) ref));
	}
	...
	protected Object getInputType(Object input) {
		...
		} else if (input instanceof SimpleFBType) {
			return input;
		}
		return null;
	}
