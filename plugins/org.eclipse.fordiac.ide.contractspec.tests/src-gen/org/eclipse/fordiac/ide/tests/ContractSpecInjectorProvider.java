...
public class ContractSpecInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected ContractSpecRuntimeModule createRuntimeModule() {
		...
		return new ContractSpecRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return ContractSpecInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
