...
public class STAlgorithmBodyImpl extends MinimalEObjectImpl.Container implements STAlgorithmBody {
	...
	public EList<STVarDeclarationBlock> getVarTempDeclarations() {
		if (varTempDeclarations == null) {
			varTempDeclarations = new EObjectContainmentEList<STVarDeclarationBlock>(STVarDeclarationBlock.class, this, STAlgorithmPackage.ST_ALGORITHM_BODY__VAR_TEMP_DECLARATIONS);
		}
