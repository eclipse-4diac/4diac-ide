...
public interface OperationalSemanticsPackage extends EPackage {
	...
	/** The feature id for the '<em><b>Fbnetwork</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 * @ordered */
	int FB_NETWORK_RUNTIME__FBNETWORK = FB_RUNTIME_ABSTRACT_FEATURE_COUNT + 0;

	/** The feature id for the '<em><b>Fb Runtimes</b></em>' containment reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @generated
	 * @ordered */
	...
	/** Returns the meta object for the containment reference list
	 * '{@link org.eclipse.fordiac.ide.fb.interpreter.OpSem.FBNetworkRuntime#getFbRuntimes <em>Fb Runtimes</em>}'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @return the meta object for the containment reference list '<em>Fb Runtimes</em>'.
	...
	interface Literals {
		...
		/** The meta object literal for the '<em><b>Fbnetwork</b></em>' reference feature. <!-- begin-user-doc --> <!--
		 * end-user-doc -->
		 *
		 * @generated */
		EReference FB_NETWORK_RUNTIME__FBNETWORK = eINSTANCE.getFBNetworkRuntime_Fbnetwork();

		/** The meta object literal for the '<em><b>Fb Runtimes</b></em>' containment reference list feature. <!--
		 * begin-user-doc --> <!-- end-user-doc -->
		 *
		 * @generated */
