...
public interface OperationalSemanticsFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Function FB Type Runtime</em>'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @return a new object of class '<em>Function FB Type Runtime</em>'.
	 * @generated
	 */
	 ...
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @return a new object of class '<em>Composite FB Type Runtime</em>'.
	 * @generated
	 */
	CompositeFBTypeRuntime createCompositeFBTypeRuntime();
	...
	/**
	 * Returns a new object of class '<em>Ecc Trace</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	...
	/**
	 * Returns a new object of class '<em>Transition Trace</em>'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
