...
public interface OperationalSemanticsFactory extends EFactory {
	...
	/** Returns a new object of class '<em>Simple FB Type Runtime</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @return a new object of class '<em>Simple FB Type Runtime</em>'.
	 * @generated */
	SimpleFBTypeRuntime createSimpleFBTypeRuntime();

	/** Returns a new object of class '<em>FB Network Runtime</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @return a new object of class '<em>FB Network Runtime</em>'.
	 * @generated */
	FBNetworkRuntime createFBNetworkRuntime();

	/** Returns a new object of class '<em>FB Transaction</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
