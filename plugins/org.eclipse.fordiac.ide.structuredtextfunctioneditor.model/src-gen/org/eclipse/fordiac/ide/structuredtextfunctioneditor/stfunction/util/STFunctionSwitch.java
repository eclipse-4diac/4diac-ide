...
public class STFunctionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case STFunctionPackage.ST_FUNCTION_SOURCE: {
				STFunctionSource stFunctionSource = (STFunctionSource)theEObject;
				T result = caseSTFunctionSource(stFunctionSource);
				if (result == null) result = caseSTSource(stFunctionSource);
	 ...
	 * @generated
	 */
	public T caseSTFunctionSource(STFunctionSource object) {
		return null;
	}
