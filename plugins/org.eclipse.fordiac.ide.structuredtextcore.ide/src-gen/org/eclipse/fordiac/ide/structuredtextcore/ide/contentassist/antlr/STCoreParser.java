...
public class STCoreParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, STCoreGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSTLiteralExpressionsAccess().getNumericLiteralAssignment_0_1(), "rule__STLiteralExpressions__NumericLiteralAssignment_0_1");
			builder.put(grammarAccess.getSTLiteralExpressionsAccess().getDateLiteralAssignment_1_1(), "rule__STLiteralExpressions__DateLiteralAssignment_1_1");
			builder.put(grammarAccess.getSTLiteralExpressionsAccess().getTimeLiteralAssignment_2_1(), "rule__STLiteralExpressions__TimeLiteralAssignment_2_1");
			builder.put(grammarAccess.getSTLiteralExpressionsAccess().getTimeOfDayLiteralAssignment_3_1(), "rule__STLiteralExpressions__TimeOfDayLiteralAssignment_3_1");
			builder.put(grammarAccess.getSTLiteralExpressionsAccess().getTimeLiteralAssignment_4_1(), "rule__STLiteralExpressions__TimeLiteralAssignment_4_1");
			builder.put(grammarAccess.getSTLiteralExpressionsAccess().getStringLiteralAssignment_5_1(), "rule__STLiteralExpressions__StringLiteralAssignment_5_1");
			...
			builder.put(grammarAccess.getNUMERIC_LITERALAccess().getKeyWordValueAssignment_2_3(), "rule__NUMERIC_LITERAL__KeyWordValueAssignment_2_3");
