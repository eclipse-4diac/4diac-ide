...
public class STCoreParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, STCoreGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNumericAccess().getAlternatives_2_0(), "rule__Numeric__Alternatives_2_0");
			builder.put(grammarAccess.getNumericAccess().getAlternatives_2_1(), "rule__Numeric__Alternatives_2_1");
			builder.put(grammarAccess.getTimeAccess().getAlternatives_0(), "rule__Time__Alternatives_0");
			builder.put(grammarAccess.getDateAndTimeAccess().getAlternatives_10(), "rule__DateAndTime__Alternatives_10");
			builder.put(grammarAccess.getTimeOfDayAccess().getAlternatives_4(), "rule__TimeOfDay__Alternatives_4");
