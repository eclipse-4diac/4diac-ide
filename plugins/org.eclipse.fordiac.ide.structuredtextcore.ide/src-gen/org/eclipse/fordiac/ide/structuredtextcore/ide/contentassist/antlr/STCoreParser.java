...
public class STCoreParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, STCoreGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBOOL_LITERALAccess().getAlternatives_1(), "rule__BOOL_LITERAL__Alternatives_1");
			builder.put(grammarAccess.getNUMERIC_LITERALAccess().getKeywordAlternatives_0_0(), "rule__NUMERIC_LITERAL__KeywordAlternatives_0_0");
			builder.put(grammarAccess.getNUMERIC_LITERALAccess().getAlternatives_1(), "rule__NUMERIC_LITERAL__Alternatives_1");
			...
			builder.put(grammarAccess.getNUMERIC_LITERALAccess().getKeywordAssignment_0(), "rule__NUMERIC_LITERAL__KeywordAssignment_0");
			builder.put(grammarAccess.getNUMERIC_LITERALAccess().getIntValueAssignment_1_0(), "rule__NUMERIC_LITERAL__IntValueAssignment_1_0");
			builder.put(grammarAccess.getNUMERIC_LITERALAccess().getRealValueAssignment_1_1(), "rule__NUMERIC_LITERAL__RealValueAssignment_1_1");
			builder.put(grammarAccess.getNUMERIC_LITERALAccess().getHexValueAssignment_1_2(), "rule__NUMERIC_LITERAL__HexValueAssignment_1_2");
