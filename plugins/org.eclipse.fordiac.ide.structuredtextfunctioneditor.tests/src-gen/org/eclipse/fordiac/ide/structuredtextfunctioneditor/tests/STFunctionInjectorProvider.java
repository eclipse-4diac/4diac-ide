...
public class STFunctionInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new STFunctionStandaloneSetup() {
			@Override
	...
	protected STFunctionRuntimeModule createRuntimeModule() {
		...
		return new STFunctionRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return STFunctionInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
