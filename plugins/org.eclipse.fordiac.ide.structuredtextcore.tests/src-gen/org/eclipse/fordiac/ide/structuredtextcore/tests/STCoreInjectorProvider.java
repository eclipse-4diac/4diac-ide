...
public class STCoreInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new STCoreStandaloneSetup() {
			@Override
	...
	protected STCoreRuntimeModule createRuntimeModule() {
		...
		return new STCoreRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return STCoreInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
