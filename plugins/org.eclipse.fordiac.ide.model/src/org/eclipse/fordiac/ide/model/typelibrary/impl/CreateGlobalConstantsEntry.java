...
public class CreateGlobalConstantsEntry implements ITypeEntryCreator {
	...
	public boolean canHandle(final EClass eClass) {
		return LibraryElementPackage.Literals.GLOBAL_CONSTANTS.isSuperTypeOf(eClass);
	}

	@Override
	public TypeEntry createTypeEntry() {
		return new GlobalConstantsEntryImpl();
	}
}
