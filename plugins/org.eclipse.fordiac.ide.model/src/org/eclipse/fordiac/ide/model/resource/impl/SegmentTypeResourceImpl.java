...
public class SegmentTypeResourceImpl extends AbstractLibraryElementResource<SegmentType> {

	public SegmentTypeResourceImpl(final URI uri) {
		super(uri, SegmentType.class);
	}
