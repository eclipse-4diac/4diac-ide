...
public class CreateSegmentTypeEntry implements ITypeEntryCreator {
	...
	public boolean canHandle(final EClass eClass) {
		return LibraryElementPackage.Literals.SEGMENT_TYPE.isSuperTypeOf(eClass);
	}

	@Override
	public SegmentTypeEntry createTypeEntry() {
		return new SegmentTypeEntryImpl();
	}
