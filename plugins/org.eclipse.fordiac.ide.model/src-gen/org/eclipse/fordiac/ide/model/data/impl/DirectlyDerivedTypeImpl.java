 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fordiac.ide.model.data.impl.DirectlyDerivedTypeImpl#getBaseType <em>Base Type</em>}</li>
 *   <li>{@link org.eclipse.fordiac.ide.model.data.impl.DirectlyDerivedTypeImpl#getInitialValue <em>Initial Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DirectlyDerivedTypeImpl extends AnyDerivedTypeImpl implements DirectlyDerivedType {
	/**
		...
		if (baseType != null && baseType.eIsProxy()) {
			...
			if (baseType != oldBaseType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DataPackage.DIRECTLY_DERIVED_TYPE__BASE_TYPE, oldBaseType, baseType));
			}
		}
		return baseType;
	}
	...
	public void setBaseType(DataType newBaseType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.DIRECTLY_DERIVED_TYPE__BASE_TYPE, oldBaseType, baseType));
	}
	...
	public void setInitialValue(String newInitialValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.DIRECTLY_DERIVED_TYPE__INITIAL_VALUE, oldInitialValue, initialValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.DIRECTLY_DERIVED_TYPE__BASE_TYPE:
				if (resolve) return getBaseType();
				return basicGetBaseType();
			case DataPackage.DIRECTLY_DERIVED_TYPE__INITIAL_VALUE:
