...
public class DataSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DataPackage.ANY_DERIVED_TYPE: {
			...
			if (result == null)
				result = caseAnyType(anyDerivedType);
			if (result == null)
		...
		case DataPackage.STRUCTURED_TYPE: {
			...
			if (result == null)
				result = caseAnyType(structuredType);
			if (result == null)
		...
		case DataPackage.ANY_TYPE: {
			...
			if (result == null)
				result = caseDataType(anyType);
			if (result == null)
				result = caseLibraryElement(anyType);
			if (result == null)
				result = caseINamedElement(anyType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.ANY_ELEMENTARY_TYPE: {
			...
			if (result == null)
				result = caseAnyType(anyElementaryType);
			if (result == null)
				result = caseDataType(anyElementaryType);
			if (result == null)
				result = caseLibraryElement(anyElementaryType);
			if (result == null)
				result = caseINamedElement(anyElementaryType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.ANY_MAGNITUDE_TYPE: {
			...
			if (result == null)
				result = caseAnyElementaryType(anyMagnitudeType);
			if (result == null)
				result = caseAnyType(anyMagnitudeType);
			if (result == null)
				result = caseDataType(anyMagnitudeType);
			if (result == null)
				result = caseLibraryElement(anyMagnitudeType);
			if (result == null)
				result = caseINamedElement(anyMagnitudeType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.ANY_NUM_TYPE: {
			...
			if (result == null)
				result = caseAnyMagnitudeType(anyNumType);
			if (result == null)
				result = caseAnyElementaryType(anyNumType);
			if (result == null)
				result = caseAnyType(anyNumType);
			if (result == null)
				result = caseDataType(anyNumType);
			if (result == null)
				result = caseLibraryElement(anyNumType);
			if (result == null)
				result = caseINamedElement(anyNumType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.ANY_REAL_TYPE: {
			...
			if (result == null)
				result = caseAnyNumType(anyRealType);
			if (result == null)
				result = caseAnyMagnitudeType(anyRealType);
			if (result == null)
				result = caseAnyElementaryType(anyRealType);
			if (result == null)
				result = caseAnyType(anyRealType);
			if (result == null)
				result = caseDataType(anyRealType);
			if (result == null)
				result = caseLibraryElement(anyRealType);
			if (result == null)
				result = caseINamedElement(anyRealType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.REAL_TYPE: {
			...
			if (result == null)
				result = caseAnyRealType(realType);
			if (result == null)
				result = caseAnyNumType(realType);
			if (result == null)
				result = caseAnyMagnitudeType(realType);
			if (result == null)
				result = caseAnyElementaryType(realType);
			if (result == null)
				result = caseAnyType(realType);
			if (result == null)
				result = caseDataType(realType);
			if (result == null)
				result = caseLibraryElement(realType);
			if (result == null)
				result = caseINamedElement(realType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.LREAL_TYPE: {
			...
			if (result == null)
				result = caseAnyRealType(lrealType);
			if (result == null)
				result = caseAnyNumType(lrealType);
			if (result == null)
				result = caseAnyMagnitudeType(lrealType);
			if (result == null)
				result = caseAnyElementaryType(lrealType);
			if (result == null)
				result = caseAnyType(lrealType);
			if (result == null)
				result = caseDataType(lrealType);
			if (result == null)
				result = caseLibraryElement(lrealType);
			if (result == null)
				result = caseINamedElement(lrealType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.ANY_INT_TYPE: {
			...
			if (result == null)
				result = caseAnyNumType(anyIntType);
			if (result == null)
				result = caseAnyMagnitudeType(anyIntType);
			if (result == null)
				result = caseAnyElementaryType(anyIntType);
			if (result == null)
				result = caseAnyType(anyIntType);
			if (result == null)
				result = caseDataType(anyIntType);
			if (result == null)
				result = caseLibraryElement(anyIntType);
			if (result == null)
				result = caseINamedElement(anyIntType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.ANY_UNSIGNED_TYPE: {
			...
			if (result == null)
				result = caseAnyIntType(anyUnsignedType);
			if (result == null)
				result = caseAnyNumType(anyUnsignedType);
			if (result == null)
				result = caseAnyMagnitudeType(anyUnsignedType);
			if (result == null)
				result = caseAnyElementaryType(anyUnsignedType);
			if (result == null)
				result = caseAnyType(anyUnsignedType);
			if (result == null)
				result = caseDataType(anyUnsignedType);
			if (result == null)
				result = caseLibraryElement(anyUnsignedType);
			if (result == null)
				result = caseINamedElement(anyUnsignedType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.USINT_TYPE: {
			...
			if (result == null)
				result = caseAnyUnsignedType(usintType);
			if (result == null)
				result = caseAnyIntType(usintType);
			if (result == null)
				result = caseAnyNumType(usintType);
			if (result == null)
				result = caseAnyMagnitudeType(usintType);
			if (result == null)
				result = caseAnyElementaryType(usintType);
			if (result == null)
				result = caseAnyType(usintType);
			if (result == null)
				result = caseDataType(usintType);
			if (result == null)
				result = caseLibraryElement(usintType);
			if (result == null)
				result = caseINamedElement(usintType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.UINT_TYPE: {
			...
			if (result == null)
				result = caseAnyUnsignedType(uintType);
			if (result == null)
				result = caseAnyIntType(uintType);
			if (result == null)
				result = caseAnyNumType(uintType);
			if (result == null)
				result = caseAnyMagnitudeType(uintType);
			if (result == null)
				result = caseAnyElementaryType(uintType);
			if (result == null)
				result = caseAnyType(uintType);
			if (result == null)
				result = caseDataType(uintType);
			if (result == null)
				result = caseLibraryElement(uintType);
			if (result == null)
				result = caseINamedElement(uintType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.UDINT_TYPE: {
			...
			if (result == null)
				result = caseAnyUnsignedType(udintType);
			if (result == null)
				result = caseAnyIntType(udintType);
			if (result == null)
				result = caseAnyNumType(udintType);
			if (result == null)
				result = caseAnyMagnitudeType(udintType);
			if (result == null)
				result = caseAnyElementaryType(udintType);
			if (result == null)
				result = caseAnyType(udintType);
			if (result == null)
				result = caseDataType(udintType);
			if (result == null)
				result = caseLibraryElement(udintType);
			if (result == null)
				result = caseINamedElement(udintType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.ULINT_TYPE: {
			...
			if (result == null)
				result = caseAnyUnsignedType(ulintType);
			if (result == null)
				result = caseAnyIntType(ulintType);
			if (result == null)
				result = caseAnyNumType(ulintType);
			if (result == null)
				result = caseAnyMagnitudeType(ulintType);
			if (result == null)
				result = caseAnyElementaryType(ulintType);
			if (result == null)
				result = caseAnyType(ulintType);
			if (result == null)
				result = caseDataType(ulintType);
			if (result == null)
				result = caseLibraryElement(ulintType);
			if (result == null)
				result = caseINamedElement(ulintType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.ANY_SIGNED_TYPE: {
			...
			if (result == null)
				result = caseAnyIntType(anySignedType);
			if (result == null)
				result = caseAnyNumType(anySignedType);
			if (result == null)
				result = caseAnyMagnitudeType(anySignedType);
			if (result == null)
				result = caseAnyElementaryType(anySignedType);
			if (result == null)
				result = caseAnyType(anySignedType);
			if (result == null)
				result = caseDataType(anySignedType);
			if (result == null)
				result = caseLibraryElement(anySignedType);
			if (result == null)
				result = caseINamedElement(anySignedType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.SINT_TYPE: {
			...
			if (result == null)
				result = caseAnySignedType(sintType);
			if (result == null)
				result = caseAnyIntType(sintType);
			if (result == null)
				result = caseAnyNumType(sintType);
			if (result == null)
				result = caseAnyMagnitudeType(sintType);
			if (result == null)
				result = caseAnyElementaryType(sintType);
			if (result == null)
				result = caseAnyType(sintType);
			if (result == null)
				result = caseDataType(sintType);
			if (result == null)
				result = caseLibraryElement(sintType);
			if (result == null)
				result = caseINamedElement(sintType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.INT_TYPE: {
			...
			if (result == null)
				result = caseAnySignedType(intType);
			if (result == null)
				result = caseAnyIntType(intType);
			if (result == null)
				result = caseAnyNumType(intType);
			if (result == null)
				result = caseAnyMagnitudeType(intType);
			if (result == null)
				result = caseAnyElementaryType(intType);
			if (result == null)
				result = caseAnyType(intType);
			if (result == null)
				result = caseDataType(intType);
			if (result == null)
				result = caseLibraryElement(intType);
			if (result == null)
				result = caseINamedElement(intType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.DINT_TYPE: {
			...
			if (result == null)
				result = caseAnySignedType(dintType);
			if (result == null)
				result = caseAnyIntType(dintType);
			if (result == null)
				result = caseAnyNumType(dintType);
			if (result == null)
				result = caseAnyMagnitudeType(dintType);
			if (result == null)
				result = caseAnyElementaryType(dintType);
			if (result == null)
				result = caseAnyType(dintType);
			if (result == null)
				result = caseDataType(dintType);
			if (result == null)
				result = caseLibraryElement(dintType);
			if (result == null)
				result = caseINamedElement(dintType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.LINT_TYPE: {
			...
			if (result == null)
				result = caseAnySignedType(lintType);
			if (result == null)
				result = caseAnyIntType(lintType);
			if (result == null)
				result = caseAnyNumType(lintType);
			if (result == null)
				result = caseAnyMagnitudeType(lintType);
			if (result == null)
				result = caseAnyElementaryType(lintType);
			if (result == null)
				result = caseAnyType(lintType);
			if (result == null)
				result = caseDataType(lintType);
			if (result == null)
				result = caseLibraryElement(lintType);
			if (result == null)
				result = caseINamedElement(lintType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.ANY_DURATION_TYPE: {
			...
			if (result == null)
				result = caseAnyMagnitudeType(anyDurationType);
			if (result == null)
				result = caseAnyElementaryType(anyDurationType);
			if (result == null)
				result = caseAnyType(anyDurationType);
			if (result == null)
				result = caseDataType(anyDurationType);
			if (result == null)
				result = caseLibraryElement(anyDurationType);
			if (result == null)
				result = caseINamedElement(anyDurationType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.TIME_TYPE: {
			...
			if (result == null)
				result = caseAnyDurationType(timeType);
			if (result == null)
				result = caseAnyMagnitudeType(timeType);
			if (result == null)
				result = caseAnyElementaryType(timeType);
			if (result == null)
				result = caseAnyType(timeType);
			if (result == null)
				result = caseDataType(timeType);
			if (result == null)
				result = caseLibraryElement(timeType);
			if (result == null)
				result = caseINamedElement(timeType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.LTIME_TYPE: {
			...
			if (result == null)
				result = caseAnyDurationType(ltimeType);
			if (result == null)
				result = caseAnyMagnitudeType(ltimeType);
			if (result == null)
				result = caseAnyElementaryType(ltimeType);
			if (result == null)
				result = caseAnyType(ltimeType);
			if (result == null)
				result = caseDataType(ltimeType);
			if (result == null)
				result = caseLibraryElement(ltimeType);
			if (result == null)
				result = caseINamedElement(ltimeType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.ANY_BIT_TYPE: {
			...
			if (result == null)
				result = caseAnyElementaryType(anyBitType);
			if (result == null)
				result = caseAnyType(anyBitType);
			if (result == null)
				result = caseDataType(anyBitType);
			if (result == null)
				result = caseLibraryElement(anyBitType);
			if (result == null)
				result = caseINamedElement(anyBitType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.BOOL_TYPE: {
			...
			if (result == null)
				result = caseAnyBitType(boolType);
			if (result == null)
				result = caseAnyElementaryType(boolType);
			if (result == null)
				result = caseAnyType(boolType);
			if (result == null)
				result = caseDataType(boolType);
			if (result == null)
				result = caseLibraryElement(boolType);
			if (result == null)
				result = caseINamedElement(boolType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.BYTE_TYPE: {
			...
			if (result == null)
				result = caseAnyBitType(byteType);
			if (result == null)
				result = caseAnyElementaryType(byteType);
			if (result == null)
				result = caseAnyType(byteType);
			if (result == null)
				result = caseDataType(byteType);
			if (result == null)
				result = caseLibraryElement(byteType);
			if (result == null)
				result = caseINamedElement(byteType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.WORD_TYPE: {
			...
			if (result == null)
				result = caseAnyBitType(wordType);
			if (result == null)
				result = caseAnyElementaryType(wordType);
			if (result == null)
				result = caseAnyType(wordType);
			if (result == null)
				result = caseDataType(wordType);
			if (result == null)
				result = caseLibraryElement(wordType);
			if (result == null)
				result = caseINamedElement(wordType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.DWORD_TYPE: {
			...
			if (result == null)
				result = caseAnyBitType(dwordType);
			if (result == null)
				result = caseAnyElementaryType(dwordType);
			if (result == null)
				result = caseAnyType(dwordType);
			if (result == null)
				result = caseDataType(dwordType);
			if (result == null)
				result = caseLibraryElement(dwordType);
			if (result == null)
				result = caseINamedElement(dwordType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.LWORD_TYPE: {
			...
			if (result == null)
				result = caseAnyBitType(lwordType);
			if (result == null)
				result = caseAnyElementaryType(lwordType);
			if (result == null)
				result = caseAnyType(lwordType);
			if (result == null)
				result = caseDataType(lwordType);
			if (result == null)
				result = caseLibraryElement(lwordType);
			if (result == null)
				result = caseINamedElement(lwordType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.ANY_CHARS_TYPE: {
			...
			if (result == null)
				result = caseAnyElementaryType(anyCharsType);
			if (result == null)
				result = caseAnyType(anyCharsType);
			if (result == null)
				result = caseDataType(anyCharsType);
			if (result == null)
				result = caseLibraryElement(anyCharsType);
			if (result == null)
				result = caseINamedElement(anyCharsType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.ANY_STRING_TYPE: {
			...
			if (result == null)
				result = caseAnyCharsType(anyStringType);
			if (result == null)
				result = caseAnyElementaryType(anyStringType);
			if (result == null)
				result = caseAnyType(anyStringType);
			if (result == null)
				result = caseDataType(anyStringType);
			if (result == null)
				result = caseLibraryElement(anyStringType);
			if (result == null)
				result = caseINamedElement(anyStringType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.STRING_TYPE: {
			...
			if (result == null)
				result = caseAnyStringType(stringType);
			if (result == null)
				result = caseAnyCharsType(stringType);
			if (result == null)
				result = caseAnyElementaryType(stringType);
			if (result == null)
				result = caseAnyType(stringType);
			if (result == null)
				result = caseDataType(stringType);
			if (result == null)
				result = caseLibraryElement(stringType);
			if (result == null)
				result = caseINamedElement(stringType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.WSTRING_TYPE: {
			...
			if (result == null)
				result = caseAnyStringType(wstringType);
			if (result == null)
				result = caseAnyCharsType(wstringType);
			if (result == null)
				result = caseAnyElementaryType(wstringType);
			if (result == null)
				result = caseAnyType(wstringType);
			if (result == null)
				result = caseDataType(wstringType);
			if (result == null)
				result = caseLibraryElement(wstringType);
			if (result == null)
				result = caseINamedElement(wstringType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.ANY_CHAR_TYPE: {
			...
			if (result == null)
				result = caseAnyCharsType(anyCharType);
			if (result == null)
				result = caseAnyElementaryType(anyCharType);
			if (result == null)
				result = caseAnyType(anyCharType);
			if (result == null)
				result = caseDataType(anyCharType);
			if (result == null)
				result = caseLibraryElement(anyCharType);
			if (result == null)
				result = caseINamedElement(anyCharType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.CHAR_TYPE: {
			...
			if (result == null)
				result = caseAnyCharType(charType);
			if (result == null)
				result = caseAnyCharsType(charType);
			if (result == null)
				result = caseAnyElementaryType(charType);
			if (result == null)
				result = caseAnyType(charType);
			if (result == null)
				result = caseDataType(charType);
			if (result == null)
				result = caseLibraryElement(charType);
			if (result == null)
				result = caseINamedElement(charType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.WCHAR_TYPE: {
			...
			if (result == null)
				result = caseAnyCharType(wcharType);
			if (result == null)
				result = caseAnyCharsType(wcharType);
			if (result == null)
				result = caseAnyElementaryType(wcharType);
			if (result == null)
				result = caseAnyType(wcharType);
			if (result == null)
				result = caseDataType(wcharType);
			if (result == null)
				result = caseLibraryElement(wcharType);
			if (result == null)
				result = caseINamedElement(wcharType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.ANY_DATE_TYPE: {
			...
			if (result == null)
				result = caseAnyElementaryType(anyDateType);
			if (result == null)
				result = caseAnyType(anyDateType);
			if (result == null)
				result = caseDataType(anyDateType);
			if (result == null)
				result = caseLibraryElement(anyDateType);
			if (result == null)
				result = caseINamedElement(anyDateType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.DATE_AND_TIME_TYPE: {
			...
			if (result == null)
				result = caseAnyDateType(dateAndTimeType);
			if (result == null)
				result = caseAnyElementaryType(dateAndTimeType);
			if (result == null)
				result = caseAnyType(dateAndTimeType);
			if (result == null)
				result = caseDataType(dateAndTimeType);
			if (result == null)
				result = caseLibraryElement(dateAndTimeType);
			if (result == null)
				result = caseINamedElement(dateAndTimeType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.LDT_TYPE: {
			...
			if (result == null)
				result = caseAnyDateType(ldtType);
			if (result == null)
				result = caseAnyElementaryType(ldtType);
			if (result == null)
				result = caseAnyType(ldtType);
			if (result == null)
				result = caseDataType(ldtType);
			if (result == null)
				result = caseLibraryElement(ldtType);
			if (result == null)
				result = caseINamedElement(ldtType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.DATE_TYPE: {
			...
			if (result == null)
				result = caseAnyDateType(dateType);
			if (result == null)
				result = caseAnyElementaryType(dateType);
			if (result == null)
				result = caseAnyType(dateType);
			if (result == null)
				result = caseDataType(dateType);
			if (result == null)
				result = caseLibraryElement(dateType);
			if (result == null)
				result = caseINamedElement(dateType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.TIME_OF_DAY_TYPE: {
			...
			if (result == null)
				result = caseAnyDateType(timeOfDayType);
			if (result == null)
				result = caseAnyElementaryType(timeOfDayType);
			if (result == null)
				result = caseAnyType(timeOfDayType);
			if (result == null)
				result = caseDataType(timeOfDayType);
			if (result == null)
				result = caseLibraryElement(timeOfDayType);
			if (result == null)
				result = caseINamedElement(timeOfDayType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.LTOD_TYPE: {
			...
			if (result == null)
				result = caseAnyDateType(ltodType);
			if (result == null)
				result = caseAnyElementaryType(ltodType);
			if (result == null)
				result = caseAnyType(ltodType);
			if (result == null)
				result = caseDataType(ltodType);
			if (result == null)
				result = caseLibraryElement(ltodType);
			if (result == null)
				result = caseINamedElement(ltodType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
