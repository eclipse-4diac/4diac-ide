...
public class VirtualDNSSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case VirtualDNSPackage.VIRTUAL_DNS_ENTRY: {
			VirtualDNSEntry virtualDNSEntry = (VirtualDNSEntry) theEObject;
			T result = caseVirtualDNSEntry(virtualDNSEntry);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case VirtualDNSPackage.VIRTUAL_DNS_COLLECTION: {
			VirtualDNSCollection virtualDNSCollection = (VirtualDNSCollection) theEObject;
			T result = caseVirtualDNSCollection(virtualDNSCollection);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case VirtualDNSPackage.VIRTUAL_DNS_MANAGEMENT: {
			VirtualDNSManagement virtualDNSManagement = (VirtualDNSManagement) theEObject;
			T result = caseVirtualDNSManagement(virtualDNSManagement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated */
	public T caseVirtualDNSEntry(VirtualDNSEntry object) {
		return null;
	}

	/** Returns the result of interpreting the object as an instance of '<em>Collection</em>'. <!-- begin-user-doc -->
	 ...
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated */
	public T caseVirtualDNSCollection(VirtualDNSCollection object) {
		return null;
	}

	/** Returns the result of interpreting the object as an instance of '<em>Management</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 ...
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated */
	public T caseVirtualDNSManagement(VirtualDNSManagement object) {
		return null;
	}
