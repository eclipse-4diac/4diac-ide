...
/** <!-- begin-user-doc --> A representation of the model object '<em><b>Interface List</b></em>'. <!-- end-user-doc -->
 *
 * <p>
...
public interface InterfaceList extends EObject {
	/** Returns the value of the '<em><b>Plugs</b></em>' containment reference list. The list contents are of type
	 * {@link org.eclipse.fordiac.ide.model.libraryElement.AdapterDeclaration}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Plugs</em>' containment reference list isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model containment="true" extendedMetaData="kind='element' name='AdapterDeclaration'
	 *        namespace='##targetNamespace'"
	 * @generated */
	EList<AdapterDeclaration> getPlugs();

	/** Returns the value of the '<em><b>Sockets</b></em>' containment reference list. The list contents are of type
	 * {@link org.eclipse.fordiac.ide.model.libraryElement.AdapterDeclaration}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Sockets</em>' containment reference list isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/** Returns the value of the '<em><b>Event Inputs</b></em>' containment reference list. The list contents are of
	 * type {@link org.eclipse.fordiac.ide.model.libraryElement.Event}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Event Inputs</em>' containment reference list isn't clear, there really should be more
	 ...
	 * @model containment="true" extendedMetaData="kind='element' name='SubAppEventInputs'
	 *        namespace='##targetNamespace'"
	 * @generated */
	EList<Event> getEventInputs();

	/** Returns the value of the '<em><b>Event Outputs</b></em>' containment reference list. The list contents are of
	 * type {@link org.eclipse.fordiac.ide.model.libraryElement.Event}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Event Outputs</em>' containment reference list isn't clear, there really should be
	 ...
	 * @model containment="true" extendedMetaData="kind='element' name='SubAppEventOutputs'
	 *        namespace='##targetNamespace'"
	 * @generated */
	EList<Event> getEventOutputs();

	/** Returns the value of the '<em><b>Input Vars</b></em>' containment reference list. The list contents are of type
	 * {@link org.eclipse.fordiac.ide.model.libraryElement.VarDeclaration}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Input Vars</em>' containment reference list isn't clear, there really should be more
	 * of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model containment="true" extendedMetaData="kind='element' name='InputVars' namespace='##targetNamespace'"
	 * @generated */
	EList<VarDeclaration> getInputVars();

	/** Returns the value of the '<em><b>Output Vars</b></em>' containment reference list. The list contents are of type
	 * {@link org.eclipse.fordiac.ide.model.libraryElement.VarDeclaration}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Output Vars</em>' containment reference list isn't clear, there really should be more
	 * of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
