...
/** <!-- begin-user-doc --> A representation of the model object '<em><b>ECC</b></em>'. <!-- end-user-doc -->
 *
 * <p>
...
public interface ECC extends EObject {
	/** Returns the value of the '<em><b>EC State</b></em>' containment reference list. The list contents are of type
	 * {@link org.eclipse.fordiac.ide.model.libraryElement.ECState}. It is bidirectional and its opposite is
	 * '{@link org.eclipse.fordiac.ide.model.libraryElement.ECState#getECC <em>ECC</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>EC State</em>' containment reference list isn't clear, there really should be more of
	 * a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model opposite="eCC" containment="true" required="true" extendedMetaData="kind='element' name='ECState'
	 *        namespace='##targetNamespace'"
	 * @generated */
	EList<ECState> getECState();

	/** Returns the value of the '<em><b>EC Transition</b></em>' containment reference list. The list contents are of
	 * type {@link org.eclipse.fordiac.ide.model.libraryElement.ECTransition}. It is bidirectional and its opposite is
	 * '{@link org.eclipse.fordiac.ide.model.libraryElement.ECTransition#getECC <em>ECC</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>EC Transition</em>' containment reference list isn't clear, there really should be
	 ...
	 * @model opposite="eCC" containment="true" required="true" extendedMetaData="kind='element' name='ECTransition'
	 *        namespace='##targetNamespace'"
	 * @generated */
	...
	/** Sets the value of the '{@link org.eclipse.fordiac.ide.model.libraryElement.ECC#getStart <em>Start</em>}'
	...
	/** Returns the value of the '<em><b>Basic FB Type</b></em>' container reference. It is bidirectional and its
	 * opposite is '{@link org.eclipse.fordiac.ide.model.libraryElement.BasicFBType#getECC <em>ECC</em>}'. <!--
	...
	/** Sets the value of the '{@link org.eclipse.fordiac.ide.model.libraryElement.ECC#getBasicFBType <em>Basic FB
