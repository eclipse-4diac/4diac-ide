 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.libraryElement.Attribute#getAttributeDeclaration <em>Attribute
 * Declaration</em>}</li>
...
public interface Attribute extends INamedElement, TypedElement {
	/** Returns the value of the '<em><b>Attribute Declaration</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Attribute Declaration</em>' reference isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/** Sets the value of the '{@link org.eclipse.fordiac.ide.model.libraryElement.Attribute#getAttributeDeclaration
	 * <em>Attribute Declaration</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/** Sets the value of the '{@link org.eclipse.fordiac.ide.model.libraryElement.Attribute#getValue <em>Value</em>}'
