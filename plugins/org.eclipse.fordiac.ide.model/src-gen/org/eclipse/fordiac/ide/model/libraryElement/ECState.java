 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.libraryElement.ECState#getECAction
 * <em>EC Action</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.libraryElement.ECState#getOutTransitions
 * <em>Out Transitions</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.libraryElement.ECState#getInTransitions
 * <em>In Transitions</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.libraryElement.ECState#getECC
 * <em>ECC</em>}</li>
 * </ul>
 *
...
public interface ECState extends INamedElement, PositionableElement {
	 ...
	 * {@link org.eclipse.fordiac.ide.model.libraryElement.ECAction}. It is
	 * bidirectional and its opposite is
	 * '{@link org.eclipse.fordiac.ide.model.libraryElement.ECAction#getECState
	 * <em>EC State</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>EC Action</em>' containment reference list isn't
	 ...
	 * @model opposite="eCState" containment="true" extendedMetaData="kind='element'
	 *        name='ECAction' namespace='##targetNamespace'"
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>In Transitions</b></em>' reference list. The
