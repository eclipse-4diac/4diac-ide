...
public interface ServiceTransaction extends EObject {
	 ...
	 * <p>
	 * If the meaning of the '<em>Input Primitive</em>' containment reference isn't clear, there really should be more
	 ...
	 * <p>
	 * If the meaning of the '<em>Output Primitive</em>' containment reference list isn't clear, there really should be
	...
	/** Returns the value of the '<em><b>Test Result</b></em>' attribute. The default value is <code>"0"</code>. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Test Result</em>' attribute isn't clear, there really should be more of a description
	 * here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/** Sets the value of the '{@link org.eclipse.fordiac.ide.model.libraryElement.ServiceTransaction#getTestResult
	...
	/** Unsets the value of the '{@link org.eclipse.fordiac.ide.model.libraryElement.ServiceTransaction#getTestResult
	 * <em>Test Result</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isSetTestResult()
	 * @see #getTestResult()
