 ...
 * <li>{@link org.eclipse.fordiac.ide.model.libraryElement.Resource#isDeviceTypeResource <em>Device Type
 * Resource</em>}</li>
 * </ul>
 *
...
public interface Resource extends TypedConfigureableObject, IVarElement {
	...
	/** Sets the value of the '{@link org.eclipse.fordiac.ide.model.libraryElement.Resource#getFBNetwork <em>FB
	 ...
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='attribute' name='x'"
	 * @generated */
	String getX();
	 ...
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='attribute' name='y'"
	 * @generated */
	String getY();
	...
	/** Returns the value of the '<em><b>Device</b></em>' container reference. It is bidirectional and its opposite is
	 * '{@link org.eclipse.fordiac.ide.model.libraryElement.Device#getResource <em>Resource</em>}'. <!-- begin-user-doc
	 * -->
	 * <p>
	 * If the meaning of the '<em>Device</em>' container reference isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/** Sets the value of the '{@link org.eclipse.fordiac.ide.model.libraryElement.Resource#getDevice <em>Device</em>}'
	...
	/** Returns the value of the '<em><b>Device Type Resource</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Device Type Resource</em>' attribute isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/** Sets the value of the '{@link org.eclipse.fordiac.ide.model.libraryElement.Resource#isDeviceTypeResource
	 * <em>Device Type Resource</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
