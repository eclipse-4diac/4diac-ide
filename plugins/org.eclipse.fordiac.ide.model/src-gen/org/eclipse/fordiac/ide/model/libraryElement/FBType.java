 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.libraryElement.FBType#getInterfaceList
 * <em>Interface List</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.libraryElement.FBType#getService
 * <em>Service</em>}</li>
 * </ul>
 *
...
public interface FBType extends CompilableType {
	 ...
	 * <p>
	 * If the meaning of the '<em>Interface List</em>' containment reference isn't
	 ...
	 *        name='InterfaceList' namespace='##targetNamespace'"
	 * @generated
	 */
	 ...
	 * end-user-doc -->
	 * 
	 * @param value the new value of the '<em>Interface List</em>' containment
	 *              reference.
	 ...
	 * @model containment="true" required="true" extendedMetaData="kind='element'
	 *        name='ServiceSequence' namespace='##targetNamespace'"
	 * @generated
	 */
	Service getService();
	 ...
	 * <em>Service</em>}' containment reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
