 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fordiac.ide.model.libraryElement.impl.AdapterConnectionImpl#getFBNetwork <em>FB Network</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdapterConnectionImpl extends ConnectionImpl implements AdapterConnection {
	...
	public FBNetwork getFBNetwork() {
		if (eContainerFeatureID() != LibraryElementPackage.ADAPTER_CONNECTION__FB_NETWORK) return null;
	...
	public NotificationChain basicSetFBNetwork(FBNetwork newFBNetwork, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newFBNetwork, LibraryElementPackage.ADAPTER_CONNECTION__FB_NETWORK, msgs);
		return msgs;
	}
	...
	public void setFBNetwork(FBNetwork newFBNetwork) {
		if (newFBNetwork != eInternalContainer() || (eContainerFeatureID() != LibraryElementPackage.ADAPTER_CONNECTION__FB_NETWORK && newFBNetwork != null)) {
			...
			if (newFBNetwork != null)
				msgs = ((InternalEObject)newFBNetwork).eInverseAdd(this, LibraryElementPackage.FB_NETWORK__ADAPTER_CONNECTIONS, FBNetwork.class, msgs);
			msgs = basicSetFBNetwork(newFBNetwork, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryElementPackage.ADAPTER_CONNECTION__FB_NETWORK, newFBNetwork, newFBNetwork));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LibraryElementPackage.ADAPTER_CONNECTION__FB_NETWORK:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case LibraryElementPackage.ADAPTER_CONNECTION__FB_NETWORK:
				return eInternalContainer().eInverseRemove(this, LibraryElementPackage.FB_NETWORK__ADAPTER_CONNECTIONS, FBNetwork.class, msgs);
			default:
