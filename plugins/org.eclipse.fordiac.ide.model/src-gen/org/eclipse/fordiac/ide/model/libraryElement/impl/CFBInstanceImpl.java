...
/** <!-- begin-user-doc --> An implementation of the model object '<em><b>CFB Instance</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class CFBInstanceImpl extends FBImpl implements CFBInstance {
	...
	public FBNetwork getCfbNetwork() {
		if (cfbNetwork != null && cfbNetwork.eIsProxy()) {
			...
			if (cfbNetwork != oldCfbNetwork) {
				...
				NotificationChain msgs = oldCfbNetwork.eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - LibraryElementPackage.CFB_INSTANCE__CFB_NETWORK, null, null);
				if (newCfbNetwork.eInternalContainer() == null) {
					msgs = newCfbNetwork.eInverseAdd(this,
							EOPPOSITE_FEATURE_BASE - LibraryElementPackage.CFB_INSTANCE__CFB_NETWORK, null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							LibraryElementPackage.CFB_INSTANCE__CFB_NETWORK, oldCfbNetwork, cfbNetwork));
			}
		}
		return cfbNetwork;
	}
	...
	public NotificationChain basicSetCfbNetwork(FBNetwork newCfbNetwork, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LibraryElementPackage.CFB_INSTANCE__CFB_NETWORK, oldCfbNetwork, newCfbNetwork);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setCfbNetwork(FBNetwork newCfbNetwork) {
		if (newCfbNetwork != cfbNetwork) {
			...
			if (cfbNetwork != null)
				msgs = ((InternalEObject) cfbNetwork).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - LibraryElementPackage.CFB_INSTANCE__CFB_NETWORK, null, msgs);
			if (newCfbNetwork != null)
				msgs = ((InternalEObject) newCfbNetwork).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - LibraryElementPackage.CFB_INSTANCE__CFB_NETWORK, null, msgs);
			msgs = basicSetCfbNetwork(newCfbNetwork, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryElementPackage.CFB_INSTANCE__CFB_NETWORK,
					newCfbNetwork, newCfbNetwork));
	}
