...
/** <!-- begin-user-doc --> A representation of the model object '<em><b>EC Action</b></em>'. <!-- end-user-doc -->
 *
 * <p>
...
public interface ECAction extends EObject {
	/** Returns the value of the '<em><b>Algorithm</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Algorithm</em>' attribute isn't clear, there really should be more of a description
	 * here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/** Sets the value of the '{@link org.eclipse.fordiac.ide.model.libraryElement.ECAction#getAlgorithm
	 * <em>Algorithm</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/** Returns the value of the '<em><b>Output</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	...
	/** Sets the value of the '{@link org.eclipse.fordiac.ide.model.libraryElement.ECAction#getOutput <em>Output</em>}'
	...
	/** Returns the value of the '<em><b>EC State</b></em>' container reference. It is bidirectional and its opposite is
	...
	/** Sets the value of the '{@link org.eclipse.fordiac.ide.model.libraryElement.ECAction#getECState <em>EC
	 * State</em>}' container reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
