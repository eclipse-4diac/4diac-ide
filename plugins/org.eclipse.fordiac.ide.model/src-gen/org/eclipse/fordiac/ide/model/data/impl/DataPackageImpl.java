...
public class DataPackageImpl extends EPackageImpl implements DataPackage {
	...
	public void initializePackageContents() {
		...
		initEClass(structuredTypeEClass, StructuredType.class, "StructuredType", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getStructuredType_VarDeclaration(), theLibraryElementPackage.getVarDeclaration(), null,
				"varDeclaration", null, 0, -1, StructuredType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(getStructuredType_VarDeclaration(), source, new String[] { "kind", "element", //$NON-NLS-1$ //$NON-NLS-2$
