...
public class LibraryElementValidator extends EObjectValidator {
	...
	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Validate Location' of 'Override Attribute'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int OVERRIDE_ATTRIBUTE__VALIDATE_LOCATION = 51;
	 ...
	 * @generated
	 */
	private static final int GENERATED_DIAGNOSTIC_CODE_COUNT = 51;
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			...
			case LibraryElementPackage.CONTAINER_VAR_DECLARATION:
				return validateContainerVarDeclaration((ContainerVarDeclaration)value, diagnostics, context);
			...
			case LibraryElementPackage.OVERRIDE_ATTRIBUTE:
				return validateOverrideAttribute((OverrideAttribute)value, diagnostics, context);
	...
	public boolean validateAdapterConnection(AdapterConnection adapterConnection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateConnection_validateNegatedConnection(adapterConnection, diagnostics, context);
		return result;
	}
	...
	public boolean validateAdapterType(AdapterType adapterType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLibraryElement_validatePackage(adapterType, diagnostics, context);
		return result;
	}
	...
	public boolean validateAttributeDeclaration(AttributeDeclaration attributeDeclaration, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLibraryElement_validatePackage(attributeDeclaration, diagnostics, context);
		return result;
	}
	...
	public boolean validateBaseFBType(BaseFBType baseFBType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLibraryElement_validatePackage(baseFBType, diagnostics, context);
		if (result || diagnostics != null) result &= validateBaseFBType_validateInternalFBs(baseFBType, diagnostics, context);
		return result;
	}

	/**
	 * Validates the validateInternalFBs constraint of '<em>Base FB Type</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateBaseFBType_validateInternalFBs(BaseFBType baseFBType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return baseFBType.validateInternalFBs(diagnostics, context);
	}
	...
	public boolean validateBasicFBType(BasicFBType basicFBType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLibraryElement_validatePackage(basicFBType, diagnostics, context);
		if (result || diagnostics != null) result &= validateBaseFBType_validateInternalFBs(basicFBType, diagnostics, context);
		return result;
	}
	...
	public boolean validateCompositeFBType(CompositeFBType compositeFBType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLibraryElement_validatePackage(compositeFBType, diagnostics, context);
		return result;
	}
	...
	public boolean validateConnection(Connection connection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateConnection_validateNegatedConnection(connection, diagnostics, context);
		return result;
	}
	...
	public boolean validateConnection_validateNegatedConnection(Connection connection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return connection.validateNegatedConnection(diagnostics, context);
	}
	 ...
	 * @generated
	 */
	public boolean validateContainerVarDeclaration(ContainerVarDeclaration containerVarDeclaration, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(containerVarDeclaration, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validateIInterfaceElement_validateName(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validateITypedElement_validateType(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validateIInterfaceElement_validateUnused(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validateVarDeclaration_validateMultipleInputConnections(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validateVarDeclaration_validateNoValueForGenericTypeVariable(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validateVarDeclaration_validateIllegalVariableLengthArrayVariable(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validateVarDeclaration_validateNoValueForVariableLengthArrayVariable(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validateVarDeclaration_validateValueForGenericInstanceVariable(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validateVarDeclaration_validateValueOverriddenBySubAppInput(containerVarDeclaration, diagnostics, context);
		if (result || diagnostics != null) result &= validateVarDeclaration_validateVarInOutSourceTypeIsWellDefined(containerVarDeclaration, diagnostics, context);
	...
	/**
	 * Validates the validateMemberInputConnections constraint of '<em>Container Var Declaration</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateContainerVarDeclaration_validateMemberInputConnections(ContainerVarDeclaration containerVarDeclaration, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return containerVarDeclaration.validateMemberInputConnections(diagnostics, context);
	}

	/**
	 * Validates the validateMemberInitialValues constraint of '<em>Container Var Declaration</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateContainerVarDeclaration_validateMemberInitialValues(ContainerVarDeclaration containerVarDeclaration, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return containerVarDeclaration.validateMemberInitialValues(diagnostics, context);
	}
	...
	public boolean validateDataConnection(DataConnection dataConnection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateConnection_validateNegatedConnection(dataConnection, diagnostics, context);
		return result;
	}
	...
	public boolean validateDeviceType(DeviceType deviceType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLibraryElement_validatePackage(deviceType, diagnostics, context);
		return result;
	}
	...
	public boolean validateEvent(Event event, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateIInterfaceElement_validateUnused(event, diagnostics, context);
	...
	public boolean validateEventConnection(EventConnection eventConnection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateConnection_validateNegatedConnection(eventConnection, diagnostics, context);
		return result;
	}
	...
	public boolean validateFBType(FBType fbType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLibraryElement_validatePackage(fbType, diagnostics, context);
		return result;
	}
	...
	public boolean validateFunctionFBType(FunctionFBType functionFBType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLibraryElement_validatePackage(functionFBType, diagnostics, context);
		return result;
	}
	...
	public boolean validateGlobalConstants(GlobalConstants globalConstants, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLibraryElement_validatePackage(globalConstants, diagnostics, context);
		return result;
	}
	...
	public boolean validateIInterfaceElement(IInterfaceElement iInterfaceElement, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateIInterfaceElement_validateUnused(iInterfaceElement, diagnostics, context);
		return result;
	}
	...
	/**
	 * Validates the validateUnused constraint of '<em>IInterface Element</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateIInterfaceElement_validateUnused(IInterfaceElement iInterfaceElement, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return iInterfaceElement.validateUnused(diagnostics, context);
	}
	...
	public boolean validateLibraryElement(LibraryElement libraryElement, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLibraryElement_validatePackage(libraryElement, diagnostics, context);
		return result;
	}
	...
	/**
	 * Validates the validatePackage constraint of '<em>Library Element</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateLibraryElement_validatePackage(LibraryElement libraryElement, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return libraryElement.validatePackage(diagnostics, context);
	}
	...
	public boolean validateResourceType(ResourceType resourceType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLibraryElement_validatePackage(resourceType, diagnostics, context);
		return result;
	}
	...
	public boolean validateSegmentType(SegmentType segmentType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLibraryElement_validatePackage(segmentType, diagnostics, context);
		return result;
	}
	...
	public boolean validateServiceInterfaceFBType(ServiceInterfaceFBType serviceInterfaceFBType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLibraryElement_validatePackage(serviceInterfaceFBType, diagnostics, context);
		return result;
	}
	...
	public boolean validateSubAppType(SubAppType subAppType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLibraryElement_validatePackage(subAppType, diagnostics, context);
		return result;
	}
	...
	public boolean validateVarConfigInstance(VarConfigInstance varConfigInstance, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateIInterfaceElement_validateUnused(varConfigInstance, diagnostics, context);
		...
		if (result || diagnostics != null) result &= validateVarDeclaration_validateIllegalVariableLengthArrayVariable(varConfigInstance, diagnostics, context);
		...
		if (result || diagnostics != null) result &= validateVarDeclaration_validateValueOverriddenBySubAppInput(varConfigInstance, diagnostics, context);
	 ...
	 * @generated
	 */
	public boolean validateOverrideAttribute(OverrideAttribute overrideAttribute, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(overrideAttribute, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(overrideAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(overrideAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(overrideAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(overrideAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(overrideAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(overrideAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(overrideAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(overrideAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validateAttribute_validateName(overrideAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validateITypedElement_validateType(overrideAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validateAttribute_validateAttributeDeclaration(overrideAttribute, diagnostics, context);
		if (result || diagnostics != null) result &= validateOverrideAttribute_validateLocation(overrideAttribute, diagnostics, context);
		return result;
	}

	/**
	 * Validates the validateLocation constraint of '<em>Override Attribute</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateOverrideAttribute_validateLocation(OverrideAttribute overrideAttribute, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return overrideAttribute.validateLocation(diagnostics, context);
	}
	...
	public boolean validateVarDeclaration(VarDeclaration varDeclaration, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateIInterfaceElement_validateUnused(varDeclaration, diagnostics, context);
		...
		if (result || diagnostics != null) result &= validateVarDeclaration_validateIllegalVariableLengthArrayVariable(varDeclaration, diagnostics, context);
		...
		if (result || diagnostics != null) result &= validateVarDeclaration_validateValueOverriddenBySubAppInput(varDeclaration, diagnostics, context);
	...
	/**
	 * Validates the validateIllegalVariableLengthArrayVariable constraint of '<em>Var Declaration</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateVarDeclaration_validateIllegalVariableLengthArrayVariable(VarDeclaration varDeclaration, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return varDeclaration.validateIllegalVariableLengthArrayVariable(diagnostics, context);
	}
	...
	/**
	 * Validates the validateValueOverriddenBySubAppInput constraint of '<em>Var Declaration</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateVarDeclaration_validateValueOverriddenBySubAppInput(VarDeclaration varDeclaration, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return varDeclaration.validateValueOverriddenBySubAppInput(diagnostics, context);
	}
