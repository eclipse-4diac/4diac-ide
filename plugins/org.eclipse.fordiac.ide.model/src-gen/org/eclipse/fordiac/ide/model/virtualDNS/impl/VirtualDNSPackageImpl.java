...
public class VirtualDNSPackageImpl extends EPackageImpl implements VirtualDNSPackage {
	 ...
	 *
	 * <p>
	 * This method is used to initialize {@link VirtualDNSPackage#eINSTANCE} when that field is accessed. Clients should
	...
	public static VirtualDNSPackage init() {
		...
		VirtualDNSPackageImpl theVirtualDNSPackage = registeredVirtualDNSPackage instanceof VirtualDNSPackageImpl
				? (VirtualDNSPackageImpl) registeredVirtualDNSPackage
				: new VirtualDNSPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEClass(virtualDNSEntryEClass, VirtualDNSEntry.class, "VirtualDNSEntry", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVirtualDNSEntry_Name(), ecorePackage.getEString(), "name", null, 0, 1, VirtualDNSEntry.class, //$NON-NLS-1$
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVirtualDNSEntry_Value(), ecorePackage.getEString(), "value", null, 0, 1, //$NON-NLS-1$
				VirtualDNSEntry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(virtualDNSCollectionEClass, VirtualDNSCollection.class, "VirtualDNSCollection", !IS_ABSTRACT, //$NON-NLS-1$
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getVirtualDNSCollection_VirtualDNSEntries(), this.getVirtualDNSEntry(), null,
				"virtualDNSEntries", null, 0, -1, VirtualDNSCollection.class, !IS_TRANSIENT, !IS_VOLATILE, //$NON-NLS-1$
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVirtualDNSCollection_Name(), ecorePackage.getEString(), "name", null, 0, 1, //$NON-NLS-1$
				VirtualDNSCollection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(virtualDNSManagementEClass, VirtualDNSManagement.class, "VirtualDNSManagement", !IS_ABSTRACT, //$NON-NLS-1$
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getVirtualDNSManagement_AvailableDNSCollections(), this.getVirtualDNSCollection(), null,
				"availableDNSCollections", null, 0, -1, VirtualDNSManagement.class, !IS_TRANSIENT, !IS_VOLATILE, //$NON-NLS-1$
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVirtualDNSManagement_ActiveVirtualDNS(), this.getVirtualDNSCollection(), null,
				"activeVirtualDNS", null, 0, 1, VirtualDNSManagement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
