...
/** <!-- begin-user-doc --> A representation of the model object '<em><b>Device Type</b></em>'. <!-- end-user-doc -->
 *
 * <p>
 ...
 * <li>{@link org.eclipse.fordiac.ide.model.libraryElement.DeviceType#getResourceTypeName <em>Resource Type
 * Name</em>}</li>
 ...
 * <li>{@link org.eclipse.fordiac.ide.model.libraryElement.DeviceType#getAttributeDeclarations <em>Attribute
 * Declarations</em>}</li>
 * </ul>
 *
...
public interface DeviceType extends CompilableType {
	/** Returns the value of the '<em><b>Var Declaration</b></em>' containment reference list. The list contents are of
	 * type {@link org.eclipse.fordiac.ide.model.libraryElement.VarDeclaration}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Var Declaration</em>' containment reference list isn't clear, there really should be
	...
	/** Returns the value of the '<em><b>Resource Type Name</b></em>' containment reference list. The list contents are
	 * of type {@link org.eclipse.fordiac.ide.model.libraryElement.ResourceTypeName}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Resource Type Name</em>' containment reference list isn't clear, there really should
	 ...
	 * @model containment="true" extendedMetaData="kind='element' name='ResourceTypeName' namespace='##targetNamespace'"
	 * @generated */
	 ...
	 * {@link org.eclipse.fordiac.ide.model.libraryElement.Resource}. <!-- begin-user-doc -->
	 * <p>
	...
	/** Sets the value of the '{@link org.eclipse.fordiac.ide.model.libraryElement.DeviceType#getFBNetwork <em>FB
	...
	/** Sets the value of the '{@link org.eclipse.fordiac.ide.model.libraryElement.DeviceType#getProfile
	...
	/** Returns the value of the '<em><b>Attribute Declarations</b></em>' containment reference list. The list contents
	 * are of type {@link org.eclipse.fordiac.ide.model.libraryElement.AttributeDeclaration}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Attribute Declarations</em>' containment reference list isn't clear, there really
