...
public interface Segment extends TypedConfigureableObject, PositionableElement, ColorizableElement {
	/** Returns the value of the '<em><b>Width</b></em>' attribute. The default value is <code>"200"</code>. <!--
	 * begin-user-doc -->
	 * <p>
	 ...
	 * @model default="200" dataType="org.eclipse.emf.ecore.xml.type.Int" extendedMetaData="kind='attribute' name='dx1'"
	 * @generated */
	int getWidth();

	/** Sets the value of the '{@link org.eclipse.fordiac.ide.model.libraryElement.Segment#getWidth <em>Width</em>}'
	...
	/** Returns the value of the '<em><b>Var Declarations</b></em>' containment reference list. The list contents are of
	 * type {@link org.eclipse.fordiac.ide.model.libraryElement.VarDeclaration}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Var Declarations</em>' containment reference list isn't clear, there really should be
	...
	/** Returns the value of the '<em><b>Out Connections</b></em>' reference list. The list contents are of type
	 * {@link org.eclipse.fordiac.ide.model.libraryElement.Link}. It is bidirectional and its opposite is
	 * '{@link org.eclipse.fordiac.ide.model.libraryElement.Link#getSegment <em>Segment</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Out Connections</em>' reference list isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
