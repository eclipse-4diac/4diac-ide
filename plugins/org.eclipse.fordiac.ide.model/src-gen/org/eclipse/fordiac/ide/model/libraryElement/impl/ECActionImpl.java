 ...
 * @generated
 */
public class ECActionImpl extends BaseECActionImpl implements ECAction {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 */
	@Override
	public Algorithm getAlgorithmModel() {
		if (getECState() == null) {return null;} return getECState().getECC().getBasicFBType().getAlgorithmNamed(getAlgorithm());
	}
