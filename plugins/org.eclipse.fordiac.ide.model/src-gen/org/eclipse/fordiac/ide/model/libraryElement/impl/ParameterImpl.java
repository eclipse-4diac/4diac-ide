...
public class ParameterImpl extends I4DIACElementImpl implements Parameter {
	...
	protected EClass eStaticClass() {
		return LibraryElementPackage.Literals.PARAMETER;
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryElementPackage.PARAMETER__COMMENT, oldComment, comment));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryElementPackage.PARAMETER__NAME, oldName, name));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryElementPackage.PARAMETER__VALUE, oldValue, value));
	}
