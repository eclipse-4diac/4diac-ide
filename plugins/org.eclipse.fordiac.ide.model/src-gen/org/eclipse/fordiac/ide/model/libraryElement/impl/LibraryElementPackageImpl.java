...
public class LibraryElementPackageImpl extends EPackageImpl implements LibraryElementPackage {
	 ...
	 * @generated
	 */
	private EClass blockFBNetworkElementEClass = null;
	 ...
	 * @generated
	 */
	private EClass containerVarDeclarationEClass = null;
	 ...
	 * @generated
	 */
	private EClass varConfigInstanceEClass = null;
	 ...
	 * @generated
	 */
	private EDataType interfaceTypeEntryEDataType = null;
	 ...
	 * @generated
	 */
	private EDataType blockFBNWElementStreamEDataType = null;
	 ...
	 */
	@Override
	public EClass getBaseECAction() {
		return baseECActionEClass;
	}
	 ...
	 */
	@Override
	public EReference getBaseECAction_Output() {
		return (EReference)baseECActionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getBaseFBType_SourceElements() {
		return (EReference)baseFBTypeEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EClass getBlockFBNetworkElement() {
		return blockFBNetworkElementEClass;
	}
	 ...
	 */
	@Override
	public EReference getBlockFBNetworkElement_Interface() {
		return (EReference)blockFBNetworkElementEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EClass getContainerVarDeclaration() {
		return containerVarDeclarationEClass;
	}
	 ...
	 */
	@Override
	public EReference getContainerVarDeclaration_CachedMembers() {
		return (EReference)containerVarDeclarationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getInterfaceList_BlockFBNetworkElement() {
	 ...
	 */
	@Override
	public EAttribute getTextFunction_Varargs() {
	 ...
	 */
	@Override
	public EAttribute getTextMethod_Varargs() {
	 ...
	 */
	@Override
	public EDataType getInterfaceTypeEntry() {
		return interfaceTypeEntryEDataType;
	}
	 ...
	 */
	@Override
	public EDataType getBlockFBNWElementStream() {
		return blockFBNWElementStreamEDataType;
	}
	...
	public void createPackageContents() {
		...
		baseECActionEClass = createEClass(BASE_EC_ACTION);
		...
		createEReference(baseFBTypeEClass, BASE_FB_TYPE__SOURCE_ELEMENTS);

		basicFBTypeEClass = createEClass(BASIC_FB_TYPE);
		createEReference(basicFBTypeEClass, BASIC_FB_TYPE__ECC);

		blockFBNetworkElementEClass = createEClass(BLOCK_FB_NETWORK_ELEMENT);
		createEReference(blockFBNetworkElementEClass, BLOCK_FB_NETWORK_ELEMENT__INTERFACE);
		...
		containerVarDeclarationEClass = createEClass(CONTAINER_VAR_DECLARATION);
		createEReference(containerVarDeclarationEClass, CONTAINER_VAR_DECLARATION__CACHED_MEMBERS);
		...
		createEReference(interfaceListEClass, INTERFACE_LIST__BLOCK_FB_NETWORK_ELEMENT);
		...
		varConfigInstanceEClass = createEClass(VAR_CONFIG_INSTANCE);
		...
		interfaceTypeEntryEDataType = createEDataType(INTERFACE_TYPE_ENTRY);
		blockFBNWElementStreamEDataType = createEDataType(BLOCK_FBNW_ELEMENT_STREAM);
	...
	public void initializePackageContents() {
		...
		blockFBNetworkElementEClass.getESuperTypes().add(this.getFBNetworkElement());
		...
		containerVarDeclarationEClass.getESuperTypes().add(this.getVarDeclaration());
		...
		fbEClass.getESuperTypes().add(this.getBlockFBNetworkElement());
		...
		addEOperation(algorithmEClass, this.getITypedElement(), "getInputParameters", 0, -1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(algorithmEClass, this.getITypedElement(), "getOutputParameters", 0, -1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(algorithmEClass, this.getITypedElement(), "getInOutParameters", 0, -1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getBaseFBType_SourceElements(), this.getSourceElement(), null, "sourceElements", null, 0, -1, BaseFBType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		op = addEOperation(baseFBTypeEClass, this.getAlgorithm(), "getAlgorithmNamed", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEString(), "name", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		op = addEOperation(baseFBTypeEClass, ecorePackage.getEBoolean(), "validateInternalFBs", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEClass(blockFBNetworkElementEClass, BlockFBNetworkElement.class, "BlockFBNetworkElement", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(getBlockFBNetworkElement_Interface(), this.getInterfaceList(), this.getInterfaceList_BlockFBNetworkElement(), "interface", null, 0, 1, BlockFBNetworkElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		addEOperation(blockFBNetworkElementEClass, this.getInterfaceList(), "getTypeInterface", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(blockFBNetworkElementEClass, null, "checkConnections", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		op = addEOperation(blockFBNetworkElementEClass, null, "setMapping", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, this.getMapping(), "newMapping", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(blockFBNetworkElementEClass, this.getBlockFBNetworkElement(), "getOpposite", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(blockFBNetworkElementEClass, this.getInterfaceTypeEntry(), "getTypeEntry", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		initEAttribute(getComment_Width(), theXMLTypePackage.getDouble(), "width", "1000", 0, 1, Comment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		initEAttribute(getComment_Height(), theXMLTypePackage.getDouble(), "height", "500", 0, 1, Comment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		...
		addEOperation(configurableMoveFBEClass, null, "updateConfiguration", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		addEOperation(connectionEClass, this.getBlockFBNetworkElement(), "getSourceElement", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(connectionEClass, this.getBlockFBNetworkElement(), "getDestinationElement", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		op = addEOperation(connectionEClass, null, "setNegated", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, theXMLTypePackage.getBoolean(), "negated", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		initEClass(containerVarDeclarationEClass, ContainerVarDeclaration.class, "ContainerVarDeclaration", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(getContainerVarDeclaration_CachedMembers(), this.getVarDeclaration(), null, "cachedMembers", null, 0, -1, ContainerVarDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		op = addEOperation(containerVarDeclarationEClass, this.getVarDeclaration(), "getCachedMember", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		op = addEOperation(containerVarDeclarationEClass, this.getVarDeclaration(), "getCachedMember", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, this.getStringList(), "path", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, theXMLTypePackage.getBoolean(), "demandCreate", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		op = addEOperation(containerVarDeclarationEClass, null, "getAllCachedMembers", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getETreeIterator());
		g2 = createEGenericType(this.getVarDeclaration());
		g1.getETypeArguments().add(g2);
		initEOperation(op, g1);
		...
		addEOperation(demultiplexerEClass, null, "updateConfiguration", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		addEOperation(ecActionEClass, this.getAlgorithm(), "getAlgorithmModel", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		op = addEOperation(errorMarkerInterfaceEClass, ecorePackage.getEBoolean(), "validateComment", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		addEOperation(eventEClass, this.getITypedElement(), "getInputParameters", 0, -1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(eventEClass, this.getITypedElement(), "getOutputParameters", 0, -1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(eventEClass, this.getITypedElement(), "getInOutParameters", 0, -1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		addEOperation(fbEClass, this.getITypedElement(), "getInputParameters", 0, -1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(fbEClass, this.getITypedElement(), "getOutputParameters", 0, -1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(fbEClass, this.getITypedElement(), "getInOutParameters", 0, -1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		addEOperation(fbNetworkEClass, this.getBlockFBNWElementStream(), "getBlockFBNetworkElements", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		op = addEOperation(fbNetworkElementEClass, ecorePackage.getEBoolean(), "validateType", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		addEOperation(fbNetworkElementEClass, theXMLTypePackage.getDouble(), "getVisibleWidth", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(fbNetworkElementEClass, theXMLTypePackage.getDouble(), "getVisibleHeight", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		addEOperation(fbTypeEClass, this.getITypedElement(), "getOutputParameters", 0, -1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(fbTypeEClass, this.getITypedElement(), "getInOutParameters", 0, -1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		addEOperation(iCallableEClass, this.getITypedElement(), "getInputParameters", 0, -1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(iCallableEClass, this.getITypedElement(), "getOutputParameters", 0, -1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(iCallableEClass, this.getITypedElement(), "getInOutParameters", 0, -1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(iCallableEClass, theDataPackage.getDataType(), "getReturnType", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(iCallableEClass, ecorePackage.getEString(), "getSignature", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(iCallableEClass, ecorePackage.getEBoolean(), "isVarargs", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		addEOperation(iInterfaceElementEClass, this.getBlockFBNetworkElement(), "getBlockFBNetworkElement", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		op = addEOperation(iInterfaceElementEClass, ecorePackage.getEBoolean(), "validateUnused", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		addEOperation(iInterfaceElementEClass, this.getStringList(), "getBlockRelativePath", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		op = addEOperation(iNamedElementEClass, ecorePackage.getEString(), "getRelativeName", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, this.getINamedElement(), "to", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getInterfaceList_BlockFBNetworkElement(), this.getBlockFBNetworkElement(), this.getBlockFBNetworkElement_Interface(), "BlockFBNetworkElement", null, 0, 1, InterfaceList.class, !IS_TRANSIENT, !IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		addEOperation(interfaceListEClass, this.getInterfaceElementStream(), "getAllInterfaceElements", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		addEParameter(op, this.getStringList(), "path", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		op = addEOperation(interfaceListEClass, this.getIInterfaceElement(), "getInterfaceElement", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, this.getIInterfaceElement(), "refElement", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		op = addEOperation(interfaceListEClass, this.getIInterfaceElement(), "getInterfaceElement", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, this.getStringList(), "path", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, theXMLTypePackage.getBoolean(), "demandCreate", 1, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		op = addEOperation(libraryElementEClass, ecorePackage.getEBoolean(), "validateName", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(libraryElementEClass, ecorePackage.getEBoolean(), "validatePackage", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		addEOperation(multiplexerEClass, null, "updateConfiguration", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		addEOperation(subAppEClass, theXMLTypePackage.getDouble(), "getVisibleWidth", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(subAppEClass, theXMLTypePackage.getDouble(), "getVisibleHeight", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getTextFunction_OutputParameters(), this.getITypedElement(), null, "outputParameters", null, 0, -1, TextFunction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getTextMethod_OutputParameters(), this.getITypedElement(), null, "outputParameters", null, 0, -1, TextMethod.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEClass(varConfigInstanceEClass, VarConfigInstance.class, "VarConfigInstance", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		op = addEOperation(varConfigInstanceEClass, ecorePackage.getEBoolean(), "validateName", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(varDeclarationEClass, ecorePackage.getEBoolean(), "validateDestinationTypeMismatch", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(varDeclarationEClass, ecorePackage.getEBoolean(), "validateHiddenPinConnected", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(varDeclarationEClass, null, "setVisible", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, theXMLTypePackage.getBoolean(), "visible", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(varDeclarationEClass, theXMLTypePackage.getBoolean(), "isVisible", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		initEDataType(interfaceTypeEntryEDataType, InterfaceTypeEntry.class, "InterfaceTypeEntry", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEDataType(blockFBNWElementStreamEDataType, Stream.class, "BlockFBNWElementStream", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS, "java.util.stream.Stream<org.eclipse.fordiac.ide.model.libraryElement.BlockFBNetworkElement>"); //$NON-NLS-1$ //$NON-NLS-2$
		initEDataType(stringArrayEDataType, String[].class, "StringArray", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEDataType(stringListEDataType, List.class, "StringList", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS, "java.util.List<java.lang.String>"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (connectionEClass.getEOperations().get(5),
		   source,
		   new String[] {
			   "invariant", "true" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		...
		addAnnotation
		  (errorMarkerInterfaceEClass.getEOperations().get(2),
		   source,
		   new String[] {
			   "invariant", "true" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		...
		addAnnotation
		  (fbNetworkElementEClass.getEOperations().get(9),
		   source,
		   new String[] {
			   "invariant", "true" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		...
		addAnnotation
		  (groupEClass.getEOperations().get(0),
		   source,
		   new String[] {
			   "invariant", "true" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		...
		addAnnotation
		  (iInterfaceElementEClass.getEOperations().get(4),
		   source,
		   new String[] {
			   "invariant", "true" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		...
		addAnnotation
		  (libraryElementEClass.getEOperations().get(3),
		   source,
		   new String[] {
			   "invariant", "true" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		...
		addAnnotation
		  (varConfigInstanceEClass.getEOperations().get(0),
		   source,
		   new String[] {
			   "invariant", "true" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		...
		addAnnotation
		  (varDeclarationEClass.getEOperations().get(16),
		   source,
		   new String[] {
			   "invariant", "true" //$NON-NLS-1$ //$NON-NLS-2$
		   });
