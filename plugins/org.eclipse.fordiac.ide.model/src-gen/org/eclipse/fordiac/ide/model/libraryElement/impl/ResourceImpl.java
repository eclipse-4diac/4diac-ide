...
public class ResourceImpl extends TypedConfigureableObjectImpl implements Resource {
	...
	public NotificationChain basicSetFBNetwork(FBNetwork newFBNetwork, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LibraryElementPackage.RESOURCE__FB_NETWORK, oldFBNetwork, newFBNetwork);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newFBNetwork != fBNetwork) {
			...
			if (fBNetwork != null)
				msgs = ((InternalEObject) fBNetwork).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - LibraryElementPackage.RESOURCE__FB_NETWORK, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryElementPackage.RESOURCE__FB_NETWORK,
	...
	public void setDevice(Device newDevice) {
		if (newDevice != eInternalContainer()
				|| (eContainerFeatureID() != LibraryElementPackage.RESOURCE__DEVICE && newDevice != null)) {
			...
			if (newDevice != null)
				msgs = ((InternalEObject) newDevice).eInverseAdd(this, LibraryElementPackage.DEVICE__RESOURCE,
						Device.class, msgs);
			msgs = basicSetDevice(newDevice, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryElementPackage.RESOURCE__DEVICE, newDevice,
					newDevice));
	}
	...
	public void setDeviceTypeResource(boolean newDeviceTypeResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryElementPackage.RESOURCE__DEVICE_TYPE_RESOURCE,
	...
	public EList<VarDeclaration> getVarDeclarations() {
		if (varDeclarations == null) {
			varDeclarations = new EObjectContainmentEList.Resolving<VarDeclaration>(VarDeclaration.class, this,
					LibraryElementPackage.RESOURCE__VAR_DECLARATIONS);
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IVarElement.class) {
			...
			case LibraryElementPackage.IVAR_ELEMENT__VAR_DECLARATIONS:
				return LibraryElementPackage.RESOURCE__VAR_DECLARATIONS;
			default:
				return -1;
			}
		}
