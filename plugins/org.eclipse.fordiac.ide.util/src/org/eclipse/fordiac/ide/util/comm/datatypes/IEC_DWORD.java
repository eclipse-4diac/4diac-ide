...
public class IEC_DWORD extends IEC_ANY_BIT {
	...
	public IEC_DWORD(int initial) {
		this.value=initial;
	}
	
	public IEC_DWORD(DataInputStream in) {
		super(in);
	}
	...
	public byte[] encodeTag() {
		...
		retval[0] = (0xff & (ASN1.APPLICATION + ASN1.DWORD));
		return retval;
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof IEC_DWORD)
			if (this.value == ((IEC_DWORD) obj).value)
				return true;
		return false;
	}
	...
	public boolean setValue(String source) {
		// TODO Implement String-Parsing for DWORD
		return false;
	}
}
