...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		if (isWin32) {
			...
			store.setDefault(PreferenceConstants.P_PATH, Messages.PreferenceInitializer_SetPathToTheFBRT);
			store.setDefault(PreferenceConstants.P_LIB, Messages.PreferenceInitializer_SetTheUsedFBRTLibraries);
		}
	}
