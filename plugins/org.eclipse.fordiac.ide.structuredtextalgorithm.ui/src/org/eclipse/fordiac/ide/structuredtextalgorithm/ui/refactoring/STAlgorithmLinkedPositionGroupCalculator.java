...
public class STAlgorithmLinkedPositionGroupCalculator extends STCoreLinkedPositionGroupCalculator {
	...
	public Provider<LinkedPositionGroup> getLinkedPositionGroup(final IRenameElementContext renameElementContext,
		...
		if (LibraryElementPackage.Literals.IINTERFACE_ELEMENT
				.isSuperTypeOf(renameElementContext.getTargetElementEClass())) {
			return LinkedPositionGroup::new; // do not use linked editing for interface refactorings
		}
