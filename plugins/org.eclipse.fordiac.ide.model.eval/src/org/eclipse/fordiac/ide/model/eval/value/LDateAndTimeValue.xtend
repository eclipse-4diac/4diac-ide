...
class LDateAndTimeValue extends AnyDateValue {
	final long value;
	...
	def static toLDateAndTimeValue(String value) { LocalDateTime.parse(value, DATE_AND_TIME_FORMATTER).toLDateAndTimeValue }
