		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFunc_CallAccess().getFuncAlternatives_0_0(), "rule__Func_Call__FuncAlternatives_0_0");
					put(grammarAccess.getParam_AssignAccess().getAlternatives(), "rule__Param_Assign__Alternatives");
					put(grammarAccess.getVariable_SubscriptAccess().getAlternatives_0(), "rule__Variable_Subscript__Alternatives_0");
					...
					put(grammarAccess.getInt_LiteralAccess().getValueAlternatives_1_0(), "rule__Int_Literal__ValueAlternatives_1_0");
					...
					put(grammarAccess.getChar_LiteralAccess().getValueAlternatives_1_0(), "rule__Char_Literal__ValueAlternatives_1_0");
					...
					put(grammarAccess.getAny_Bit_Type_NameAccess().getAlternatives(), "rule__Any_Bit_Type_Name__Alternatives");
					put(grammarAccess.getStructuredTextAlgorithmAccess().getGroup(), "rule__StructuredTextAlgorithm__Group__0");
					put(grammarAccess.getStructuredTextAlgorithmAccess().getGroup_1(), "rule__StructuredTextAlgorithm__Group_1__0");
					put(grammarAccess.getStructuredTextAlgorithmAccess().getGroup_1_1(), "rule__StructuredTextAlgorithm__Group_1_1__0");
					...
					put(grammarAccess.getVariable_SubscriptAccess().getGroup_1(), "rule__Variable_Subscript__Group_1__0");
					put(grammarAccess.getVariable_SubscriptAccess().getGroup_1_3(), "rule__Variable_Subscript__Group_1_3__0");
					...
					put(grammarAccess.getStructuredTextAlgorithmAccess().getLocalVariablesAssignment_1_1_0(), "rule__StructuredTextAlgorithm__LocalVariablesAssignment_1_1_0");
					put(grammarAccess.getStructuredTextAlgorithmAccess().getStatementsAssignment_2(), "rule__StructuredTextAlgorithm__StatementsAssignment_2");
					put(grammarAccess.getVar_Decl_InitAccess().getConstantAssignment_1(), "rule__Var_Decl_Init__ConstantAssignment_1");
					put(grammarAccess.getVar_Decl_InitAccess().getNameAssignment_2(), "rule__Var_Decl_Init__NameAssignment_2");
					put(grammarAccess.getVar_Decl_InitAccess().getTypeAssignment_4(), "rule__Var_Decl_Init__TypeAssignment_4");
					put(grammarAccess.getVar_Decl_InitAccess().getArrayAssignment_5_0(), "rule__Var_Decl_Init__ArrayAssignment_5_0");
					put(grammarAccess.getVar_Decl_InitAccess().getArraySizeAssignment_5_1(), "rule__Var_Decl_Init__ArraySizeAssignment_5_1");
					put(grammarAccess.getVar_Decl_InitAccess().getInitialValueAssignment_6_1(), "rule__Var_Decl_Init__InitialValueAssignment_6_1");
					put(grammarAccess.getStmt_ListAccess().getStatementsAssignment_1_0(), "rule__Stmt_List__StatementsAssignment_1_0");
					put(grammarAccess.getAssign_StmtAccess().getVariableAssignment_0(), "rule__Assign_Stmt__VariableAssignment_0");
					put(grammarAccess.getAssign_StmtAccess().getExpressionAssignment_2(), "rule__Assign_Stmt__ExpressionAssignment_2");
					put(grammarAccess.getIF_StmtAccess().getExpressionAssignment_1(), "rule__IF_Stmt__ExpressionAssignment_1");
					put(grammarAccess.getIF_StmtAccess().getStatmentsAssignment_3(), "rule__IF_Stmt__StatmentsAssignment_3");
					...
					put(grammarAccess.getELSIF_ClauseAccess().getExpressionAssignment_1(), "rule__ELSIF_Clause__ExpressionAssignment_1");
					put(grammarAccess.getELSIF_ClauseAccess().getStatementsAssignment_3(), "rule__ELSIF_Clause__StatementsAssignment_3");
					put(grammarAccess.getELSE_ClauseAccess().getStatementsAssignment_1(), "rule__ELSE_Clause__StatementsAssignment_1");
					put(grammarAccess.getCase_StmtAccess().getExpressionAssignment_1(), "rule__Case_Stmt__ExpressionAssignment_1");
					...
					put(grammarAccess.getCase_SelectionAccess().getCaseAssignment_0(), "rule__Case_Selection__CaseAssignment_0");
					put(grammarAccess.getCase_SelectionAccess().getCaseAssignment_1_1(), "rule__Case_Selection__CaseAssignment_1_1");
					put(grammarAccess.getCase_SelectionAccess().getStatementsAssignment_3(), "rule__Case_Selection__StatementsAssignment_3");
					...
					put(grammarAccess.getFor_StmtAccess().getStatementsAssignment_8(), "rule__For_Stmt__StatementsAssignment_8");
					put(grammarAccess.getWhile_StmtAccess().getExpressionAssignment_1(), "rule__While_Stmt__ExpressionAssignment_1");
					...
					put(grammarAccess.getRepeat_StmtAccess().getExpressionAssignment_3(), "rule__Repeat_Stmt__ExpressionAssignment_3");
					put(grammarAccess.getOr_ExpressionAccess().getOperatorAssignment_1_1(), "rule__Or_Expression__OperatorAssignment_1_1");
					put(grammarAccess.getOr_ExpressionAccess().getRightAssignment_1_2(), "rule__Or_Expression__RightAssignment_1_2");
					...
					put(grammarAccess.getFunc_CallAccess().getArgsAssignment_2_0(), "rule__Func_Call__ArgsAssignment_2_0");
					put(grammarAccess.getFunc_CallAccess().getArgsAssignment_2_1_1(), "rule__Func_Call__ArgsAssignment_2_1_1");
					put(grammarAccess.getParam_Assign_InAccess().getVarAssignment_0_0(), "rule__Param_Assign_In__VarAssignment_0_0");
					put(grammarAccess.getParam_Assign_InAccess().getExprAssignment_1(), "rule__Param_Assign_In__ExprAssignment_1");
					put(grammarAccess.getParam_Assign_OutAccess().getNotAssignment_0(), "rule__Param_Assign_Out__NotAssignment_0");
					put(grammarAccess.getParam_Assign_OutAccess().getVarAssignment_1(), "rule__Param_Assign_Out__VarAssignment_1");
					put(grammarAccess.getParam_Assign_OutAccess().getExprAssignment_3(), "rule__Param_Assign_Out__ExprAssignment_3");
					put(grammarAccess.getVariable_SubscriptAccess().getIndexAssignment_1_2(), "rule__Variable_Subscript__IndexAssignment_1_2");
					put(grammarAccess.getVariable_SubscriptAccess().getIndexAssignment_1_3_1(), "rule__Variable_Subscript__IndexAssignment_1_3_1");
					put(grammarAccess.getVariable_AdapterAccess().getAdapterAssignment_1(), "rule__Variable_Adapter__AdapterAssignment_1");
					put(grammarAccess.getVariable_AdapterAccess().getVarAssignment_3(), "rule__Variable_Adapter__VarAssignment_3");
					put(grammarAccess.getVariable_PrimaryAccess().getVarAssignment(), "rule__Variable_Primary__VarAssignment");
					put(grammarAccess.getInt_LiteralAccess().getTypeAssignment_0_0(), "rule__Int_Literal__TypeAssignment_0_0");
					put(grammarAccess.getInt_LiteralAccess().getValueAssignment_1(), "rule__Int_Literal__ValueAssignment_1");
					put(grammarAccess.getReal_LiteralAccess().getTypeAssignment_0_0(), "rule__Real_Literal__TypeAssignment_0_0");
					put(grammarAccess.getReal_LiteralAccess().getValueAssignment_1(), "rule__Real_Literal__ValueAssignment_1");
					put(grammarAccess.getBool_LiteralAccess().getTypeAssignment_0_0(), "rule__Bool_Literal__TypeAssignment_0_0");
					put(grammarAccess.getBool_LiteralAccess().getValueAssignment_1(), "rule__Bool_Literal__ValueAssignment_1");
					put(grammarAccess.getChar_LiteralAccess().getTypeAssignment_0_0(), "rule__Char_Literal__TypeAssignment_0_0");
					put(grammarAccess.getChar_LiteralAccess().getLengthAssignment_0_1(), "rule__Char_Literal__LengthAssignment_0_1");
					put(grammarAccess.getChar_LiteralAccess().getValueAssignment_1(), "rule__Char_Literal__ValueAssignment_1");
					put(grammarAccess.getDurationAccess().getTypeAssignment_0(), "rule__Duration__TypeAssignment_0");
					put(grammarAccess.getDurationAccess().getNegativeAssignment_2_1(), "rule__Duration__NegativeAssignment_2_1");
					put(grammarAccess.getDurationAccess().getValueAssignment_3(), "rule__Duration__ValueAssignment_3");
					put(grammarAccess.getDurationAccess().getValueAssignment_4_1(), "rule__Duration__ValueAssignment_4_1");
					put(grammarAccess.getDuration_ValueAccess().getValueAssignment_0(), "rule__Duration_Value__ValueAssignment_0");
					put(grammarAccess.getDuration_ValueAccess().getUnitAssignment_1(), "rule__Duration_Value__UnitAssignment_1");
					put(grammarAccess.getTime_Of_DayAccess().getTypeAssignment_0(), "rule__Time_Of_Day__TypeAssignment_0");
					put(grammarAccess.getTime_Of_DayAccess().getValueAssignment_2(), "rule__Time_Of_Day__ValueAssignment_2");
					...
					put(grammarAccess.getDate_And_TimeAccess().getTypeAssignment_0(), "rule__Date_And_Time__TypeAssignment_0");
					put(grammarAccess.getDate_And_TimeAccess().getValueAssignment_2(), "rule__Date_And_Time__ValueAssignment_2");
				}
			};
		}
