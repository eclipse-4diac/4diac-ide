...
public class StructuredTextParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, StructuredTextGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFBCallAccess().getGroup(), "rule__FBCall__Group__0");
			builder.put(grammarAccess.getFBCallAccess().getGroup_4(), "rule__FBCall__Group_4__0");
			builder.put(grammarAccess.getFBCallAccess().getGroup_4_1(), "rule__FBCall__Group_4_1__0");
			...
			builder.put(grammarAccess.getFBCallAccess().getFbAssignment_0(), "rule__FBCall__FbAssignment_0");
			builder.put(grammarAccess.getFBCallAccess().getEventAssignment_2(), "rule__FBCall__EventAssignment_2");
			builder.put(grammarAccess.getFBCallAccess().getArgsAssignment_4_0(), "rule__FBCall__ArgsAssignment_4_0");
			builder.put(grammarAccess.getFBCallAccess().getArgsAssignment_4_1_1(), "rule__FBCall__ArgsAssignment_4_1_1");
