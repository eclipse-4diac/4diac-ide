...
public class GlobalConstantsInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new GlobalConstantsStandaloneSetup() {
			@Override
	...
	protected GlobalConstantsRuntimeModule createRuntimeModule() {
		...
		return new GlobalConstantsRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return GlobalConstantsInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
