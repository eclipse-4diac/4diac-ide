...
import org.eclipse.fordiac.ide.model.structuredtext.validation.StructuredTextValidator;
...
public abstract class AbstractStructuredTextRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder,
				"org/eclipse/fordiac/ide/model/structuredtext/StructuredText.properties");
		super.configure(binder);
	}

	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME))
				.toInstance("org.eclipse.fordiac.ide.model.structuredtext.StructuredText");
	}
	...
	public Class<? extends StructuredTextValidator> bindStructuredTextValidator() {
		return StructuredTextValidator.class;
	}
