 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.UnaryExpressionImpl#getOperator
 * <em>Operator</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.UnaryExpressionImpl#getExpression
 * <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
...
public class UnaryExpressionImpl extends ExpressionImpl implements UnaryExpression {
	...
	public void setOperator(UnaryOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.UNARY_EXPRESSION__OPERATOR,
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.UNARY_EXPRESSION__EXPRESSION, oldExpression, newExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject) expression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.UNARY_EXPRESSION__EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.UNARY_EXPRESSION__EXPRESSION,
