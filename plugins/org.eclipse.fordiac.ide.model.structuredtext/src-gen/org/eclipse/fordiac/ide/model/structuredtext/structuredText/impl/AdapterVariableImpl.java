 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.AdapterVariableImpl#getAdapter
 * <em>Adapter</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.AdapterVariableImpl#getVar
 * <em>Var</em>}</li>
 * </ul>
 *
 * @generated
...
public class AdapterVariableImpl extends VariableImpl implements AdapterVariable {
			...
			if (adapter != oldAdapter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							StructuredTextPackage.ADAPTER_VARIABLE__ADAPTER, oldAdapter, adapter));
			}
		}
		return adapter;
	}
	...
	public void setAdapter(AdapterDeclaration newAdapter) {
		...
		adapter = newAdapter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.ADAPTER_VARIABLE__ADAPTER,
					oldAdapter, adapter));
	}
	...
	public VarDeclaration getVar() {
		if (var != null && var.eIsProxy()) {
			...
			if (var != oldVar) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							StructuredTextPackage.ADAPTER_VARIABLE__VAR, oldVar, var));
			}
		}
		return var;
	}
	...
	public void setVar(VarDeclaration newVar) {
		...
		var = newVar;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.ADAPTER_VARIABLE__VAR, oldVar,
					var));
	}
