 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.AssignmentStatementImpl#getVariable
 * <em>Variable</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.AssignmentStatementImpl#getExpression
 * <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
...
public class AssignmentStatementImpl extends StatementImpl implements AssignmentStatement {
	...
	public NotificationChain basicSetVariable(Variable newVariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.ASSIGNMENT_STATEMENT__VARIABLE, oldVariable, newVariable);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newVariable != variable) {
			...
			if (variable != null)
				msgs = ((InternalEObject) variable).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.ASSIGNMENT_STATEMENT__VARIABLE, null, msgs);
			if (newVariable != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.ASSIGNMENT_STATEMENT__VARIABLE,
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.ASSIGNMENT_STATEMENT__EXPRESSION, oldExpression, newExpression);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject) expression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.ASSIGNMENT_STATEMENT__EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.ASSIGNMENT_STATEMENT__EXPRESSION, newExpression, newExpression));
	}
