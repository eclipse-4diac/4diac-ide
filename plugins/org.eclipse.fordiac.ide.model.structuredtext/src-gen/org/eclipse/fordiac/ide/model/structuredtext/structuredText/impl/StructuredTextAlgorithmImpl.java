 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.StructuredTextAlgorithmImpl#getLocalVariables
 * <em>Local Variables</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.StructuredTextAlgorithmImpl#getStatements
 * <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
...
public class StructuredTextAlgorithmImpl extends MinimalEObjectImpl.Container implements StructuredTextAlgorithm {
	...
	public EList<VarDeclaration> getLocalVariables() {
		if (localVariables == null) {
			localVariables = new EObjectContainmentEList<VarDeclaration>(VarDeclaration.class, this,
					StructuredTextPackage.STRUCTURED_TEXT_ALGORITHM__LOCAL_VARIABLES);
		}
	...
	public NotificationChain basicSetStatements(StatementList newStatements, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.STRUCTURED_TEXT_ALGORITHM__STATEMENTS, oldStatements, newStatements);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newStatements != statements) {
			...
			if (statements != null)
				msgs = ((InternalEObject) statements).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.STRUCTURED_TEXT_ALGORITHM__STATEMENTS, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.STRUCTURED_TEXT_ALGORITHM__STATEMENTS, newStatements, newStatements));
	}
