...
public class InternalStructuredTextParser extends AbstractInternalAntlrParser {
	...
	public final EObject ruleVar_Decl_Init() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:151:2: ( ( () ( (lv_constant_1_0= CONSTANT )
			...
			// InternalStructuredTextParser.g:152:2: ( () ( (lv_constant_1_0= CONSTANT ) )?
			// ( (lv_name_2_0= RULE_ID ) ) otherlv_3= Colon ( ( ruleType_Name ) ) ( (
			// (lv_array_5_0= LeftSquareBracket ) ) ( (lv_arraySize_6_0= ruleArray_Size ) )
			// otherlv_7= RightSquareBracket )? (otherlv_8= ColonEqualsSign (
			// (lv_initialValue_9_0= ruleConstant ) ) )? )
			{
				...
				// otherlv_7= RightSquareBracket )? (otherlv_8= ColonEqualsSign (
				// (lv_initialValue_9_0= ruleConstant ) ) )? )
				// InternalStructuredTextParser.g:153:3: () ( (lv_constant_1_0= CONSTANT ) )? (
				// (lv_name_2_0= RULE_ID ) ) otherlv_3= Colon ( ( ruleType_Name ) ) ( (
				// (lv_array_5_0= LeftSquareBracket ) ) ( (lv_arraySize_6_0= ruleArray_Size ) )
				// otherlv_7= RightSquareBracket )? (otherlv_8= ColonEqualsSign (
				// (lv_initialValue_9_0= ruleConstant ) ) )?
				{
					...
					// InternalStructuredTextParser.g:154:4:
					{
						...
						current = forceCreateModelElement(
								grammarAccess.getVar_Decl_InitAccess().getLocalVariableAction_0(), current);
					...
					// InternalStructuredTextParser.g:161:4: (lv_constant_1_0= CONSTANT )
					{
						...
						// InternalStructuredTextParser.g:162:5: lv_constant_1_0= CONSTANT
						{
							...
							newLeafNode(lv_constant_1_0,
									grammarAccess.getVar_Decl_InitAccess().getConstantCONSTANTKeyword_1_0());
					...
					// InternalStructuredTextParser.g:175:4: (lv_name_2_0= RULE_ID )
					{
						...
						// InternalStructuredTextParser.g:176:5: lv_name_2_0= RULE_ID
						{
							...
							newLeafNode(lv_name_2_0,
									grammarAccess.getVar_Decl_InitAccess().getNameIDTerminalRuleCall_2_0());
					...
					// InternalStructuredTextParser.g:197:4: ( ruleType_Name )
					{
						...
						// InternalStructuredTextParser.g:198:5: ruleType_Name
						{
							...
							newCompositeNode(
									grammarAccess.getVar_Decl_InitAccess().getTypeDataTypeCrossReference_4_0());
					...
					// InternalStructuredTextParser.g:212:3: ( ( (lv_array_5_0= LeftSquareBracket )
					...
					// ( (lv_arraySize_6_0= ruleArray_Size ) ) otherlv_7= RightSquareBracket
					{
						...
						// InternalStructuredTextParser.g:214:5: (lv_array_5_0= LeftSquareBracket )
						{
							...
							// InternalStructuredTextParser.g:215:6: lv_array_5_0= LeftSquareBracket
							{
								...
								newLeafNode(lv_array_5_0, grammarAccess.getVar_Decl_InitAccess()
						...
						// InternalStructuredTextParser.g:228:5: (lv_arraySize_6_0= ruleArray_Size )
						{
							...
							// InternalStructuredTextParser.g:229:6: lv_arraySize_6_0= ruleArray_Size
							{
								...
								newCompositeNode(grammarAccess.getVar_Decl_InitAccess()
						...
						newLeafNode(otherlv_7,
								grammarAccess.getVar_Decl_InitAccess().getRightSquareBracketKeyword_5_2());
					...
					// InternalStructuredTextParser.g:251:3: (otherlv_8= ColonEqualsSign (
					// (lv_initialValue_9_0= ruleConstant ) ) )?
					int alt5 = 2;
					...
					switch (alt5) {
					case 1:
					// InternalStructuredTextParser.g:252:4: otherlv_8= ColonEqualsSign (
					// (lv_initialValue_9_0= ruleConstant ) )
					{
	...
	// InternalStructuredTextParser.g:280:1: entryRuleStmt_List returns [EObject
	...
	// InternalStructuredTextParser.g:287:1: ruleStmt_List returns [EObject
	...
	public final EObject ruleStmt_List() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:293:2: ( ( () ( ( (lv_statements_1_0= ruleStmt
			// ) )? otherlv_2= Semicolon )* ) )
			// InternalStructuredTextParser.g:294:2: ( () ( ( (lv_statements_1_0= ruleStmt )
			// )? otherlv_2= Semicolon )* )
			{
				// InternalStructuredTextParser.g:294:2: ( () ( ( (lv_statements_1_0= ruleStmt )
				// )? otherlv_2= Semicolon )* )
				// InternalStructuredTextParser.g:295:3: () ( ( (lv_statements_1_0= ruleStmt )
				// )? otherlv_2= Semicolon )*
				{
					...
					// InternalStructuredTextParser.g:302:3: ( ( (lv_statements_1_0= ruleStmt ) )?
					// otherlv_2= Semicolon )*
					loop7: do {
						int alt7 = 2;
						switch (input.LA(1)) {
						...
						// otherlv_2= Semicolon
						{
							...
							if ((LA6_0 == CONTINUE || (LA6_0 >= REPEAT && LA6_0 <= RETURN) || LA6_0 == SUPER
									|| LA6_0 == WHILE || LA6_0 == CASE || LA6_0 == EXIT || LA6_0 == TIME || LA6_0 == FOR
									|| (LA6_0 >= DT && LA6_0 <= IF) || LA6_0 == LT || LA6_0 == T || LA6_0 == RULE_ID)) {
								alt6 = 1;
							}
							switch (alt6) {
							case 1:
	...
	// InternalStructuredTextParser.g:331:1: entryRuleStmt returns [EObject
	...
	// InternalStructuredTextParser.g:338:1: ruleStmt returns [EObject current=null]
	...
	public final EObject ruleStmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:344:2: ( (this_Assign_Stmt_0= ruleAssign_Stmt
			...
			// InternalStructuredTextParser.g:345:2: (this_Assign_Stmt_0= ruleAssign_Stmt |
			// this_Subprog_Ctrl_Stmt_1= ruleSubprog_Ctrl_Stmt | this_Selection_Stmt_2=
			// ruleSelection_Stmt | this_Iteration_Stmt_3= ruleIteration_Stmt )
			{
				// InternalStructuredTextParser.g:345:2: (this_Assign_Stmt_0= ruleAssign_Stmt |
				...
				// InternalStructuredTextParser.g:346:3: this_Assign_Stmt_0= ruleAssign_Stmt
				{
					...
					break;
				case 2:
				// InternalStructuredTextParser.g:355:3: this_Subprog_Ctrl_Stmt_1=
				// ruleSubprog_Ctrl_Stmt
				{
					...
					break;
				case 3:
				// InternalStructuredTextParser.g:364:3: this_Selection_Stmt_2=
				// ruleSelection_Stmt
				{
					...
					break;
				case 4:
				// InternalStructuredTextParser.g:373:3: this_Iteration_Stmt_3=
				// ruleIteration_Stmt
				{
	...
	// InternalStructuredTextParser.g:385:1: entryRuleAssign_Stmt returns [EObject
	...
	public final EObject entryRuleAssign_Stmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:385:52: (iv_ruleAssign_Stmt= ruleAssign_Stmt
			// EOF )
	...
	// InternalStructuredTextParser.g:392:1: ruleAssign_Stmt returns [EObject
	...
	public final EObject ruleAssign_Stmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:398:2: ( ( ( (lv_variable_0_0= ruleVariable )
			// ) otherlv_1= ColonEqualsSign ( (lv_expression_2_0= ruleExpression ) ) ) )
			// InternalStructuredTextParser.g:399:2: ( ( (lv_variable_0_0= ruleVariable ) )
			// otherlv_1= ColonEqualsSign ( (lv_expression_2_0= ruleExpression ) ) )
			{
				// InternalStructuredTextParser.g:399:2: ( ( (lv_variable_0_0= ruleVariable ) )
				// otherlv_1= ColonEqualsSign ( (lv_expression_2_0= ruleExpression ) ) )
	...
	// InternalStructuredTextParser.g:446:1: entryRuleSubprog_Ctrl_Stmt returns
	...
	public final EObject entryRuleSubprog_Ctrl_Stmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:446:58: (iv_ruleSubprog_Ctrl_Stmt=
			// ruleSubprog_Ctrl_Stmt EOF )
			// InternalStructuredTextParser.g:447:2: iv_ruleSubprog_Ctrl_Stmt=
			// ruleSubprog_Ctrl_Stmt EOF
			{
	...
	// InternalStructuredTextParser.g:453:1: ruleSubprog_Ctrl_Stmt returns [EObject
	...
	public final EObject ruleSubprog_Ctrl_Stmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:459:2: ( (this_Func_Call_0= ruleFunc_Call | (
			// () otherlv_2= SUPER otherlv_3= LeftParenthesis otherlv_4= RightParenthesis )
			// | ( () otherlv_6= RETURN ) ) )
			// InternalStructuredTextParser.g:460:2: (this_Func_Call_0= ruleFunc_Call | ( ()
			// otherlv_2= SUPER otherlv_3= LeftParenthesis otherlv_4= RightParenthesis ) | (
			// () otherlv_6= RETURN ) )
			{
				// InternalStructuredTextParser.g:460:2: (this_Func_Call_0= ruleFunc_Call | ( ()
				...
				// InternalStructuredTextParser.g:461:3: this_Func_Call_0= ruleFunc_Call
				{
					...
					break;
				case 2:
				// InternalStructuredTextParser.g:470:3: ( () otherlv_2= SUPER otherlv_3=
				// LeftParenthesis otherlv_4= RightParenthesis )
				{
					// InternalStructuredTextParser.g:470:3: ( () otherlv_2= SUPER otherlv_3=
					// LeftParenthesis otherlv_4= RightParenthesis )
					// InternalStructuredTextParser.g:471:4: () otherlv_2= SUPER otherlv_3=
					// LeftParenthesis otherlv_4= RightParenthesis
					{
	...
	// InternalStructuredTextParser.g:509:1: entryRuleSelection_Stmt returns
	...
	public final EObject entryRuleSelection_Stmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:509:55: (iv_ruleSelection_Stmt=
			// ruleSelection_Stmt EOF )
			// InternalStructuredTextParser.g:510:2: iv_ruleSelection_Stmt=
			// ruleSelection_Stmt EOF
			{
	...
	// InternalStructuredTextParser.g:516:1: ruleSelection_Stmt returns [EObject
	...
	public final EObject ruleSelection_Stmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:522:2: ( (this_IF_Stmt_0= ruleIF_Stmt |
			// this_Case_Stmt_1= ruleCase_Stmt ) )
			// InternalStructuredTextParser.g:523:2: (this_IF_Stmt_0= ruleIF_Stmt |
			// this_Case_Stmt_1= ruleCase_Stmt )
			{
				// InternalStructuredTextParser.g:523:2: (this_IF_Stmt_0= ruleIF_Stmt |
				// this_Case_Stmt_1= ruleCase_Stmt )
	...
	// InternalStructuredTextParser.g:545:1: entryRuleIF_Stmt returns [EObject
	...
	// InternalStructuredTextParser.g:552:1: ruleIF_Stmt returns [EObject
	...
	public final EObject ruleIF_Stmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:558:2: ( (otherlv_0= IF ( (lv_expression_1_0=
			// ruleExpression ) ) otherlv_2= THEN ( (lv_statments_3_0= ruleStmt_List ) ) (
			// (lv_elseif_4_0= ruleELSIF_Clause ) )* ( (lv_else_5_0= ruleELSE_Clause ) )?
			// otherlv_6= END_IF ) )
			// InternalStructuredTextParser.g:559:2: (otherlv_0= IF ( (lv_expression_1_0=
			// ruleExpression ) ) otherlv_2= THEN ( (lv_statments_3_0= ruleStmt_List ) ) (
			// (lv_elseif_4_0= ruleELSIF_Clause ) )* ( (lv_else_5_0= ruleELSE_Clause ) )?
			// otherlv_6= END_IF )
			{
				...
				// (lv_elseif_4_0= ruleELSIF_Clause ) )* ( (lv_else_5_0= ruleELSE_Clause ) )?
				// otherlv_6= END_IF )
				// InternalStructuredTextParser.g:560:3: otherlv_0= IF ( (lv_expression_1_0=
				// ruleExpression ) ) otherlv_2= THEN ( (lv_statments_3_0= ruleStmt_List ) ) (
				// (lv_elseif_4_0= ruleELSIF_Clause ) )* ( (lv_else_5_0= ruleELSE_Clause ) )?
				// otherlv_6= END_IF
				{
	...
	// InternalStructuredTextParser.g:652:1: entryRuleELSIF_Clause returns [EObject
	...
	public final EObject entryRuleELSIF_Clause() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:652:53: (iv_ruleELSIF_Clause= ruleELSIF_Clause
			// EOF )
			// InternalStructuredTextParser.g:653:2: iv_ruleELSIF_Clause= ruleELSIF_Clause
			// EOF
			{
	...
	// InternalStructuredTextParser.g:659:1: ruleELSIF_Clause returns [EObject
	...
	public final EObject ruleELSIF_Clause() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:665:2: ( (otherlv_0= ELSIF (
			// (lv_expression_1_0= ruleExpression ) ) otherlv_2= THEN ( (lv_statements_3_0=
			// ruleStmt_List ) ) ) )
			// InternalStructuredTextParser.g:666:2: (otherlv_0= ELSIF ( (lv_expression_1_0=
			// ruleExpression ) ) otherlv_2= THEN ( (lv_statements_3_0= ruleStmt_List ) ) )
			{
				// InternalStructuredTextParser.g:666:2: (otherlv_0= ELSIF ( (lv_expression_1_0=
				// ruleExpression ) ) otherlv_2= THEN ( (lv_statements_3_0= ruleStmt_List ) ) )
				// InternalStructuredTextParser.g:667:3: otherlv_0= ELSIF ( (lv_expression_1_0=
				// ruleExpression ) ) otherlv_2= THEN ( (lv_statements_3_0= ruleStmt_List ) )
				{
	...
	// InternalStructuredTextParser.g:717:1: entryRuleELSE_Clause returns [EObject
	...
	public final EObject entryRuleELSE_Clause() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:717:52: (iv_ruleELSE_Clause= ruleELSE_Clause
			// EOF )
	...
	// InternalStructuredTextParser.g:724:1: ruleELSE_Clause returns [EObject
	...
	public final EObject ruleELSE_Clause() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:730:2: ( (otherlv_0= ELSE (
			// (lv_statements_1_0= ruleStmt_List ) ) ) )
			// InternalStructuredTextParser.g:731:2: (otherlv_0= ELSE ( (lv_statements_1_0=
			// ruleStmt_List ) ) )
			{
				// InternalStructuredTextParser.g:731:2: (otherlv_0= ELSE ( (lv_statements_1_0=
				// ruleStmt_List ) ) )
				// InternalStructuredTextParser.g:732:3: otherlv_0= ELSE ( (lv_statements_1_0=
				// ruleStmt_List ) )
				{
	...
	// InternalStructuredTextParser.g:759:1: entryRuleCase_Stmt returns [EObject
	...
	// InternalStructuredTextParser.g:766:1: ruleCase_Stmt returns [EObject
	...
	public final EObject ruleCase_Stmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:772:2: ( (otherlv_0= CASE (
			// (lv_expression_1_0= ruleExpression ) ) otherlv_2= OF ( (lv_case_3_0=
			// ruleCase_Selection ) )+ ( (lv_else_4_0= ruleELSE_Clause ) )? otherlv_5=
			// END_CASE ) )
			// InternalStructuredTextParser.g:773:2: (otherlv_0= CASE ( (lv_expression_1_0=
			...
			// (lv_else_4_0= ruleELSE_Clause ) )? otherlv_5= END_CASE )
			{
				...
				// ruleExpression ) ) otherlv_2= OF ( (lv_case_3_0= ruleCase_Selection ) )+ (
				// (lv_else_4_0= ruleELSE_Clause ) )? otherlv_5= END_CASE )
				// InternalStructuredTextParser.g:774:3: otherlv_0= CASE ( (lv_expression_1_0=
				// ruleExpression ) ) otherlv_2= OF ( (lv_case_3_0= ruleCase_Selection ) )+ (
				// (lv_else_4_0= ruleELSE_Clause ) )? otherlv_5= END_CASE
				{
					...
					loop13: do {
						...
						if (((LA13_0 >= LDATE_AND_TIME && LA13_0 <= TIME_OF_DAY) || LA13_0 == WSTRING
								|| LA13_0 == STRING || (LA13_0 >= FALSE && LA13_0 <= LTIME)
								|| (LA13_0 >= UDINT && LA13_0 <= ULINT) || (LA13_0 >= USINT && LA13_0 <= WCHAR)
								|| LA13_0 == BOOL || (LA13_0 >= CHAR && LA13_0 <= DINT)
								|| (LA13_0 >= LINT && LA13_0 <= SINT) || (LA13_0 >= TIME && LA13_0 <= UINT)
								|| (LA13_0 >= INT && LA13_0 <= LDT) || LA13_0 == TOD || LA13_0 == DT
								|| (LA13_0 >= LD && LA13_0 <= LT) || LA13_0 == PlusSign || LA13_0 == HyphenMinus
								|| LA13_0 == T || LA13_0 == D_1
								|| (LA13_0 >= RULE_BINARY_INT && LA13_0 <= RULE_UNSIGNED_INT)
								|| LA13_0 == RULE_S_BYTE_CHAR_STR || LA13_0 == RULE_D_BYTE_CHAR_STR)) {
							alt13 = 1;
						}
	...
	// InternalStructuredTextParser.g:847:1: entryRuleCase_Selection returns
	...
	public final EObject entryRuleCase_Selection() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:847:55: (iv_ruleCase_Selection=
			// ruleCase_Selection EOF )
			// InternalStructuredTextParser.g:848:2: iv_ruleCase_Selection=
			// ruleCase_Selection EOF
			{
	...
	// InternalStructuredTextParser.g:854:1: ruleCase_Selection returns [EObject
	...
	public final EObject ruleCase_Selection() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:860:2: ( ( ( (lv_case_0_0= ruleConstant ) )
			// (otherlv_1= Comma ( (lv_case_2_0= ruleConstant ) ) )* otherlv_3= Colon (
			// (lv_statements_4_0= ruleStmt_List ) ) ) )
			// InternalStructuredTextParser.g:861:2: ( ( (lv_case_0_0= ruleConstant ) )
			// (otherlv_1= Comma ( (lv_case_2_0= ruleConstant ) ) )* otherlv_3= Colon (
			// (lv_statements_4_0= ruleStmt_List ) ) )
			{
				// InternalStructuredTextParser.g:861:2: ( ( (lv_case_0_0= ruleConstant ) )
				...
				// (lv_statements_4_0= ruleStmt_List ) )
				{
					...
					// InternalStructuredTextParser.g:881:3: (otherlv_1= Comma ( (lv_case_2_0=
					// ruleConstant ) ) )*
					loop15: do {
						int alt15 = 2;
						...
						switch (alt15) {
						case 1:
						// InternalStructuredTextParser.g:882:4: otherlv_1= Comma ( (lv_case_2_0=
						// ruleConstant ) )
						{
	...
	// InternalStructuredTextParser.g:933:1: entryRuleIteration_Stmt returns
	...
	public final EObject entryRuleIteration_Stmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:933:55: (iv_ruleIteration_Stmt=
			// ruleIteration_Stmt EOF )
			// InternalStructuredTextParser.g:934:2: iv_ruleIteration_Stmt=
			// ruleIteration_Stmt EOF
			{
	...
	// InternalStructuredTextParser.g:940:1: ruleIteration_Stmt returns [EObject
	...
	public final EObject ruleIteration_Stmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:946:2: ( (this_For_Stmt_0= ruleFor_Stmt |
			// this_While_Stmt_1= ruleWhile_Stmt | this_Repeat_Stmt_2= ruleRepeat_Stmt | (
			// () otherlv_4= EXIT ) | ( () otherlv_6= CONTINUE ) ) )
			// InternalStructuredTextParser.g:947:2: (this_For_Stmt_0= ruleFor_Stmt |
			// this_While_Stmt_1= ruleWhile_Stmt | this_Repeat_Stmt_2= ruleRepeat_Stmt | (
			// () otherlv_4= EXIT ) | ( () otherlv_6= CONTINUE ) )
			{
				// InternalStructuredTextParser.g:947:2: (this_For_Stmt_0= ruleFor_Stmt |
	...
	// InternalStructuredTextParser.g:1006:1: entryRuleFor_Stmt returns [EObject
	...
	// InternalStructuredTextParser.g:1013:1: ruleFor_Stmt returns [EObject
	...
	public final EObject ruleFor_Stmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1019:2: ( (otherlv_0= FOR ( (lv_variable_1_0=
			...
			// InternalStructuredTextParser.g:1020:2: (otherlv_0= FOR ( (lv_variable_1_0=
			// ruleVariable_Primary ) ) otherlv_2= ColonEqualsSign ( (lv_from_3_0=
			// ruleExpression ) ) otherlv_4= TO ( (lv_to_5_0= ruleExpression ) ) (otherlv_6=
			// BY ( (lv_by_7_0= ruleExpression ) ) )? otherlv_8= DO ( (lv_statements_9_0=
			// ruleStmt_List ) ) otherlv_10= END_FOR )
			{
				...
				// BY ( (lv_by_7_0= ruleExpression ) ) )? otherlv_8= DO ( (lv_statements_9_0=
				// ruleStmt_List ) ) otherlv_10= END_FOR )
				// InternalStructuredTextParser.g:1021:3: otherlv_0= FOR ( (lv_variable_1_0=
				// ruleVariable_Primary ) ) otherlv_2= ColonEqualsSign ( (lv_from_3_0=
				// ruleExpression ) ) otherlv_4= TO ( (lv_to_5_0= ruleExpression ) ) (otherlv_6=
				// BY ( (lv_by_7_0= ruleExpression ) ) )? otherlv_8= DO ( (lv_statements_9_0=
				// ruleStmt_List ) ) otherlv_10= END_FOR
				{
					...
					// InternalStructuredTextParser.g:1025:3: ( (lv_variable_1_0=
					...
					// InternalStructuredTextParser.g:1090:3: (otherlv_6= BY ( (lv_by_7_0=
					// ruleExpression ) ) )?
					int alt17 = 2;
					...
					switch (alt17) {
					case 1:
					// InternalStructuredTextParser.g:1091:4: otherlv_6= BY ( (lv_by_7_0=
					// ruleExpression ) )
					{
	...
	// InternalStructuredTextParser.g:1146:1: entryRuleWhile_Stmt returns [EObject
	...
	public final EObject entryRuleWhile_Stmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1146:51: (iv_ruleWhile_Stmt= ruleWhile_Stmt
			// EOF )
	...
	// InternalStructuredTextParser.g:1153:1: ruleWhile_Stmt returns [EObject
	...
	public final EObject ruleWhile_Stmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1159:2: ( (otherlv_0= WHILE (
			// (lv_expression_1_0= ruleExpression ) ) otherlv_2= DO ( (lv_statements_3_0=
			// ruleStmt_List ) ) otherlv_4= END_WHILE ) )
			// InternalStructuredTextParser.g:1160:2: (otherlv_0= WHILE (
			// (lv_expression_1_0= ruleExpression ) ) otherlv_2= DO ( (lv_statements_3_0=
			// ruleStmt_List ) ) otherlv_4= END_WHILE )
			{
				// InternalStructuredTextParser.g:1160:2: (otherlv_0= WHILE (
				// (lv_expression_1_0= ruleExpression ) ) otherlv_2= DO ( (lv_statements_3_0=
				// ruleStmt_List ) ) otherlv_4= END_WHILE )
				// InternalStructuredTextParser.g:1161:3: otherlv_0= WHILE ( (lv_expression_1_0=
	...
	// InternalStructuredTextParser.g:1215:1: entryRuleRepeat_Stmt returns [EObject
	...
	public final EObject entryRuleRepeat_Stmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1215:52: (iv_ruleRepeat_Stmt= ruleRepeat_Stmt
			// EOF )
			// InternalStructuredTextParser.g:1216:2: iv_ruleRepeat_Stmt= ruleRepeat_Stmt
			// EOF
			{
	...
	// InternalStructuredTextParser.g:1222:1: ruleRepeat_Stmt returns [EObject
	...
	public final EObject ruleRepeat_Stmt() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1228:2: ( (otherlv_0= REPEAT (
			// (lv_statements_1_0= ruleStmt_List ) ) otherlv_2= UNTIL ( (lv_expression_3_0=
			// ruleExpression ) ) otherlv_4= END_REPEAT ) )
			// InternalStructuredTextParser.g:1229:2: (otherlv_0= REPEAT (
			// (lv_statements_1_0= ruleStmt_List ) ) otherlv_2= UNTIL ( (lv_expression_3_0=
			// ruleExpression ) ) otherlv_4= END_REPEAT )
			{
				// InternalStructuredTextParser.g:1229:2: (otherlv_0= REPEAT (
				// (lv_statements_1_0= ruleStmt_List ) ) otherlv_2= UNTIL ( (lv_expression_3_0=
				// ruleExpression ) ) otherlv_4= END_REPEAT )
				// InternalStructuredTextParser.g:1230:3: otherlv_0= REPEAT (
				// (lv_statements_1_0= ruleStmt_List ) ) otherlv_2= UNTIL ( (lv_expression_3_0=
				// ruleExpression ) ) otherlv_4= END_REPEAT
				{
	...
	// InternalStructuredTextParser.g:1284:1: entryRuleExpression returns [EObject
	...
	public final EObject entryRuleExpression() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1284:51: (iv_ruleExpression= ruleExpression
			// EOF )
	...
	// InternalStructuredTextParser.g:1291:1: ruleExpression returns [EObject
	...
	public final EObject ruleExpression() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1297:2: (this_Or_Expression_0=
			// ruleOr_Expression )
			// InternalStructuredTextParser.g:1298:2: this_Or_Expression_0=
			// ruleOr_Expression
			{
	...
	// InternalStructuredTextParser.g:1309:1: entryRuleOr_Expression returns
	...
	public final EObject entryRuleOr_Expression() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1309:54: (iv_ruleOr_Expression=
			// ruleOr_Expression EOF )
			// InternalStructuredTextParser.g:1310:2: iv_ruleOr_Expression=
			// ruleOr_Expression EOF
			{
	...
	// InternalStructuredTextParser.g:1316:1: ruleOr_Expression returns [EObject
	...
	public final EObject ruleOr_Expression() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1322:2: ( (this_Xor_Expr_0= ruleXor_Expr ( ()
			// ( (lv_operator_2_0= ruleOr_Operator ) ) ( (lv_right_3_0= ruleXor_Expr ) ) )*
			// ) )
			// InternalStructuredTextParser.g:1323:2: (this_Xor_Expr_0= ruleXor_Expr ( () (
			// (lv_operator_2_0= ruleOr_Operator ) ) ( (lv_right_3_0= ruleXor_Expr ) ) )* )
			{
				// InternalStructuredTextParser.g:1323:2: (this_Xor_Expr_0= ruleXor_Expr ( () (
				// (lv_operator_2_0= ruleOr_Operator ) ) ( (lv_right_3_0= ruleXor_Expr ) ) )* )
				// InternalStructuredTextParser.g:1324:3: this_Xor_Expr_0= ruleXor_Expr ( () (
				// (lv_operator_2_0= ruleOr_Operator ) ) ( (lv_right_3_0= ruleXor_Expr ) ) )*
				{
					...
					// InternalStructuredTextParser.g:1332:3: ( () ( (lv_operator_2_0=
					// ruleOr_Operator ) ) ( (lv_right_3_0= ruleXor_Expr ) ) )*
					loop18: do {
						int alt18 = 2;
						...
						switch (alt18) {
						case 1:
						// InternalStructuredTextParser.g:1333:4: () ( (lv_operator_2_0= ruleOr_Operator
	...
	// InternalStructuredTextParser.g:1383:1: entryRuleXor_Expr returns [EObject
	...
	// InternalStructuredTextParser.g:1390:1: ruleXor_Expr returns [EObject
	...
	public final EObject ruleXor_Expr() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1396:2: ( (this_And_Expr_0= ruleAnd_Expr ( ()
			// ( (lv_operator_2_0= ruleXor_Operator ) ) ( (lv_right_3_0= ruleAnd_Expr ) ) )*
			// ) )
			// InternalStructuredTextParser.g:1397:2: (this_And_Expr_0= ruleAnd_Expr ( () (
			// (lv_operator_2_0= ruleXor_Operator ) ) ( (lv_right_3_0= ruleAnd_Expr ) ) )* )
			{
				// InternalStructuredTextParser.g:1397:2: (this_And_Expr_0= ruleAnd_Expr ( () (
				// (lv_operator_2_0= ruleXor_Operator ) ) ( (lv_right_3_0= ruleAnd_Expr ) ) )* )
				// InternalStructuredTextParser.g:1398:3: this_And_Expr_0= ruleAnd_Expr ( () (
				// (lv_operator_2_0= ruleXor_Operator ) ) ( (lv_right_3_0= ruleAnd_Expr ) ) )*
				{
					...
					// InternalStructuredTextParser.g:1406:3: ( () ( (lv_operator_2_0=
					// ruleXor_Operator ) ) ( (lv_right_3_0= ruleAnd_Expr ) ) )*
					loop19: do {
						int alt19 = 2;
						...
						switch (alt19) {
						case 1:
						// InternalStructuredTextParser.g:1407:4: () ( (lv_operator_2_0=
						// ruleXor_Operator ) ) ( (lv_right_3_0= ruleAnd_Expr ) )
						{
	...
	// InternalStructuredTextParser.g:1457:1: entryRuleAnd_Expr returns [EObject
	...
	// InternalStructuredTextParser.g:1464:1: ruleAnd_Expr returns [EObject
	...
	public final EObject ruleAnd_Expr() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1470:2: ( (this_Compare_Expr_0=
			// ruleCompare_Expr ( () ( (lv_operator_2_0= ruleAnd_Operator ) ) (
			// (lv_right_3_0= ruleCompare_Expr ) ) )* ) )
			// InternalStructuredTextParser.g:1471:2: (this_Compare_Expr_0= ruleCompare_Expr
			...
			// ruleCompare_Expr ) ) )* )
			{
				...
				// ( () ( (lv_operator_2_0= ruleAnd_Operator ) ) ( (lv_right_3_0=
				// ruleCompare_Expr ) ) )* )
				// InternalStructuredTextParser.g:1472:3: this_Compare_Expr_0= ruleCompare_Expr
				// ( () ( (lv_operator_2_0= ruleAnd_Operator ) ) ( (lv_right_3_0=
				// ruleCompare_Expr ) ) )*
				{
					...
					// InternalStructuredTextParser.g:1480:3: ( () ( (lv_operator_2_0=
					...
					loop20: do {
						...
						switch (alt20) {
						case 1:
						// InternalStructuredTextParser.g:1481:4: () ( (lv_operator_2_0=
						// ruleAnd_Operator ) ) ( (lv_right_3_0= ruleCompare_Expr ) )
						{
	...
	// InternalStructuredTextParser.g:1531:1: entryRuleCompare_Expr returns [EObject
	...
	public final EObject entryRuleCompare_Expr() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1531:53: (iv_ruleCompare_Expr=
			// ruleCompare_Expr EOF )
			// InternalStructuredTextParser.g:1532:2: iv_ruleCompare_Expr= ruleCompare_Expr
			// EOF
			{
	...
	// InternalStructuredTextParser.g:1538:1: ruleCompare_Expr returns [EObject
	...
	public final EObject ruleCompare_Expr() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1544:2: ( (this_Equ_Expr_0= ruleEqu_Expr ( ()
			// ( (lv_operator_2_0= ruleCompare_Operator ) ) ( (lv_right_3_0= ruleEqu_Expr )
			// ) )* ) )
			// InternalStructuredTextParser.g:1545:2: (this_Equ_Expr_0= ruleEqu_Expr ( () (
			// (lv_operator_2_0= ruleCompare_Operator ) ) ( (lv_right_3_0= ruleEqu_Expr ) )
			// )* )
			{
				// InternalStructuredTextParser.g:1545:2: (this_Equ_Expr_0= ruleEqu_Expr ( () (
				// (lv_operator_2_0= ruleCompare_Operator ) ) ( (lv_right_3_0= ruleEqu_Expr ) )
				// )* )
				// InternalStructuredTextParser.g:1546:3: this_Equ_Expr_0= ruleEqu_Expr ( () (
				// (lv_operator_2_0= ruleCompare_Operator ) ) ( (lv_right_3_0= ruleEqu_Expr ) )
				// )*
				{
					...
					// InternalStructuredTextParser.g:1554:3: ( () ( (lv_operator_2_0=
					// ruleCompare_Operator ) ) ( (lv_right_3_0= ruleEqu_Expr ) ) )*
					loop21: do {
						int alt21 = 2;
						...
						switch (alt21) {
						case 1:
						// InternalStructuredTextParser.g:1555:4: () ( (lv_operator_2_0=
						// ruleCompare_Operator ) ) ( (lv_right_3_0= ruleEqu_Expr ) )
						{
							...
							// InternalStructuredTextParser.g:1562:4: ( (lv_operator_2_0=
	...
	// InternalStructuredTextParser.g:1605:1: entryRuleEqu_Expr returns [EObject
	...
	// InternalStructuredTextParser.g:1612:1: ruleEqu_Expr returns [EObject
	...
	public final EObject ruleEqu_Expr() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1618:2: ( (this_Add_Expr_0= ruleAdd_Expr ( ()
			// ( (lv_operator_2_0= ruleEqu_Operator ) ) ( (lv_right_3_0= ruleAdd_Expr ) ) )*
			// ) )
			// InternalStructuredTextParser.g:1619:2: (this_Add_Expr_0= ruleAdd_Expr ( () (
			// (lv_operator_2_0= ruleEqu_Operator ) ) ( (lv_right_3_0= ruleAdd_Expr ) ) )* )
			{
				// InternalStructuredTextParser.g:1619:2: (this_Add_Expr_0= ruleAdd_Expr ( () (
				// (lv_operator_2_0= ruleEqu_Operator ) ) ( (lv_right_3_0= ruleAdd_Expr ) ) )* )
				// InternalStructuredTextParser.g:1620:3: this_Add_Expr_0= ruleAdd_Expr ( () (
				// (lv_operator_2_0= ruleEqu_Operator ) ) ( (lv_right_3_0= ruleAdd_Expr ) ) )*
				{
					...
					// InternalStructuredTextParser.g:1628:3: ( () ( (lv_operator_2_0=
					// ruleEqu_Operator ) ) ( (lv_right_3_0= ruleAdd_Expr ) ) )*
					loop22: do {
						int alt22 = 2;
						int LA22_0 = input.LA(1);

						if ((LA22_0 == LessThanSignEqualsSign || LA22_0 == GreaterThanSignEqualsSign
								|| LA22_0 == LessThanSign || LA22_0 == GreaterThanSign)) {
							alt22 = 1;
						}

						switch (alt22) {
						case 1:
						// InternalStructuredTextParser.g:1629:4: () ( (lv_operator_2_0=
						// ruleEqu_Operator ) ) ( (lv_right_3_0= ruleAdd_Expr ) )
						{
	...
	// InternalStructuredTextParser.g:1679:1: entryRuleAdd_Expr returns [EObject
	...
	// InternalStructuredTextParser.g:1686:1: ruleAdd_Expr returns [EObject
	...
	public final EObject ruleAdd_Expr() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1692:2: ( (this_Term_0= ruleTerm ( () (
			// (lv_operator_2_0= ruleAdd_Operator ) ) ( (lv_right_3_0= ruleTerm ) ) )* ) )
			// InternalStructuredTextParser.g:1693:2: (this_Term_0= ruleTerm ( () (
			// (lv_operator_2_0= ruleAdd_Operator ) ) ( (lv_right_3_0= ruleTerm ) ) )* )
			{
				// InternalStructuredTextParser.g:1693:2: (this_Term_0= ruleTerm ( () (
				// (lv_operator_2_0= ruleAdd_Operator ) ) ( (lv_right_3_0= ruleTerm ) ) )* )
				// InternalStructuredTextParser.g:1694:3: this_Term_0= ruleTerm ( () (
				// (lv_operator_2_0= ruleAdd_Operator ) ) ( (lv_right_3_0= ruleTerm ) ) )*
				{
					...
					// InternalStructuredTextParser.g:1702:3: ( () ( (lv_operator_2_0=
					// ruleAdd_Operator ) ) ( (lv_right_3_0= ruleTerm ) ) )*
					loop23: do {
						int alt23 = 2;
						...
						switch (alt23) {
						case 1:
						// InternalStructuredTextParser.g:1703:4: () ( (lv_operator_2_0=
						// ruleAdd_Operator ) ) ( (lv_right_3_0= ruleTerm ) )
						{
	...
	// InternalStructuredTextParser.g:1753:1: entryRuleTerm returns [EObject
	...
	// InternalStructuredTextParser.g:1760:1: ruleTerm returns [EObject
	...
	public final EObject ruleTerm() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1766:2: ( (this_Power_Expr_0= rulePower_Expr (
			// () ( (lv_operator_2_0= ruleTerm_Operator ) ) ( (lv_right_3_0= rulePower_Expr
			// ) ) )* ) )
			// InternalStructuredTextParser.g:1767:2: (this_Power_Expr_0= rulePower_Expr (
			// () ( (lv_operator_2_0= ruleTerm_Operator ) ) ( (lv_right_3_0= rulePower_Expr
			// ) ) )* )
			{
				// InternalStructuredTextParser.g:1767:2: (this_Power_Expr_0= rulePower_Expr (
				// () ( (lv_operator_2_0= ruleTerm_Operator ) ) ( (lv_right_3_0= rulePower_Expr
				// ) ) )* )
				// InternalStructuredTextParser.g:1768:3: this_Power_Expr_0= rulePower_Expr ( ()
				// ( (lv_operator_2_0= ruleTerm_Operator ) ) ( (lv_right_3_0= rulePower_Expr ) )
				// )*
				{
					...
					// InternalStructuredTextParser.g:1776:3: ( () ( (lv_operator_2_0=
					// ruleTerm_Operator ) ) ( (lv_right_3_0= rulePower_Expr ) ) )*
					loop24: do {
						int alt24 = 2;
						...
						switch (alt24) {
						case 1:
						// InternalStructuredTextParser.g:1777:4: () ( (lv_operator_2_0=
						// ruleTerm_Operator ) ) ( (lv_right_3_0= rulePower_Expr ) )
						{
	...
	// InternalStructuredTextParser.g:1827:1: entryRulePower_Expr returns [EObject
	...
	public final EObject entryRulePower_Expr() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1827:51: (iv_rulePower_Expr= rulePower_Expr
			// EOF )
	...
	// InternalStructuredTextParser.g:1834:1: rulePower_Expr returns [EObject
	...
	public final EObject rulePower_Expr() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1840:2: ( (this_Unary_Expr_0= ruleUnary_Expr (
			// () ( (lv_operator_2_0= rulePower_Operator ) ) ( (lv_right_3_0= ruleUnary_Expr
			// ) ) )* ) )
			// InternalStructuredTextParser.g:1841:2: (this_Unary_Expr_0= ruleUnary_Expr (
			// () ( (lv_operator_2_0= rulePower_Operator ) ) ( (lv_right_3_0= ruleUnary_Expr
			// ) ) )* )
			{
				// InternalStructuredTextParser.g:1841:2: (this_Unary_Expr_0= ruleUnary_Expr (
				// () ( (lv_operator_2_0= rulePower_Operator ) ) ( (lv_right_3_0= ruleUnary_Expr
				// ) ) )* )
				// InternalStructuredTextParser.g:1842:3: this_Unary_Expr_0= ruleUnary_Expr ( ()
				// ( (lv_operator_2_0= rulePower_Operator ) ) ( (lv_right_3_0= ruleUnary_Expr )
				// ) )*
				{
					...
					// InternalStructuredTextParser.g:1850:3: ( () ( (lv_operator_2_0=
					// rulePower_Operator ) ) ( (lv_right_3_0= ruleUnary_Expr ) ) )*
					loop25: do {
						int alt25 = 2;
						...
						switch (alt25) {
						case 1:
						// InternalStructuredTextParser.g:1851:4: () ( (lv_operator_2_0=
						// rulePower_Operator ) ) ( (lv_right_3_0= ruleUnary_Expr ) )
						{
	...
	// InternalStructuredTextParser.g:1901:1: entryRuleUnary_Expr returns [EObject
	...
	public final EObject entryRuleUnary_Expr() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1901:51: (iv_ruleUnary_Expr= ruleUnary_Expr
			// EOF )
	...
	// InternalStructuredTextParser.g:1908:1: ruleUnary_Expr returns [EObject
	...
	public final EObject ruleUnary_Expr() throws RecognitionException {
		...
		try {
			...
			// this_Primary_Expr_3= rulePrimary_Expr | this_Constant_4= ruleConstant )
			{
				...
				switch (alt26) {
				case 1:
				// InternalStructuredTextParser.g:1916:3: ( () ( (lv_operator_1_0=
				// ruleUnary_Operator ) ) ( (lv_expression_2_0= rulePrimary_Expr ) ) )
				{
					// InternalStructuredTextParser.g:1916:3: ( () ( (lv_operator_1_0=
					// ruleUnary_Operator ) ) ( (lv_expression_2_0= rulePrimary_Expr ) ) )
					// InternalStructuredTextParser.g:1917:4: () ( (lv_operator_1_0=
					// ruleUnary_Operator ) ) ( (lv_expression_2_0= rulePrimary_Expr ) )
					{
	...
	// InternalStructuredTextParser.g:1985:1: entryRulePrimary_Expr returns [EObject
	...
	public final EObject entryRulePrimary_Expr() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1985:53: (iv_rulePrimary_Expr=
			// rulePrimary_Expr EOF )
			// InternalStructuredTextParser.g:1986:2: iv_rulePrimary_Expr= rulePrimary_Expr
			// EOF
			{
	...
	// InternalStructuredTextParser.g:1992:1: rulePrimary_Expr returns [EObject
	...
	public final EObject rulePrimary_Expr() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:1998:2: ( (this_Variable_0= ruleVariable |
			// this_Func_Call_1= ruleFunc_Call | (otherlv_2= LeftParenthesis
			// this_Expression_3= ruleExpression otherlv_4= RightParenthesis ) ) )
			// InternalStructuredTextParser.g:1999:2: (this_Variable_0= ruleVariable |
			// this_Func_Call_1= ruleFunc_Call | (otherlv_2= LeftParenthesis
			// this_Expression_3= ruleExpression otherlv_4= RightParenthesis ) )
			{
				// InternalStructuredTextParser.g:1999:2: (this_Variable_0= ruleVariable |
				...
				case RULE_ID: {
					...
					if ((LA27_1 == EOF || LA27_1 == END_REPEAT || LA27_1 == THEN || LA27_1 == AND || LA27_1 == MOD
							|| (LA27_1 >= XOR && LA27_1 <= AsteriskAsterisk)
							|| (LA27_1 >= LessThanSignEqualsSign && LA27_1 <= LessThanSignGreaterThanSign)
							|| (LA27_1 >= GreaterThanSignEqualsSign && LA27_1 <= DO) || (LA27_1 >= OF && LA27_1 <= TO)
							|| LA27_1 == Ampersand || (LA27_1 >= RightParenthesis && LA27_1 <= Solidus)
							|| (LA27_1 >= Semicolon && LA27_1 <= GreaterThanSign)
							|| (LA27_1 >= LeftSquareBracket && LA27_1 <= RightSquareBracket))) {
						alt27 = 1;
				...
				// InternalStructuredTextParser.g:2009:3: this_Func_Call_1= ruleFunc_Call
				{
					...
					break;
				case 3:
				// InternalStructuredTextParser.g:2018:3: (otherlv_2= LeftParenthesis
				// this_Expression_3= ruleExpression otherlv_4= RightParenthesis )
				{
					// InternalStructuredTextParser.g:2018:3: (otherlv_2= LeftParenthesis
					// this_Expression_3= ruleExpression otherlv_4= RightParenthesis )
					// InternalStructuredTextParser.g:2019:4: otherlv_2= LeftParenthesis
					// this_Expression_3= ruleExpression otherlv_4= RightParenthesis
					{
	...
	// InternalStructuredTextParser.g:2040:1: entryRuleFunc_Call returns [EObject
	...
	// InternalStructuredTextParser.g:2047:1: ruleFunc_Call returns [EObject
	...
	public final EObject ruleFunc_Call() throws RecognitionException {
		...
		try {
			...
			// )* )? otherlv_5= RightParenthesis )
			{
				...
				// ruleParam_Assign ) ) (otherlv_3= Comma ( (lv_args_4_0= ruleParam_Assign ) )
				// )* )? otherlv_5= RightParenthesis )
				// InternalStructuredTextParser.g:2055:3: ( ( (lv_func_0_1= RULE_ID |
				// lv_func_0_2= TIME ) ) ) otherlv_1= LeftParenthesis ( ( (lv_args_2_0=
				// ruleParam_Assign ) ) (otherlv_3= Comma ( (lv_args_4_0= ruleParam_Assign ) )
				// )* )? otherlv_5= RightParenthesis
				{
					// InternalStructuredTextParser.g:2055:3: ( ( (lv_func_0_1= RULE_ID |
					// lv_func_0_2= TIME ) ) )
					// InternalStructuredTextParser.g:2056:4: ( (lv_func_0_1= RULE_ID | lv_func_0_2=
					// TIME ) )
					{
						// InternalStructuredTextParser.g:2056:4: ( (lv_func_0_1= RULE_ID | lv_func_0_2=
						// TIME ) )
						// InternalStructuredTextParser.g:2057:5: (lv_func_0_1= RULE_ID | lv_func_0_2=
						// TIME )
						{
							// InternalStructuredTextParser.g:2057:5: (lv_func_0_1= RULE_ID | lv_func_0_2=
							// TIME )
					...
					// InternalStructuredTextParser.g:2090:3: ( ( (lv_args_2_0= ruleParam_Assign ) )
					// (otherlv_3= Comma ( (lv_args_4_0= ruleParam_Assign ) ) )* )?
					int alt30 = 2;
					int LA30_0 = input.LA(1);

					if (((LA30_0 >= LDATE_AND_TIME && LA30_0 <= TIME_OF_DAY) || LA30_0 == WSTRING || LA30_0 == STRING
							|| (LA30_0 >= FALSE && LA30_0 <= LTIME) || (LA30_0 >= UDINT && LA30_0 <= ULINT)
							|| (LA30_0 >= USINT && LA30_0 <= WCHAR) || LA30_0 == BOOL
							|| (LA30_0 >= CHAR && LA30_0 <= DINT) || (LA30_0 >= LINT && LA30_0 <= SINT)
							|| (LA30_0 >= TIME && LA30_0 <= UINT) || (LA30_0 >= INT && LA30_0 <= LDT)
							|| (LA30_0 >= NOT && LA30_0 <= TOD) || LA30_0 == DT || (LA30_0 >= LD && LA30_0 <= LT)
							|| LA30_0 == LeftParenthesis || LA30_0 == PlusSign || LA30_0 == HyphenMinus || LA30_0 == T
							|| LA30_0 == D_1 || (LA30_0 >= RULE_ID && LA30_0 <= RULE_UNSIGNED_INT)
							|| LA30_0 == RULE_S_BYTE_CHAR_STR || LA30_0 == RULE_D_BYTE_CHAR_STR)) {
						alt30 = 1;
					}
					switch (alt30) {
					case 1:
					...
					// (otherlv_3= Comma ( (lv_args_4_0= ruleParam_Assign ) ) )*
					{
						...
						// InternalStructuredTextParser.g:2110:4: (otherlv_3= Comma ( (lv_args_4_0=
						// ruleParam_Assign ) ) )*
						loop29: do {
							int alt29 = 2;
							...
							switch (alt29) {
							case 1:
							// InternalStructuredTextParser.g:2111:5: otherlv_3= Comma ( (lv_args_4_0=
							// ruleParam_Assign ) )
							{
	...
	// InternalStructuredTextParser.g:2144:1: entryRuleParam_Assign returns [EObject
	...
	public final EObject entryRuleParam_Assign() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2144:53: (iv_ruleParam_Assign=
			// ruleParam_Assign EOF )
			// InternalStructuredTextParser.g:2145:2: iv_ruleParam_Assign= ruleParam_Assign
			// EOF
			{
	...
	// InternalStructuredTextParser.g:2151:1: ruleParam_Assign returns [EObject
	...
	public final EObject ruleParam_Assign() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2157:2: ( (this_Param_Assign_In_0=
			// ruleParam_Assign_In | this_Param_Assign_Out_1= ruleParam_Assign_Out ) )
			// InternalStructuredTextParser.g:2158:2: (this_Param_Assign_In_0=
			// ruleParam_Assign_In | this_Param_Assign_Out_1= ruleParam_Assign_Out )
			{
				// InternalStructuredTextParser.g:2158:2: (this_Param_Assign_In_0=
				// ruleParam_Assign_In | this_Param_Assign_Out_1= ruleParam_Assign_Out )
				...
				case RULE_ID: {
					...
					if ((LA31_1 == EOF || LA31_1 == AND || LA31_1 == MOD
							|| (LA31_1 >= XOR && LA31_1 <= LessThanSignGreaterThanSign)
							|| LA31_1 == GreaterThanSignEqualsSign || LA31_1 == OR
							|| (LA31_1 >= Ampersand && LA31_1 <= Solidus)
							|| (LA31_1 >= LessThanSign && LA31_1 <= GreaterThanSign) || LA31_1 == LeftSquareBracket)) {
						alt31 = 1;
				...
				case NOT: {
					...
					if ((LA31_3 == RULE_ID)) {
						...
						if ((LA31_5 == EOF || LA31_5 == AND || LA31_5 == MOD
								|| (LA31_5 >= XOR && LA31_5 <= AsteriskAsterisk)
								|| (LA31_5 >= LessThanSignEqualsSign && LA31_5 <= LessThanSignGreaterThanSign)
								|| LA31_5 == GreaterThanSignEqualsSign || LA31_5 == OR
								|| (LA31_5 >= Ampersand && LA31_5 <= Solidus)
								|| (LA31_5 >= LessThanSign && LA31_5 <= GreaterThanSign)
								|| LA31_5 == LeftSquareBracket)) {
							alt31 = 1;
					...
					} else if ((LA31_3 == TIME || LA31_3 == DT || LA31_3 == LT || LA31_3 == LeftParenthesis
							|| LA31_3 == T)) {
						alt31 = 1;
					} else {
				...
				switch (alt31) {
				case 1:
				// InternalStructuredTextParser.g:2159:3: this_Param_Assign_In_0=
				// ruleParam_Assign_In
				{
					...
					break;
				case 2:
				// InternalStructuredTextParser.g:2168:3: this_Param_Assign_Out_1=
	...
	// InternalStructuredTextParser.g:2180:1: entryRuleParam_Assign_In returns
	...
	public final EObject entryRuleParam_Assign_In() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2180:56: (iv_ruleParam_Assign_In=
			// ruleParam_Assign_In EOF )
			// InternalStructuredTextParser.g:2181:2: iv_ruleParam_Assign_In=
			// ruleParam_Assign_In EOF
			{
	...
	// InternalStructuredTextParser.g:2187:1: ruleParam_Assign_In returns [EObject
	...
	public final EObject ruleParam_Assign_In() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2193:2: ( ( ( ( (lv_var_0_0= RULE_ID ) )
			// otherlv_1= ColonEqualsSign )? ( (lv_expr_2_0= ruleExpression ) ) ) )
			// InternalStructuredTextParser.g:2194:2: ( ( ( (lv_var_0_0= RULE_ID ) )
			// otherlv_1= ColonEqualsSign )? ( (lv_expr_2_0= ruleExpression ) ) )
			{
				// InternalStructuredTextParser.g:2194:2: ( ( ( (lv_var_0_0= RULE_ID ) )
				// otherlv_1= ColonEqualsSign )? ( (lv_expr_2_0= ruleExpression ) ) )
				// InternalStructuredTextParser.g:2195:3: ( ( (lv_var_0_0= RULE_ID ) )
				// otherlv_1= ColonEqualsSign )? ( (lv_expr_2_0= ruleExpression ) )
				{
					// InternalStructuredTextParser.g:2195:3: ( ( (lv_var_0_0= RULE_ID ) )
					...
					switch (alt32) {
					case 1:
					// InternalStructuredTextParser.g:2196:4: ( (lv_var_0_0= RULE_ID ) ) otherlv_1=
					// ColonEqualsSign
					{
	...
	// InternalStructuredTextParser.g:2242:1: entryRuleParam_Assign_Out returns
	...
	public final EObject entryRuleParam_Assign_Out() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2242:57: (iv_ruleParam_Assign_Out=
			// ruleParam_Assign_Out EOF )
			// InternalStructuredTextParser.g:2243:2: iv_ruleParam_Assign_Out=
			// ruleParam_Assign_Out EOF
			{
	...
	// InternalStructuredTextParser.g:2249:1: ruleParam_Assign_Out returns [EObject
	...
	public final EObject ruleParam_Assign_Out() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2255:2: ( ( ( (lv_not_0_0= NOT ) )? (
			// (lv_var_1_0= RULE_ID ) ) otherlv_2= EqualsSignGreaterThanSign ( (lv_expr_3_0=
			// ruleVariable ) ) ) )
			// InternalStructuredTextParser.g:2256:2: ( ( (lv_not_0_0= NOT ) )? (
			// (lv_var_1_0= RULE_ID ) ) otherlv_2= EqualsSignGreaterThanSign ( (lv_expr_3_0=
			// ruleVariable ) ) )
			{
				// InternalStructuredTextParser.g:2256:2: ( ( (lv_not_0_0= NOT ) )? (
				// (lv_var_1_0= RULE_ID ) ) otherlv_2= EqualsSignGreaterThanSign ( (lv_expr_3_0=
				// ruleVariable ) ) )
				// InternalStructuredTextParser.g:2257:3: ( (lv_not_0_0= NOT ) )? ( (lv_var_1_0=
	...
	// InternalStructuredTextParser.g:2316:1: entryRuleVariable returns [EObject
	...
	// InternalStructuredTextParser.g:2323:1: ruleVariable returns [EObject
	...
	public final EObject ruleVariable() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2329:2: (this_Variable_Subscript_0=
			// ruleVariable_Subscript )
			// InternalStructuredTextParser.g:2330:2: this_Variable_Subscript_0=
			// ruleVariable_Subscript
			{
	...
	// InternalStructuredTextParser.g:2341:1: entryRuleVariable_Subscript returns
	...
	public final EObject entryRuleVariable_Subscript() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2341:59: (iv_ruleVariable_Subscript=
			// ruleVariable_Subscript EOF )
			// InternalStructuredTextParser.g:2342:2: iv_ruleVariable_Subscript=
			// ruleVariable_Subscript EOF
			{
	...
	// InternalStructuredTextParser.g:2348:1: ruleVariable_Subscript returns
	...
	public final EObject ruleVariable_Subscript() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2354:2: ( ( (this_Variable_Primary_0=
			...
			// ) )
			// InternalStructuredTextParser.g:2355:2: ( (this_Variable_Primary_0=
			// ruleVariable_Primary | this_Variable_Adapter_1= ruleVariable_Adapter ) ( ()
			// otherlv_3= LeftSquareBracket ( (lv_index_4_0= ruleExpression ) ) (otherlv_5=
			// Comma ( (lv_index_6_0= ruleExpression ) ) )* otherlv_7= RightSquareBracket )?
			// )
			{
				...
				// Comma ( (lv_index_6_0= ruleExpression ) ) )* otherlv_7= RightSquareBracket )?
				// )
				// InternalStructuredTextParser.g:2356:3: (this_Variable_Primary_0=
				// ruleVariable_Primary | this_Variable_Adapter_1= ruleVariable_Adapter ) ( ()
				// otherlv_3= LeftSquareBracket ( (lv_index_4_0= ruleExpression ) ) (otherlv_5=
				// Comma ( (lv_index_6_0= ruleExpression ) ) )* otherlv_7= RightSquareBracket )?
				{
					...
					case RULE_ID: {
						...
						if ((LA34_1 == EOF || LA34_1 == END_REPEAT || LA34_1 == THEN || LA34_1 == AND || LA34_1 == MOD
								|| (LA34_1 >= XOR && LA34_1 <= LessThanSignGreaterThanSign)
								|| (LA34_1 >= GreaterThanSignEqualsSign && LA34_1 <= DO)
								|| (LA34_1 >= OF && LA34_1 <= TO) || LA34_1 == Ampersand
								|| (LA34_1 >= RightParenthesis && LA34_1 <= HyphenMinus) || LA34_1 == Solidus
								|| (LA34_1 >= Semicolon && LA34_1 <= GreaterThanSign)
								|| (LA34_1 >= LeftSquareBracket && LA34_1 <= RightSquareBracket))) {
							alt34 = 1;
					...
					case T: {
						...
						if ((LA34_2 == FullStop)) {
							alt34 = 2;
						} else if ((LA34_2 == EOF || LA34_2 == END_REPEAT || LA34_2 == THEN || LA34_2 == AND
								|| LA34_2 == MOD || (LA34_2 >= XOR && LA34_2 <= LessThanSignGreaterThanSign)
								|| (LA34_2 >= GreaterThanSignEqualsSign && LA34_2 <= DO)
								|| (LA34_2 >= OF && LA34_2 <= TO) || LA34_2 == Ampersand
								|| (LA34_2 >= RightParenthesis && LA34_2 <= HyphenMinus) || LA34_2 == Solidus
								|| (LA34_2 >= Semicolon && LA34_2 <= GreaterThanSign)
								|| (LA34_2 >= LeftSquareBracket && LA34_2 <= RightSquareBracket))) {
							alt34 = 1;
						} else {
					...
					case LT: {
						...
						if ((LA34_3 == FullStop)) {
							alt34 = 2;
						} else if ((LA34_3 == EOF || LA34_3 == END_REPEAT || LA34_3 == THEN || LA34_3 == AND
								|| LA34_3 == MOD || (LA34_3 >= XOR && LA34_3 <= LessThanSignGreaterThanSign)
								|| (LA34_3 >= GreaterThanSignEqualsSign && LA34_3 <= DO)
								|| (LA34_3 >= OF && LA34_3 <= TO) || LA34_3 == Ampersand
								|| (LA34_3 >= RightParenthesis && LA34_3 <= HyphenMinus) || LA34_3 == Solidus
								|| (LA34_3 >= Semicolon && LA34_3 <= GreaterThanSign)
								|| (LA34_3 >= LeftSquareBracket && LA34_3 <= RightSquareBracket))) {
							alt34 = 1;
						} else {
					...
					case DT: {
						...
						if ((LA34_4 == EOF || LA34_4 == END_REPEAT || LA34_4 == THEN || LA34_4 == AND || LA34_4 == MOD
								|| (LA34_4 >= XOR && LA34_4 <= LessThanSignGreaterThanSign)
								|| (LA34_4 >= GreaterThanSignEqualsSign && LA34_4 <= DO)
								|| (LA34_4 >= OF && LA34_4 <= TO) || LA34_4 == Ampersand
								|| (LA34_4 >= RightParenthesis && LA34_4 <= HyphenMinus) || LA34_4 == Solidus
								|| (LA34_4 >= Semicolon && LA34_4 <= GreaterThanSign)
								|| (LA34_4 >= LeftSquareBracket && LA34_4 <= RightSquareBracket))) {
							alt34 = 1;
					...
					switch (alt34) {
					case 1:
					// InternalStructuredTextParser.g:2357:4: this_Variable_Primary_0=
					// ruleVariable_Primary
					{
						...
						break;
					case 2:
					// InternalStructuredTextParser.g:2366:4: this_Variable_Adapter_1=
					...
					// InternalStructuredTextParser.g:2375:3: ( () otherlv_3= LeftSquareBracket (
					...
					switch (alt36) {
					case 1:
					// InternalStructuredTextParser.g:2376:4: () otherlv_3= LeftSquareBracket (
					// (lv_index_4_0= ruleExpression ) ) (otherlv_5= Comma ( (lv_index_6_0=
					// ruleExpression ) ) )* otherlv_7= RightSquareBracket
					{
						...
						// InternalStructuredTextParser.g:2406:4: (otherlv_5= Comma ( (lv_index_6_0=
						// ruleExpression ) ) )*
						loop35: do {
							int alt35 = 2;
							...
							switch (alt35) {
							case 1:
							// InternalStructuredTextParser.g:2407:5: otherlv_5= Comma ( (lv_index_6_0=
							// ruleExpression ) )
							{
	...
	// InternalStructuredTextParser.g:2440:1: entryRuleVariable_Adapter returns
	...
	public final EObject entryRuleVariable_Adapter() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2440:57: (iv_ruleVariable_Adapter=
			// ruleVariable_Adapter EOF )
			// InternalStructuredTextParser.g:2441:2: iv_ruleVariable_Adapter=
			// ruleVariable_Adapter EOF
			{
	...
	// InternalStructuredTextParser.g:2447:1: ruleVariable_Adapter returns [EObject
	...
	public final EObject ruleVariable_Adapter() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2453:2: ( ( () ( ( ruleAdapter_Name ) )
			// otherlv_2= FullStop ( ( ruleVariable_Name ) ) ) )
			// InternalStructuredTextParser.g:2454:2: ( () ( ( ruleAdapter_Name ) )
			// otherlv_2= FullStop ( ( ruleVariable_Name ) ) )
			{
				// InternalStructuredTextParser.g:2454:2: ( () ( ( ruleAdapter_Name ) )
				// otherlv_2= FullStop ( ( ruleVariable_Name ) ) )
				// InternalStructuredTextParser.g:2455:3: () ( ( ruleAdapter_Name ) ) otherlv_2=
	...
	// InternalStructuredTextParser.g:2502:1: entryRuleAdapter_Name returns [String
	...
	public final String entryRuleAdapter_Name() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2502:52: (iv_ruleAdapter_Name=
			// ruleAdapter_Name EOF )
			// InternalStructuredTextParser.g:2503:2: iv_ruleAdapter_Name= ruleAdapter_Name
			// EOF
			{
	...
	// InternalStructuredTextParser.g:2509:1: ruleAdapter_Name returns
	...
	public final AntlrDatatypeRuleToken ruleAdapter_Name() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2515:2: ( (this_ID_0= RULE_ID | kw= T | kw= LT
			// | kw= DT ) )
			// InternalStructuredTextParser.g:2516:2: (this_ID_0= RULE_ID | kw= T | kw= LT |
			// kw= DT )
			{
				// InternalStructuredTextParser.g:2516:2: (this_ID_0= RULE_ID | kw= T | kw= LT |
				// kw= DT )
	...
	// InternalStructuredTextParser.g:2546:1: entryRuleVariable_Primary returns
	...
	public final EObject entryRuleVariable_Primary() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2546:57: (iv_ruleVariable_Primary=
			// ruleVariable_Primary EOF )
			// InternalStructuredTextParser.g:2547:2: iv_ruleVariable_Primary=
			// ruleVariable_Primary EOF
			{
	...
	// InternalStructuredTextParser.g:2553:1: ruleVariable_Primary returns [EObject
	...
	// InternalStructuredTextParser.g:2579:1: entryRuleVariable_Name returns [String
	...
	public final String entryRuleVariable_Name() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2579:53: (iv_ruleVariable_Name=
			// ruleVariable_Name EOF )
			// InternalStructuredTextParser.g:2580:2: iv_ruleVariable_Name=
			// ruleVariable_Name EOF
			{
	...
	// InternalStructuredTextParser.g:2586:1: ruleVariable_Name returns
	// [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (this_ID_0=
	// RULE_ID | kw= T | kw= LT | kw= DT ) ;
	public final AntlrDatatypeRuleToken ruleVariable_Name() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2592:2: ( (this_ID_0= RULE_ID | kw= T | kw= LT
			// | kw= DT ) )
			// InternalStructuredTextParser.g:2593:2: (this_ID_0= RULE_ID | kw= T | kw= LT |
			// kw= DT )
			{
				// InternalStructuredTextParser.g:2593:2: (this_ID_0= RULE_ID | kw= T | kw= LT |
				// kw= DT )
	...
	// InternalStructuredTextParser.g:2623:1: entryRuleConstant returns [EObject
	...
	// InternalStructuredTextParser.g:2630:1: ruleConstant returns [EObject
	...
	public final EObject ruleConstant() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2636:2: ( (this_Numeric_Literal_0=
			...
			// ) )
			// InternalStructuredTextParser.g:2637:2: (this_Numeric_Literal_0=
			// ruleNumeric_Literal | this_Char_Literal_1= ruleChar_Literal |
			// this_Time_Literal_2= ruleTime_Literal | this_Bool_Literal_3= ruleBool_Literal
			// )
			{
				...
				switch (alt39) {
				case 1:
				// InternalStructuredTextParser.g:2638:3: this_Numeric_Literal_0=
				// ruleNumeric_Literal
				{
	...
	// InternalStructuredTextParser.g:2677:1: entryRuleNumeric_Literal returns
	...
	public final EObject entryRuleNumeric_Literal() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2677:56: (iv_ruleNumeric_Literal=
			// ruleNumeric_Literal EOF )
			// InternalStructuredTextParser.g:2678:2: iv_ruleNumeric_Literal=
			// ruleNumeric_Literal EOF
			{
	...
	// InternalStructuredTextParser.g:2684:1: ruleNumeric_Literal returns [EObject
	...
	public final EObject ruleNumeric_Literal() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2690:2: ( (this_Int_Literal_0= ruleInt_Literal
			// | this_Real_Literal_1= ruleReal_Literal ) )
			// InternalStructuredTextParser.g:2691:2: (this_Int_Literal_0= ruleInt_Literal |
			// this_Real_Literal_1= ruleReal_Literal )
			{
				// InternalStructuredTextParser.g:2691:2: (this_Int_Literal_0= ruleInt_Literal |
				// this_Real_Literal_1= ruleReal_Literal )
				...
				case PlusSign: {
					...
					if ((LA40_2 == RULE_UNSIGNED_INT)) {
						...
						if ((LA40_4 == EOF || LA40_4 == END_REPEAT || LA40_4 == THEN || LA40_4 == AND || LA40_4 == MOD
								|| (LA40_4 >= XOR && LA40_4 <= AsteriskAsterisk)
								|| (LA40_4 >= LessThanSignEqualsSign && LA40_4 <= LessThanSignGreaterThanSign)
								|| (LA40_4 >= GreaterThanSignEqualsSign && LA40_4 <= DO)
								|| (LA40_4 >= OF && LA40_4 <= TO) || LA40_4 == Ampersand
								|| (LA40_4 >= RightParenthesis && LA40_4 <= HyphenMinus)
								|| (LA40_4 >= Solidus && LA40_4 <= GreaterThanSign) || LA40_4 == RightSquareBracket)) {
							alt40 = 1;
				...
				case RULE_UNSIGNED_INT: {
					...
					if ((LA40_4 == EOF || LA40_4 == END_REPEAT || LA40_4 == THEN || LA40_4 == AND || LA40_4 == MOD
							|| (LA40_4 >= XOR && LA40_4 <= AsteriskAsterisk)
							|| (LA40_4 >= LessThanSignEqualsSign && LA40_4 <= LessThanSignGreaterThanSign)
							|| (LA40_4 >= GreaterThanSignEqualsSign && LA40_4 <= DO) || (LA40_4 >= OF && LA40_4 <= TO)
							|| LA40_4 == Ampersand || (LA40_4 >= RightParenthesis && LA40_4 <= HyphenMinus)
							|| (LA40_4 >= Solidus && LA40_4 <= GreaterThanSign) || LA40_4 == RightSquareBracket)) {
						alt40 = 1;
					} else if ((LA40_4 == FullStop)) {
						alt40 = 2;
	...
	// InternalStructuredTextParser.g:2713:1: entryRuleInt_Literal returns [EObject
	...
	public final EObject entryRuleInt_Literal() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2713:52: (iv_ruleInt_Literal= ruleInt_Literal
			// EOF )
			// InternalStructuredTextParser.g:2714:2: iv_ruleInt_Literal= ruleInt_Literal
			// EOF
			{
	...
	// InternalStructuredTextParser.g:2720:1: ruleInt_Literal returns [EObject
	...
	public final EObject ruleInt_Literal() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2726:2: ( ( ( ( (lv_type_0_0=
			...
			// InternalStructuredTextParser.g:2727:2: ( ( ( (lv_type_0_0= ruleInt_Type_Name
			...
			// RULE_HEX_INT ) ) ) )
			{
				...
				// lv_value_2_2= RULE_BINARY_INT | lv_value_2_3= RULE_OCTAL_INT | lv_value_2_4=
				// RULE_HEX_INT ) ) ) )
				// InternalStructuredTextParser.g:2728:3: ( ( (lv_type_0_0= ruleInt_Type_Name )
				...
				// ) )
				{
					...
					if (((LA41_0 >= UDINT && LA41_0 <= ULINT) || LA41_0 == USINT || LA41_0 == DINT || LA41_0 == LINT
							|| LA41_0 == SINT || LA41_0 == UINT || LA41_0 == INT)) {
						alt41 = 1;
					}
					switch (alt41) {
					case 1:
					...
					// InternalStructuredTextParser.g:2753:3: ( ( (lv_value_2_1= ruleSigned_Int |
					// lv_value_2_2= RULE_BINARY_INT | lv_value_2_3= RULE_OCTAL_INT | lv_value_2_4=
					// RULE_HEX_INT ) ) )
					// InternalStructuredTextParser.g:2754:4: ( (lv_value_2_1= ruleSigned_Int |
					// lv_value_2_2= RULE_BINARY_INT | lv_value_2_3= RULE_OCTAL_INT | lv_value_2_4=
					// RULE_HEX_INT ) )
					{
						// InternalStructuredTextParser.g:2754:4: ( (lv_value_2_1= ruleSigned_Int |
						// lv_value_2_2= RULE_BINARY_INT | lv_value_2_3= RULE_OCTAL_INT | lv_value_2_4=
						// RULE_HEX_INT ) )
						// InternalStructuredTextParser.g:2755:5: (lv_value_2_1= ruleSigned_Int |
						// lv_value_2_2= RULE_BINARY_INT | lv_value_2_3= RULE_OCTAL_INT | lv_value_2_4=
						// RULE_HEX_INT )
						{
							// InternalStructuredTextParser.g:2755:5: (lv_value_2_1= ruleSigned_Int |
	...
	// InternalStructuredTextParser.g:2823:1: entryRuleSigned_Int returns [String
	...
	public final String entryRuleSigned_Int() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2823:50: (iv_ruleSigned_Int= ruleSigned_Int
			// EOF )
	...
	// InternalStructuredTextParser.g:2830:1: ruleSigned_Int returns
	...
	public final AntlrDatatypeRuleToken ruleSigned_Int() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2836:2: ( ( (kw= PlusSign | kw= HyphenMinus )?
			// this_UNSIGNED_INT_2= RULE_UNSIGNED_INT ) )
			// InternalStructuredTextParser.g:2837:2: ( (kw= PlusSign | kw= HyphenMinus )?
			// this_UNSIGNED_INT_2= RULE_UNSIGNED_INT )
			{
				// InternalStructuredTextParser.g:2837:2: ( (kw= PlusSign | kw= HyphenMinus )?
				// this_UNSIGNED_INT_2= RULE_UNSIGNED_INT )
	...
	// InternalStructuredTextParser.g:2862:1: entryRuleArray_Size returns [String
	...
	public final String entryRuleArray_Size() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2862:50: (iv_ruleArray_Size= ruleArray_Size
			// EOF )
	...
	// InternalStructuredTextParser.g:2869:1: ruleArray_Size returns
	// [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] :
	...
	public final AntlrDatatypeRuleToken ruleArray_Size() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2875:2: (this_UNSIGNED_INT_0=
			// RULE_UNSIGNED_INT )
	...
	// InternalStructuredTextParser.g:2886:1: entryRuleReal_Literal returns [EObject
	...
	public final EObject entryRuleReal_Literal() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2886:53: (iv_ruleReal_Literal=
			// ruleReal_Literal EOF )
			// InternalStructuredTextParser.g:2887:2: iv_ruleReal_Literal= ruleReal_Literal
			// EOF
			{
	...
	// InternalStructuredTextParser.g:2893:1: ruleReal_Literal returns [EObject
	...
	public final EObject ruleReal_Literal() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2899:2: ( ( ( ( (lv_type_0_0=
			// ruleReal_Type_Name ) ) otherlv_1= NumberSign )? ( (lv_value_2_0=
			// ruleReal_Value ) ) ) )
			// InternalStructuredTextParser.g:2900:2: ( ( ( (lv_type_0_0= ruleReal_Type_Name
			// ) ) otherlv_1= NumberSign )? ( (lv_value_2_0= ruleReal_Value ) ) )
			{
				// InternalStructuredTextParser.g:2900:2: ( ( ( (lv_type_0_0= ruleReal_Type_Name
				// ) ) otherlv_1= NumberSign )? ( (lv_value_2_0= ruleReal_Value ) ) )
				// InternalStructuredTextParser.g:2901:3: ( ( (lv_type_0_0= ruleReal_Type_Name )
				// ) otherlv_1= NumberSign )? ( (lv_value_2_0= ruleReal_Value ) )
				{
					// InternalStructuredTextParser.g:2901:3: ( ( (lv_type_0_0= ruleReal_Type_Name )
					// ) otherlv_1= NumberSign )?
	...
	// InternalStructuredTextParser.g:2949:1: entryRuleReal_Value returns [String
	...
	public final String entryRuleReal_Value() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2949:50: (iv_ruleReal_Value= ruleReal_Value
			// EOF )
	...
	// InternalStructuredTextParser.g:2956:1: ruleReal_Value returns
	// [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] :
	...
	public final AntlrDatatypeRuleToken ruleReal_Value() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:2962:2: ( (this_Signed_Int_0= ruleSigned_Int
			// kw= FullStop this_UNSIGNED_INT_2= RULE_UNSIGNED_INT (kw= E this_Signed_Int_4=
			// ruleSigned_Int )? ) )
			// InternalStructuredTextParser.g:2963:2: (this_Signed_Int_0= ruleSigned_Int kw=
			...
			// ruleSigned_Int )? )
			{
				...
				// FullStop this_UNSIGNED_INT_2= RULE_UNSIGNED_INT (kw= E this_Signed_Int_4=
				// ruleSigned_Int )? )
				// InternalStructuredTextParser.g:2964:3: this_Signed_Int_0= ruleSigned_Int kw=
				// FullStop this_UNSIGNED_INT_2= RULE_UNSIGNED_INT (kw= E this_Signed_Int_4=
				// ruleSigned_Int )?
				{
					...
					// InternalStructuredTextParser.g:2986:3: (kw= E this_Signed_Int_4=
					// ruleSigned_Int )?
					int alt45 = 2;
					...
					switch (alt45) {
					case 1:
					// InternalStructuredTextParser.g:2987:4: kw= E this_Signed_Int_4=
					// ruleSigned_Int
					{
	...
	// InternalStructuredTextParser.g:3007:1: entryRuleBool_Literal returns [EObject
	...
	public final EObject entryRuleBool_Literal() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3007:53: (iv_ruleBool_Literal=
			// ruleBool_Literal EOF )
			// InternalStructuredTextParser.g:3008:2: iv_ruleBool_Literal= ruleBool_Literal
			// EOF
			{
	...
	// InternalStructuredTextParser.g:3014:1: ruleBool_Literal returns [EObject
	...
	public final EObject ruleBool_Literal() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3020:2: ( ( ( ( (lv_type_0_0=
			// ruleBool_Type_Name ) ) otherlv_1= NumberSign )? ( (lv_value_2_0=
			// ruleBool_Value ) ) ) )
			// InternalStructuredTextParser.g:3021:2: ( ( ( (lv_type_0_0= ruleBool_Type_Name
			// ) ) otherlv_1= NumberSign )? ( (lv_value_2_0= ruleBool_Value ) ) )
			{
				// InternalStructuredTextParser.g:3021:2: ( ( ( (lv_type_0_0= ruleBool_Type_Name
				// ) ) otherlv_1= NumberSign )? ( (lv_value_2_0= ruleBool_Value ) ) )
				// InternalStructuredTextParser.g:3022:3: ( ( (lv_type_0_0= ruleBool_Type_Name )
				// ) otherlv_1= NumberSign )? ( (lv_value_2_0= ruleBool_Value ) )
				{
					// InternalStructuredTextParser.g:3022:3: ( ( (lv_type_0_0= ruleBool_Type_Name )
					// ) otherlv_1= NumberSign )?
	...
	// InternalStructuredTextParser.g:3070:1: entryRuleBool_Value returns [String
	...
	public final String entryRuleBool_Value() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3070:50: (iv_ruleBool_Value= ruleBool_Value
			// EOF )
	...
	// InternalStructuredTextParser.g:3077:1: ruleBool_Value returns
	...
	// InternalStructuredTextParser.g:3100:1: entryRuleChar_Literal returns [EObject
	...
	public final EObject entryRuleChar_Literal() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3100:53: (iv_ruleChar_Literal=
			// ruleChar_Literal EOF )
			// InternalStructuredTextParser.g:3101:2: iv_ruleChar_Literal= ruleChar_Literal
			// EOF
			{
	...
	// InternalStructuredTextParser.g:3107:1: ruleChar_Literal returns [EObject
	...
	public final EObject ruleChar_Literal() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3113:2: ( ( ( ( (lv_type_0_0=
			...
			// InternalStructuredTextParser.g:3114:2: ( ( ( (lv_type_0_0=
			// ruleString_Type_Name ) ) ( (lv_length_1_0= RULE_UNSIGNED_INT ) )? otherlv_2=
			// NumberSign )? ( ( (lv_value_3_1= RULE_S_BYTE_CHAR_STR | lv_value_3_2=
			// RULE_D_BYTE_CHAR_STR ) ) ) )
			{
				...
				// NumberSign )? ( ( (lv_value_3_1= RULE_S_BYTE_CHAR_STR | lv_value_3_2=
				// RULE_D_BYTE_CHAR_STR ) ) ) )
				// InternalStructuredTextParser.g:3115:3: ( ( (lv_type_0_0= ruleString_Type_Name
				// ) ) ( (lv_length_1_0= RULE_UNSIGNED_INT ) )? otherlv_2= NumberSign )? ( (
				// (lv_value_3_1= RULE_S_BYTE_CHAR_STR | lv_value_3_2= RULE_D_BYTE_CHAR_STR ) )
				// )
				{
					...
					// InternalStructuredTextParser.g:3158:3: ( ( (lv_value_3_1=
					// RULE_S_BYTE_CHAR_STR | lv_value_3_2= RULE_D_BYTE_CHAR_STR ) ) )
					// InternalStructuredTextParser.g:3159:4: ( (lv_value_3_1= RULE_S_BYTE_CHAR_STR
					// | lv_value_3_2= RULE_D_BYTE_CHAR_STR ) )
					{
						// InternalStructuredTextParser.g:3159:4: ( (lv_value_3_1= RULE_S_BYTE_CHAR_STR
						// | lv_value_3_2= RULE_D_BYTE_CHAR_STR ) )
						// InternalStructuredTextParser.g:3160:5: (lv_value_3_1= RULE_S_BYTE_CHAR_STR |
						// lv_value_3_2= RULE_D_BYTE_CHAR_STR )
						{
							// InternalStructuredTextParser.g:3160:5: (lv_value_3_1= RULE_S_BYTE_CHAR_STR |
							// lv_value_3_2= RULE_D_BYTE_CHAR_STR )
	...
	// InternalStructuredTextParser.g:3197:1: entryRuleTime_Literal returns [EObject
	...
	public final EObject entryRuleTime_Literal() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3197:53: (iv_ruleTime_Literal=
			// ruleTime_Literal EOF )
			// InternalStructuredTextParser.g:3198:2: iv_ruleTime_Literal= ruleTime_Literal
			// EOF
			{
	...
	// InternalStructuredTextParser.g:3204:1: ruleTime_Literal returns [EObject
	...
	public final EObject ruleTime_Literal() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3210:2: ( (this_Duration_0= ruleDuration |
			// this_Time_Of_Day_1= ruleTime_Of_Day | this_Date_2= ruleDate |
			// this_Date_And_Time_3= ruleDate_And_Time ) )
			// InternalStructuredTextParser.g:3211:2: (this_Duration_0= ruleDuration |
			// this_Time_Of_Day_1= ruleTime_Of_Day | this_Date_2= ruleDate |
			// this_Date_And_Time_3= ruleDate_And_Time )
			{
				// InternalStructuredTextParser.g:3211:2: (this_Duration_0= ruleDuration |
				...
				// InternalStructuredTextParser.g:3230:3: this_Date_2= ruleDate
				{
					...
					break;
				case 4:
				// InternalStructuredTextParser.g:3239:3: this_Date_And_Time_3=
				// ruleDate_And_Time
				{
	...
	// InternalStructuredTextParser.g:3251:1: entryRuleDuration returns [EObject
	...
	// InternalStructuredTextParser.g:3258:1: ruleDuration returns [EObject
	...
	public final EObject ruleDuration() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3264:2: ( ( ( (lv_type_0_0= ruleTime_Type_Name
			...
			// InternalStructuredTextParser.g:3265:2: ( ( (lv_type_0_0= ruleTime_Type_Name )
			// ) otherlv_1= NumberSign (otherlv_2= PlusSign | ( (lv_negative_3_0=
			// HyphenMinus ) ) )? ( (lv_value_4_0= ruleDuration_Value ) ) (otherlv_5= KW__ (
			// (lv_value_6_0= ruleDuration_Value ) ) )* )
			{
				...
				// (lv_value_6_0= ruleDuration_Value ) ) )*
				{
					...
					// InternalStructuredTextParser.g:3289:3: (otherlv_2= PlusSign | (
					...
					// InternalStructuredTextParser.g:3329:3: (otherlv_5= KW__ ( (lv_value_6_0=
					// ruleDuration_Value ) ) )*
					loop53: do {
						int alt53 = 2;
						...
						switch (alt53) {
						case 1:
						// InternalStructuredTextParser.g:3330:4: otherlv_5= KW__ ( (lv_value_6_0=
						// ruleDuration_Value ) )
						{
	...
	// InternalStructuredTextParser.g:3358:1: entryRuleDuration_Value returns
	...
	public final EObject entryRuleDuration_Value() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3358:55: (iv_ruleDuration_Value=
			// ruleDuration_Value EOF )
			// InternalStructuredTextParser.g:3359:2: iv_ruleDuration_Value=
			// ruleDuration_Value EOF
			{
	...
	// InternalStructuredTextParser.g:3365:1: ruleDuration_Value returns [EObject
	...
	public final EObject ruleDuration_Value() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3371:2: ( ( ( (lv_value_0_0= ruleFix_Point ) )
			// ( (lv_unit_1_0= ruleDuration_Unit ) ) ) )
			// InternalStructuredTextParser.g:3372:2: ( ( (lv_value_0_0= ruleFix_Point ) ) (
			// (lv_unit_1_0= ruleDuration_Unit ) ) )
			{
				// InternalStructuredTextParser.g:3372:2: ( ( (lv_value_0_0= ruleFix_Point ) ) (
				// (lv_unit_1_0= ruleDuration_Unit ) ) )
	...
	// InternalStructuredTextParser.g:3415:1: entryRuleFix_Point returns [String
	...
	// InternalStructuredTextParser.g:3422:1: ruleFix_Point returns
	// [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] :
	...
	public final AntlrDatatypeRuleToken ruleFix_Point() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3428:2: ( (this_UNSIGNED_INT_0=
			// RULE_UNSIGNED_INT (kw= FullStop this_UNSIGNED_INT_2= RULE_UNSIGNED_INT )? ) )
			// InternalStructuredTextParser.g:3429:2: (this_UNSIGNED_INT_0=
			// RULE_UNSIGNED_INT (kw= FullStop this_UNSIGNED_INT_2= RULE_UNSIGNED_INT )? )
			{
				// InternalStructuredTextParser.g:3429:2: (this_UNSIGNED_INT_0=
				// RULE_UNSIGNED_INT (kw= FullStop this_UNSIGNED_INT_2= RULE_UNSIGNED_INT )? )
				// InternalStructuredTextParser.g:3430:3: this_UNSIGNED_INT_0= RULE_UNSIGNED_INT
				// (kw= FullStop this_UNSIGNED_INT_2= RULE_UNSIGNED_INT )?
				{
					...
					// InternalStructuredTextParser.g:3437:3: (kw= FullStop this_UNSIGNED_INT_2=
					// RULE_UNSIGNED_INT )?
					int alt54 = 2;
					...
					switch (alt54) {
					case 1:
					// InternalStructuredTextParser.g:3438:4: kw= FullStop this_UNSIGNED_INT_2=
					// RULE_UNSIGNED_INT
					{
						kw = (Token) match(input, FullStop, FOLLOW_10);
	...
	// InternalStructuredTextParser.g:3455:1: entryRuleTime_Of_Day returns [EObject
	...
	public final EObject entryRuleTime_Of_Day() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3455:52: (iv_ruleTime_Of_Day= ruleTime_Of_Day
			// EOF )
			// InternalStructuredTextParser.g:3456:2: iv_ruleTime_Of_Day= ruleTime_Of_Day
			// EOF
			{
	...
	// InternalStructuredTextParser.g:3462:1: ruleTime_Of_Day returns [EObject
	...
	public final EObject ruleTime_Of_Day() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3468:2: ( ( ( (lv_type_0_0= ruleTod_Type_Name
			// ) ) otherlv_1= NumberSign ( (lv_value_2_0= ruleDaytime ) ) ) )
			// InternalStructuredTextParser.g:3469:2: ( ( (lv_type_0_0= ruleTod_Type_Name )
			// ) otherlv_1= NumberSign ( (lv_value_2_0= ruleDaytime ) ) )
			{
				// InternalStructuredTextParser.g:3469:2: ( ( (lv_type_0_0= ruleTod_Type_Name )
				// ) otherlv_1= NumberSign ( (lv_value_2_0= ruleDaytime ) ) )
	...
	// InternalStructuredTextParser.g:3516:1: entryRuleDaytime returns [String
	...
	// InternalStructuredTextParser.g:3523:1: ruleDaytime returns
	// [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] :
	...
	public final AntlrDatatypeRuleToken ruleDaytime() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3529:2: ( (this_Day_Hour_0= ruleDay_Hour kw=
			// Colon this_Day_Minute_2= ruleDay_Minute kw= Colon this_Day_Second_4=
			// ruleDay_Second ) )
			// InternalStructuredTextParser.g:3530:2: (this_Day_Hour_0= ruleDay_Hour kw=
			// Colon this_Day_Minute_2= ruleDay_Minute kw= Colon this_Day_Second_4=
			// ruleDay_Second )
			{
				// InternalStructuredTextParser.g:3530:2: (this_Day_Hour_0= ruleDay_Hour kw=
				// Colon this_Day_Minute_2= ruleDay_Minute kw= Colon this_Day_Second_4=
				// ruleDay_Second )
				// InternalStructuredTextParser.g:3531:3: this_Day_Hour_0= ruleDay_Hour kw=
				// Colon this_Day_Minute_2= ruleDay_Minute kw= Colon this_Day_Second_4=
				// ruleDay_Second
				{
	...
	// InternalStructuredTextParser.g:3575:1: entryRuleDay_Hour returns [String
	...
	// InternalStructuredTextParser.g:3582:1: ruleDay_Hour returns
	// [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] :
	// this_UNSIGNED_INT_0= RULE_UNSIGNED_INT ;
	public final AntlrDatatypeRuleToken ruleDay_Hour() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3588:2: (this_UNSIGNED_INT_0=
			// RULE_UNSIGNED_INT )
	...
	// InternalStructuredTextParser.g:3599:1: entryRuleDay_Minute returns [String
	...
	public final String entryRuleDay_Minute() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3599:50: (iv_ruleDay_Minute= ruleDay_Minute
			// EOF )
	...
	// InternalStructuredTextParser.g:3606:1: ruleDay_Minute returns
	// [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] :
	// this_UNSIGNED_INT_0= RULE_UNSIGNED_INT ;
	public final AntlrDatatypeRuleToken ruleDay_Minute() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3612:2: (this_UNSIGNED_INT_0=
			// RULE_UNSIGNED_INT )
	...
	// InternalStructuredTextParser.g:3623:1: entryRuleDay_Second returns [String
	...
	public final String entryRuleDay_Second() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3623:50: (iv_ruleDay_Second= ruleDay_Second
			// EOF )
	...
	// InternalStructuredTextParser.g:3630:1: ruleDay_Second returns
	// [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] :
	...
	// InternalStructuredTextParser.g:3650:1: entryRuleDate returns [EObject
	...
	// InternalStructuredTextParser.g:3657:1: ruleDate returns [EObject
	...
	public final EObject ruleDate() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3663:2: ( ( ( (lv_type_0_0= ruleDate_Type_Name
			// ) ) otherlv_1= NumberSign ( (lv_value_2_0= ruleDate_Literal ) ) ) )
			// InternalStructuredTextParser.g:3664:2: ( ( (lv_type_0_0= ruleDate_Type_Name )
			// ) otherlv_1= NumberSign ( (lv_value_2_0= ruleDate_Literal ) ) )
			{
				// InternalStructuredTextParser.g:3664:2: ( ( (lv_type_0_0= ruleDate_Type_Name )
				// ) otherlv_1= NumberSign ( (lv_value_2_0= ruleDate_Literal ) ) )
	...
	// InternalStructuredTextParser.g:3711:1: entryRuleDate_Literal returns [String
	...
	public final String entryRuleDate_Literal() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3711:52: (iv_ruleDate_Literal=
			// ruleDate_Literal EOF )
			// InternalStructuredTextParser.g:3712:2: iv_ruleDate_Literal= ruleDate_Literal
			// EOF
			{
	...
	// InternalStructuredTextParser.g:3718:1: ruleDate_Literal returns
	...
	public final AntlrDatatypeRuleToken ruleDate_Literal() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3724:2: ( (this_Year_0= ruleYear kw=
			// HyphenMinus this_Month_2= ruleMonth kw= HyphenMinus this_Day_4= ruleDay ) )
			// InternalStructuredTextParser.g:3725:2: (this_Year_0= ruleYear kw= HyphenMinus
			// this_Month_2= ruleMonth kw= HyphenMinus this_Day_4= ruleDay )
			{
				// InternalStructuredTextParser.g:3725:2: (this_Year_0= ruleYear kw= HyphenMinus
				// this_Month_2= ruleMonth kw= HyphenMinus this_Day_4= ruleDay )
				// InternalStructuredTextParser.g:3726:3: this_Year_0= ruleYear kw= HyphenMinus
				// this_Month_2= ruleMonth kw= HyphenMinus this_Day_4= ruleDay
				{
	...
	// InternalStructuredTextParser.g:3770:1: entryRuleYear returns [String
	...
	// InternalStructuredTextParser.g:3777:1: ruleYear returns
	// [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] :
	// this_UNSIGNED_INT_0= RULE_UNSIGNED_INT ;
	public final AntlrDatatypeRuleToken ruleYear() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3783:2: (this_UNSIGNED_INT_0=
			// RULE_UNSIGNED_INT )
	...
	// InternalStructuredTextParser.g:3794:1: entryRuleMonth returns [String
	...
	// InternalStructuredTextParser.g:3801:1: ruleMonth returns
	// [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] :
	// this_UNSIGNED_INT_0= RULE_UNSIGNED_INT ;
	public final AntlrDatatypeRuleToken ruleMonth() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3807:2: (this_UNSIGNED_INT_0=
			// RULE_UNSIGNED_INT )
	...
	// InternalStructuredTextParser.g:3818:1: entryRuleDay returns [String
	...
	// $ANTLR start "ruleDay"
	// InternalStructuredTextParser.g:3825:1: ruleDay returns
	// [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] :
	// this_UNSIGNED_INT_0= RULE_UNSIGNED_INT ;
	public final AntlrDatatypeRuleToken ruleDay() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3831:2: (this_UNSIGNED_INT_0=
			// RULE_UNSIGNED_INT )
	...
	// InternalStructuredTextParser.g:3842:1: entryRuleDate_And_Time returns
	...
	public final EObject entryRuleDate_And_Time() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3842:54: (iv_ruleDate_And_Time=
			// ruleDate_And_Time EOF )
			// InternalStructuredTextParser.g:3843:2: iv_ruleDate_And_Time=
			// ruleDate_And_Time EOF
			{
	...
	// InternalStructuredTextParser.g:3849:1: ruleDate_And_Time returns [EObject
	...
	public final EObject ruleDate_And_Time() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3855:2: ( ( ( (lv_type_0_0= ruleDT_Type_Name )
			// ) otherlv_1= NumberSign ( (lv_value_2_0= ruleDate_And_Time_Value ) ) ) )
			// InternalStructuredTextParser.g:3856:2: ( ( (lv_type_0_0= ruleDT_Type_Name ) )
			// otherlv_1= NumberSign ( (lv_value_2_0= ruleDate_And_Time_Value ) ) )
			{
				// InternalStructuredTextParser.g:3856:2: ( ( (lv_type_0_0= ruleDT_Type_Name ) )
				// otherlv_1= NumberSign ( (lv_value_2_0= ruleDate_And_Time_Value ) ) )
				...
				// otherlv_1= NumberSign ( (lv_value_2_0= ruleDate_And_Time_Value ) )
				{
					...
					// InternalStructuredTextParser.g:3880:3: ( (lv_value_2_0=
	...
	// InternalStructuredTextParser.g:3903:1: entryRuleDate_And_Time_Value returns
	...
	public final String entryRuleDate_And_Time_Value() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3903:59: (iv_ruleDate_And_Time_Value=
			// ruleDate_And_Time_Value EOF )
			// InternalStructuredTextParser.g:3904:2: iv_ruleDate_And_Time_Value=
			// ruleDate_And_Time_Value EOF
			{
	...
	// InternalStructuredTextParser.g:3910:1: ruleDate_And_Time_Value returns
	// [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] :
	...
	public final AntlrDatatypeRuleToken ruleDate_And_Time_Value() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3916:2: ( (this_Date_Literal_0=
			// ruleDate_Literal kw= HyphenMinus this_Daytime_2= ruleDaytime ) )
			// InternalStructuredTextParser.g:3917:2: (this_Date_Literal_0= ruleDate_Literal
			// kw= HyphenMinus this_Daytime_2= ruleDaytime )
			{
				// InternalStructuredTextParser.g:3917:2: (this_Date_Literal_0= ruleDate_Literal
				// kw= HyphenMinus this_Daytime_2= ruleDaytime )
				// InternalStructuredTextParser.g:3918:3: this_Date_Literal_0= ruleDate_Literal
				// kw= HyphenMinus this_Daytime_2= ruleDaytime
				{
	...
	// InternalStructuredTextParser.g:3947:1: entryRuleType_Name returns [String
	...
	public final AntlrDatatypeRuleToken ruleType_Name() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:3960:2: ( (this_ID_0= RULE_ID | kw= DINT | kw=
			...
			// InternalStructuredTextParser.g:3961:2: (this_ID_0= RULE_ID | kw= DINT | kw=
			// INT | kw= SINT | kw= LINT | kw= UINT | kw= USINT | kw= UDINT | kw= ULINT |
			// kw= REAL | kw= LREAL | kw= STRING | kw= WSTRING | kw= CHAR | kw= WCHAR | kw=
			// TIME | kw= LTIME | kw= TIME_OF_DAY | kw= LTIME_OF_DAY | kw= TOD | kw= LTOD |
			// kw= DATE | kw= LDATE | kw= DATE_AND_TIME | kw= LDATE_AND_TIME | kw= BOOL )
	...
	// InternalStructuredTextParser.g:4123:1: ruleOr_Operator returns [Enumerator
	...
	// InternalStructuredTextParser.g:4140:1: ruleXor_Operator returns [Enumerator
	...
	// InternalStructuredTextParser.g:4157:1: ruleAnd_Operator returns [Enumerator
	...
	public final Enumerator ruleAnd_Operator() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:4163:2: ( ( (enumLiteral_0= AND ) |
			// (enumLiteral_1= Ampersand ) ) )
			// InternalStructuredTextParser.g:4164:2: ( (enumLiteral_0= AND ) |
			// (enumLiteral_1= Ampersand ) )
			{
				// InternalStructuredTextParser.g:4164:2: ( (enumLiteral_0= AND ) |
				// (enumLiteral_1= Ampersand ) )
	...
	// InternalStructuredTextParser.g:4184:1: ruleCompare_Operator returns
	...
	public final Enumerator ruleCompare_Operator() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:4190:2: ( ( (enumLiteral_0= EqualsSign ) |
			// (enumLiteral_1= LessThanSignGreaterThanSign ) ) )
			// InternalStructuredTextParser.g:4191:2: ( (enumLiteral_0= EqualsSign ) |
			// (enumLiteral_1= LessThanSignGreaterThanSign ) )
			{
				// InternalStructuredTextParser.g:4191:2: ( (enumLiteral_0= EqualsSign ) |
				// (enumLiteral_1= LessThanSignGreaterThanSign ) )
				...
				// InternalStructuredTextParser.g:4192:3: (enumLiteral_0= EqualsSign )
				{
					...
					break;
				case 2:
				// InternalStructuredTextParser.g:4200:3: (enumLiteral_1=
				// LessThanSignGreaterThanSign )
				{
					// InternalStructuredTextParser.g:4200:3: (enumLiteral_1=
					// LessThanSignGreaterThanSign )
					// InternalStructuredTextParser.g:4201:4: enumLiteral_1=
					// LessThanSignGreaterThanSign
					{
	...
	// InternalStructuredTextParser.g:4211:1: ruleEqu_Operator returns [Enumerator
	...
	public final Enumerator ruleEqu_Operator() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:4217:2: ( ( (enumLiteral_0= LessThanSign ) |
			// (enumLiteral_1= LessThanSignEqualsSign ) | (enumLiteral_2= GreaterThanSign )
			// | (enumLiteral_3= GreaterThanSignEqualsSign ) ) )
			// InternalStructuredTextParser.g:4218:2: ( (enumLiteral_0= LessThanSign ) |
			// (enumLiteral_1= LessThanSignEqualsSign ) | (enumLiteral_2= GreaterThanSign )
			// | (enumLiteral_3= GreaterThanSignEqualsSign ) )
			{
				// InternalStructuredTextParser.g:4218:2: ( (enumLiteral_0= LessThanSign ) |
				...
				// InternalStructuredTextParser.g:4235:3: (enumLiteral_2= GreaterThanSign )
				{
					...
					break;
				case 4:
				// InternalStructuredTextParser.g:4243:3: (enumLiteral_3=
				// GreaterThanSignEqualsSign )
				{
					// InternalStructuredTextParser.g:4243:3: (enumLiteral_3=
					// GreaterThanSignEqualsSign )
					// InternalStructuredTextParser.g:4244:4: enumLiteral_3=
					// GreaterThanSignEqualsSign
					{
	...
	// InternalStructuredTextParser.g:4254:1: ruleAdd_Operator returns [Enumerator
	...
	public final Enumerator ruleAdd_Operator() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:4260:2: ( ( (enumLiteral_0= PlusSign ) |
			// (enumLiteral_1= HyphenMinus ) ) )
			// InternalStructuredTextParser.g:4261:2: ( (enumLiteral_0= PlusSign ) |
			// (enumLiteral_1= HyphenMinus ) )
			{
				// InternalStructuredTextParser.g:4261:2: ( (enumLiteral_0= PlusSign ) |
				// (enumLiteral_1= HyphenMinus ) )
	...
	// InternalStructuredTextParser.g:4281:1: ruleTerm_Operator returns [Enumerator
	...
	public final Enumerator ruleTerm_Operator() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:4287:2: ( ( (enumLiteral_0= Asterisk ) |
			// (enumLiteral_1= Solidus ) | (enumLiteral_2= MOD ) ) )
			// InternalStructuredTextParser.g:4288:2: ( (enumLiteral_0= Asterisk ) |
			// (enumLiteral_1= Solidus ) | (enumLiteral_2= MOD ) )
			{
				// InternalStructuredTextParser.g:4288:2: ( (enumLiteral_0= Asterisk ) |
				// (enumLiteral_1= Solidus ) | (enumLiteral_2= MOD ) )
	...
	// InternalStructuredTextParser.g:4316:1: rulePower_Operator returns [Enumerator
	...
	// InternalStructuredTextParser.g:4333:1: ruleUnary_Operator returns [Enumerator
	...
	public final Enumerator ruleUnary_Operator() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:4339:2: ( ( (enumLiteral_0= HyphenMinus ) |
			// (enumLiteral_1= PlusSign ) | (enumLiteral_2= NOT ) ) )
			// InternalStructuredTextParser.g:4340:2: ( (enumLiteral_0= HyphenMinus ) |
			// (enumLiteral_1= PlusSign ) | (enumLiteral_2= NOT ) )
			{
				// InternalStructuredTextParser.g:4340:2: ( (enumLiteral_0= HyphenMinus ) |
				// (enumLiteral_1= PlusSign ) | (enumLiteral_2= NOT ) )
	...
	// InternalStructuredTextParser.g:4368:1: ruleDuration_Unit returns [Enumerator
	...
	public final Enumerator ruleDuration_Unit() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:4374:2: ( ( (enumLiteral_0= D_1 ) |
			// (enumLiteral_1= H ) | (enumLiteral_2= M ) | (enumLiteral_3= S ) |
			// (enumLiteral_4= Ms ) | (enumLiteral_5= Us ) | (enumLiteral_6= Ns ) ) )
			// InternalStructuredTextParser.g:4375:2: ( (enumLiteral_0= D_1 ) |
			// (enumLiteral_1= H ) | (enumLiteral_2= M ) | (enumLiteral_3= S ) |
			// (enumLiteral_4= Ms ) | (enumLiteral_5= Us ) | (enumLiteral_6= Ns ) )
			{
				// InternalStructuredTextParser.g:4375:2: ( (enumLiteral_0= D_1 ) |
	...
	// InternalStructuredTextParser.g:4435:1: ruleInt_Type_Name returns [Enumerator
	...
	// InternalStructuredTextParser.g:4510:1: ruleReal_Type_Name returns [Enumerator
	...
	public final Enumerator ruleReal_Type_Name() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:4516:2: ( ( (enumLiteral_0= REAL ) |
			// (enumLiteral_1= LREAL ) ) )
			// InternalStructuredTextParser.g:4517:2: ( (enumLiteral_0= REAL ) |
			// (enumLiteral_1= LREAL ) )
			{
				// InternalStructuredTextParser.g:4517:2: ( (enumLiteral_0= REAL ) |
				// (enumLiteral_1= LREAL ) )
	...
	// InternalStructuredTextParser.g:4537:1: ruleString_Type_Name returns
	...
	public final Enumerator ruleString_Type_Name() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:4543:2: ( ( (enumLiteral_0= STRING ) |
			// (enumLiteral_1= WSTRING ) | (enumLiteral_2= CHAR ) | (enumLiteral_3= WCHAR )
			// ) )
			// InternalStructuredTextParser.g:4544:2: ( (enumLiteral_0= STRING ) |
			// (enumLiteral_1= WSTRING ) | (enumLiteral_2= CHAR ) | (enumLiteral_3= WCHAR )
			// )
			{
				// InternalStructuredTextParser.g:4544:2: ( (enumLiteral_0= STRING ) |
	...
	// InternalStructuredTextParser.g:4580:1: ruleTime_Type_Name returns [Enumerator
	...
	public final Enumerator ruleTime_Type_Name() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:4586:2: ( ( (enumLiteral_0= TIME ) |
			// (enumLiteral_1= LTIME ) | (enumLiteral_2= T ) | (enumLiteral_3= LT ) ) )
			// InternalStructuredTextParser.g:4587:2: ( (enumLiteral_0= TIME ) |
			// (enumLiteral_1= LTIME ) | (enumLiteral_2= T ) | (enumLiteral_3= LT ) )
			{
				// InternalStructuredTextParser.g:4587:2: ( (enumLiteral_0= TIME ) |
				// (enumLiteral_1= LTIME ) | (enumLiteral_2= T ) | (enumLiteral_3= LT ) )
	...
	// InternalStructuredTextParser.g:4623:1: ruleTod_Type_Name returns [Enumerator
	...
	public final Enumerator ruleTod_Type_Name() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:4629:2: ( ( (enumLiteral_0= TIME_OF_DAY ) |
			// (enumLiteral_1= LTIME_OF_DAY ) | (enumLiteral_2= TOD ) | (enumLiteral_3= LTOD
			// ) ) )
			// InternalStructuredTextParser.g:4630:2: ( (enumLiteral_0= TIME_OF_DAY ) |
			// (enumLiteral_1= LTIME_OF_DAY ) | (enumLiteral_2= TOD ) | (enumLiteral_3= LTOD
			// ) )
			{
				// InternalStructuredTextParser.g:4630:2: ( (enumLiteral_0= TIME_OF_DAY ) |
	...
	// InternalStructuredTextParser.g:4666:1: ruleDate_Type_Name returns [Enumerator
	...
	public final Enumerator ruleDate_Type_Name() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:4672:2: ( ( (enumLiteral_0= DATE ) |
			// (enumLiteral_1= LDATE ) | (enumLiteral_2= D_1 ) | (enumLiteral_3= LD ) ) )
			// InternalStructuredTextParser.g:4673:2: ( (enumLiteral_0= DATE ) |
			// (enumLiteral_1= LDATE ) | (enumLiteral_2= D_1 ) | (enumLiteral_3= LD ) )
			{
				// InternalStructuredTextParser.g:4673:2: ( (enumLiteral_0= DATE ) |
				// (enumLiteral_1= LDATE ) | (enumLiteral_2= D_1 ) | (enumLiteral_3= LD ) )
	...
	// InternalStructuredTextParser.g:4709:1: ruleDT_Type_Name returns [Enumerator
	...
	public final Enumerator ruleDT_Type_Name() throws RecognitionException {
		...
		try {
			// InternalStructuredTextParser.g:4715:2: ( ( (enumLiteral_0= DATE_AND_TIME ) |
			// (enumLiteral_1= LDATE_AND_TIME ) | (enumLiteral_2= DT ) | (enumLiteral_3= LDT
			// ) ) )
			// InternalStructuredTextParser.g:4716:2: ( (enumLiteral_0= DATE_AND_TIME ) |
			// (enumLiteral_1= LDATE_AND_TIME ) | (enumLiteral_2= DT ) | (enumLiteral_3= LDT
			// ) )
			{
				// InternalStructuredTextParser.g:4716:2: ( (enumLiteral_0= DATE_AND_TIME ) |
	...
	// InternalStructuredTextParser.g:4752:1: ruleBool_Type_Name returns [Enumerator
