...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Out
 * Argument</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.OutArgumentImpl#isNot
 * <em>Not</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.OutArgumentImpl#getExpr
 * <em>Expr</em>}</li>
 * </ul>
 *
 * @generated
...
public class OutArgumentImpl extends ArgumentImpl implements OutArgument {
	...
	public void setNot(boolean newNot) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.OUT_ARGUMENT__NOT, oldNot,
					not));
	}
	...
	public NotificationChain basicSetExpr(Variable newExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.OUT_ARGUMENT__EXPR, oldExpr, newExpr);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpr != expr) {
			...
			if (expr != null)
				msgs = ((InternalEObject) expr).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.OUT_ARGUMENT__EXPR, null, msgs);
			if (newExpr != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.OUT_ARGUMENT__EXPR, newExpr,
					newExpr));
	}
