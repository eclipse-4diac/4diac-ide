...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Partial
 * Access</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.PartialAccessImpl#isDwordaccess
 * <em>Dwordaccess</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.PartialAccessImpl#getIndex
 * <em>Index</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.PartialAccessImpl#isWordaccess
 * <em>Wordaccess</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.PartialAccessImpl#isByteaccess
 * <em>Byteaccess</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.PartialAccessImpl#isBitaccess
 * <em>Bitaccess</em>}</li>
 * </ul>
 *
 * @generated
...
public class PartialAccessImpl extends MinimalEObjectImpl.Container implements PartialAccess {
	/**
	 * The default value of the '{@link #isDwordaccess() <em>Dwordaccess</em>}'
	...
	/**
	 * The cached value of the '{@link #isDwordaccess() <em>Dwordaccess</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isDwordaccess()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isWordaccess() <em>Wordaccess</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isWordaccess()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isWordaccess() <em>Wordaccess</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isWordaccess()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isByteaccess() <em>Byteaccess</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isByteaccess()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isByteaccess() <em>Byteaccess</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isByteaccess()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isBitaccess() <em>Bitaccess</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isBitaccess()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isBitaccess() <em>Bitaccess</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isBitaccess()
	 * @generated
	...
	public void setDwordaccess(boolean newDwordaccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.PARTIAL_ACCESS__DWORDACCESS,
					oldDwordaccess, dwordaccess));
	}
	...
	public void setIndex(int newIndex) {
		...
		index = newIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.PARTIAL_ACCESS__INDEX, oldIndex,
					index));
	}
	...
	public void setWordaccess(boolean newWordaccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.PARTIAL_ACCESS__WORDACCESS,
					oldWordaccess, wordaccess));
	}
	...
	public void setByteaccess(boolean newByteaccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.PARTIAL_ACCESS__BYTEACCESS,
					oldByteaccess, byteaccess));
	}
	...
	public void setBitaccess(boolean newBitaccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.PARTIAL_ACCESS__BITACCESS,
					oldBitaccess, bitaccess));
	}
