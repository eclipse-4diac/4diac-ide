 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.LocalVariableImpl#isConstant
 * <em>Constant</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.LocalVariableImpl#isArray
 * <em>Array</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.LocalVariableImpl#getInitialValue
...
public class LocalVariableImpl extends VarDeclarationImpl implements LocalVariable {
	...
	public void setConstant(boolean newConstant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.LOCAL_VARIABLE__CONSTANT,
	...
	public void setArray(boolean newArray) {
		...
		array = newArray;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.LOCAL_VARIABLE__ARRAY, oldArray,
					array));
	}
	...
	public NotificationChain basicSetInitialValue(Constant newInitialValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.LOCAL_VARIABLE__INITIAL_VALUE, oldInitialValue, newInitialValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newInitialValue != initialValue) {
			...
			if (initialValue != null)
				msgs = ((InternalEObject) initialValue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.LOCAL_VARIABLE__INITIAL_VALUE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.LOCAL_VARIABLE__INITIAL_VALUE,
