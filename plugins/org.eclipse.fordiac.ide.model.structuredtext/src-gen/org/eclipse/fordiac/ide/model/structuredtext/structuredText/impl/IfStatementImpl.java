...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>If
 * Statement</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.IfStatementImpl#getExpression
 * <em>Expression</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.IfStatementImpl#getStatments
 * <em>Statments</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.IfStatementImpl#getElseif
 * <em>Elseif</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.IfStatementImpl#getElse
 * <em>Else</em>}</li>
 * </ul>
 *
 * @generated
...
public class IfStatementImpl extends StatementImpl implements IfStatement {
	...
	/**
	 * The cached value of the '{@link #getStatments() <em>Statments</em>}'
	 * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getStatments()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getElseif() <em>Elseif</em>}' containment
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.IF_STATEMENT__EXPRESSION, oldExpression, newExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject) expression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.IF_STATEMENT__EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.IF_STATEMENT__EXPRESSION,
	...
	public NotificationChain basicSetStatments(StatementList newStatments, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.IF_STATEMENT__STATMENTS, oldStatments, newStatments);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setStatments(StatementList newStatments) {
		if (newStatments != statments) {
			NotificationChain msgs = null;
			if (statments != null)
				msgs = ((InternalEObject) statments).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.IF_STATEMENT__STATMENTS, null, msgs);
			if (newStatments != null)
				msgs = ((InternalEObject) newStatments).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.IF_STATEMENT__STATMENTS, null, msgs);
			msgs = basicSetStatments(newStatments, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.IF_STATEMENT__STATMENTS,
					newStatments, newStatments));
	}
	...
	public EList<ElseIfClause> getElseif() {
		if (elseif == null) {
			elseif = new EObjectContainmentEList<ElseIfClause>(ElseIfClause.class, this,
					StructuredTextPackage.IF_STATEMENT__ELSEIF);
		}
		return elseif;
	}
	...
	public NotificationChain basicSetElse(ElseClause newElse, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.IF_STATEMENT__ELSE, oldElse, newElse);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newElse != else_) {
			...
			if (else_ != null)
				msgs = ((InternalEObject) else_).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.IF_STATEMENT__ELSE, null, msgs);
			if (newElse != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.IF_STATEMENT__ELSE, newElse,
					newElse));
	}
