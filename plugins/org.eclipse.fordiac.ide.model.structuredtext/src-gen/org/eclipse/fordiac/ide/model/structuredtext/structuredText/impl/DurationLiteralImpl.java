 ...
 * '<em><b>Duration Literal</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.DurationLiteralImpl#isNegative
 * <em>Negative</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.DurationLiteralImpl#getValue
 * <em>Value</em>}</li>
 * </ul>
 *
 * @generated
...
public class DurationLiteralImpl extends TimeLiteralImpl implements DurationLiteral {
	...
	public void setNegative(boolean newNegative) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.DURATION_LITERAL__NEGATIVE,
	...
	public EList<DurationValue> getValue() {
		if (value == null) {
			value = new EObjectContainmentEList<DurationValue>(DurationValue.class, this,
					StructuredTextPackage.DURATION_LITERAL__VALUE);
		}
		return value;
	}
