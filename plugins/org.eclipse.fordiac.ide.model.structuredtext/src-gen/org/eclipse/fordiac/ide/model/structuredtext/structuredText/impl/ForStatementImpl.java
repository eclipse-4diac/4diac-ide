...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>For
 * Statement</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.ForStatementImpl#getVariable
 * <em>Variable</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.ForStatementImpl#getFrom
 * <em>From</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.ForStatementImpl#getTo
 * <em>To</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.ForStatementImpl#getBy
 * <em>By</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.ForStatementImpl#getStatements
 * <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
...
public class ForStatementImpl extends StatementImpl implements ForStatement {
	...
	public NotificationChain basicSetVariable(PrimaryVariable newVariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.FOR_STATEMENT__VARIABLE, oldVariable, newVariable);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newVariable != variable) {
			...
			if (variable != null)
				msgs = ((InternalEObject) variable).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.FOR_STATEMENT__VARIABLE, null, msgs);
			if (newVariable != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.FOR_STATEMENT__VARIABLE,
	...
	public NotificationChain basicSetFrom(Expression newFrom, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.FOR_STATEMENT__FROM, oldFrom, newFrom);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newFrom != from) {
			...
			if (from != null)
				msgs = ((InternalEObject) from).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.FOR_STATEMENT__FROM, null, msgs);
			if (newFrom != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.FOR_STATEMENT__FROM, newFrom,
					newFrom));
	}
	...
	public NotificationChain basicSetTo(Expression newTo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.FOR_STATEMENT__TO, oldTo, newTo);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newTo != to) {
			...
			if (to != null)
				msgs = ((InternalEObject) to).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.FOR_STATEMENT__TO, null, msgs);
			if (newTo != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.FOR_STATEMENT__TO, newTo,
					newTo));
	}
	...
	public NotificationChain basicSetBy(Expression newBy, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.FOR_STATEMENT__BY, oldBy, newBy);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newBy != by) {
			...
			if (by != null)
				msgs = ((InternalEObject) by).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.FOR_STATEMENT__BY, null, msgs);
			if (newBy != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.FOR_STATEMENT__BY, newBy,
					newBy));
	}
	...
	public NotificationChain basicSetStatements(StatementList newStatements, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.FOR_STATEMENT__STATEMENTS, oldStatements, newStatements);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newStatements != statements) {
			...
			if (statements != null)
				msgs = ((InternalEObject) statements).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.FOR_STATEMENT__STATEMENTS, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.FOR_STATEMENT__STATEMENTS,
