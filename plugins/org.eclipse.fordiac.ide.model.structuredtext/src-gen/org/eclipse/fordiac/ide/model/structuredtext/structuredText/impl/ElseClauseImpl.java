...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Else
 * Clause</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.ElseClauseImpl#getStatements
 * <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
	...
	public NotificationChain basicSetStatements(StatementList newStatements, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.ELSE_CLAUSE__STATEMENTS, oldStatements, newStatements);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newStatements != statements) {
			...
			if (statements != null)
				msgs = ((InternalEObject) statements).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.ELSE_CLAUSE__STATEMENTS, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.ELSE_CLAUSE__STATEMENTS,
