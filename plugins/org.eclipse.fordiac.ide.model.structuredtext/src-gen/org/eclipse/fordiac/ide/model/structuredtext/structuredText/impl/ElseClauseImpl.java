 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.ElseClauseImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElseClauseImpl extends MinimalEObjectImpl.Container implements ElseClause
{
  ...
  {
    return StructuredTextPackage.Literals.ELSE_CLAUSE;
  }
...
public StatementList getStatements()
  ...
  public NotificationChain basicSetStatements(StatementList newStatements, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StructuredTextPackage.ELSE_CLAUSE__STATEMENTS, oldStatements, newStatements);
...
public void setStatements(StatementList newStatements)
  {
    if (newStatements != statements)
    {
      ...
      if (statements != null)
        msgs = ((InternalEObject)statements).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StructuredTextPackage.ELSE_CLAUSE__STATEMENTS, null, msgs);
      if (newStatements != null)
        msgs = ((InternalEObject)newStatements).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StructuredTextPackage.ELSE_CLAUSE__STATEMENTS, null, msgs);
      msgs = basicSetStatements(newStatements, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.ELSE_CLAUSE__STATEMENTS, newStatements, newStatements));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case StructuredTextPackage.ELSE_CLAUSE__STATEMENTS:
