 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.ArrayVariableImpl#getArray
 * <em>Array</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.impl.ArrayVariableImpl#getIndex
 * <em>Index</em>}</li>
 * </ul>
 *
 * @generated
...
public class ArrayVariableImpl extends VariableImpl implements ArrayVariable {
	/**
	 * The cached value of the '{@link #getArray() <em>Array</em>}' containment
	...
	public NotificationChain basicSetArray(Variable newArray, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StructuredTextPackage.ARRAY_VARIABLE__ARRAY, oldArray, newArray);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newArray != array) {
			...
			if (array != null)
				msgs = ((InternalEObject) array).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StructuredTextPackage.ARRAY_VARIABLE__ARRAY, null, msgs);
			if (newArray != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextPackage.ARRAY_VARIABLE__ARRAY, newArray,
					newArray));
	}
	...
	public EList<Expression> getIndex() {
		if (index == null) {
			index = new EObjectContainmentEList<Expression>(Expression.class, this,
					StructuredTextPackage.ARRAY_VARIABLE__INDEX);
		}
		return index;
	}
