...
// Entry rule entryRuleFBCall
entryRuleFBCall returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getFBCallRule()); }
	iv_ruleFBCall=ruleFBCall
	{ $current=$iv_ruleFBCall.current; }
	EOF;

// Rule FBCall
ruleFBCall returns [EObject current=null]
@init {
	enterRule();
}
@after {
