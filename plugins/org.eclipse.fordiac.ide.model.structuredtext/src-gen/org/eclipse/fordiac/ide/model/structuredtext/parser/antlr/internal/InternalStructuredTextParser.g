...
entryRuleDuration_Value returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getDuration_ValueRule()); }
	iv_ruleDuration_Value=ruleDuration_Value
	{ $current=$iv_ruleDuration_Value.current; }
	EOF;

// Rule Duration_Value
ruleDuration_Value returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleFix_Point returns [String current=null]:
	{ newCompositeNode(grammarAccess.getFix_PointRule()); }
	iv_ruleFix_Point=ruleFix_Point
	{ $current=$iv_ruleFix_Point.current.getText(); }
	EOF;

// Rule Fix_Point
ruleFix_Point returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
entryRuleDaytime returns [String current=null]:
	{ newCompositeNode(grammarAccess.getDaytimeRule()); }
	iv_ruleDaytime=ruleDaytime
	{ $current=$iv_ruleDaytime.current.getText(); }
	EOF;

// Rule Daytime
ruleDaytime returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
entryRuleDay_Hour returns [String current=null]:
	{ newCompositeNode(grammarAccess.getDay_HourRule()); }
	iv_ruleDay_Hour=ruleDay_Hour
	{ $current=$iv_ruleDay_Hour.current.getText(); }
	EOF;

// Rule Day_Hour
ruleDay_Hour returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
entryRuleDay_Minute returns [String current=null]:
	{ newCompositeNode(grammarAccess.getDay_MinuteRule()); }
	iv_ruleDay_Minute=ruleDay_Minute
	{ $current=$iv_ruleDay_Minute.current.getText(); }
	EOF;

// Rule Day_Minute
ruleDay_Minute returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
entryRuleDay_Second returns [String current=null]:
	{ newCompositeNode(grammarAccess.getDay_SecondRule()); }
	iv_ruleDay_Second=ruleDay_Second
	{ $current=$iv_ruleDay_Second.current.getText(); }
	EOF;

// Rule Day_Second
ruleDay_Second returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
entryRuleDate_Literal returns [String current=null]:
	{ newCompositeNode(grammarAccess.getDate_LiteralRule()); }
	iv_ruleDate_Literal=ruleDate_Literal
	{ $current=$iv_ruleDate_Literal.current.getText(); }
	EOF;

// Rule Date_Literal
ruleDate_Literal returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
// Rule Time_Type_Name
ruleTime_Type_Name returns [Enumerator current=null]
@init {
	enterRule();
}
@after {
...
// Rule Tod_Type_Name
ruleTod_Type_Name returns [Enumerator current=null]
@init {
	enterRule();
}
@after {
...
// Rule Date_Type_Name
ruleDate_Type_Name returns [Enumerator current=null]
@init {
	enterRule();
}
@after {
...
// Rule DT_Type_Name
ruleDT_Type_Name returns [Enumerator current=null]
@init {
	enterRule();
}
@after {
