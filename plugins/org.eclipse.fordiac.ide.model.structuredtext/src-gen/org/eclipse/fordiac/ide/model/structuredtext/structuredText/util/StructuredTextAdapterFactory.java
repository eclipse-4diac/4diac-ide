...
public class StructuredTextAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected StructuredTextSwitch<Adapter> modelSwitch =
    new StructuredTextSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseFB_Call(FB_Call object)
      {
        return createFB_CallAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.fordiac.ide.model.structuredtext.structuredText.FB_Call <em>FB Call</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createFB_CallAdapter()
  {
    return null;
  }
