...
public class StructuredTextGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class Var_Decl_LocalElements extends AbstractParserRuleElementFinder {
		...
		//{LocalVariable} constant?='CONSTANT'? name=ID (located?='AT' location=Variable)? ':' (array?='ARRAY' '['
		//arrayStart=Array_Size '..' arrayStop=Array_Size ']' 'OF')? type=[datatype::DataType|Type_Name] (initalized?=':='
	...
	public class Multibit_Part_AccessElements extends AbstractParserRuleElementFinder {
		...
		//	dwordaccess?='.%D' index=Partial_Value | wordaccess?='.%W' index=Partial_Value | byteaccess?='.%B' index=Partial_Value
	...
	public class Type_NameElements extends AbstractParserRuleElementFinder {
		...
		//| 'DATE' | 'LDATE' | 'DATE_AND_TIME' | 'LDATE_AND_TIME' | 'BOOL' | 'LWORD' | 'DWORD' | 'WORD' | 'BYTE'
		public Alternatives getAlternatives() { return cAlternatives; }
