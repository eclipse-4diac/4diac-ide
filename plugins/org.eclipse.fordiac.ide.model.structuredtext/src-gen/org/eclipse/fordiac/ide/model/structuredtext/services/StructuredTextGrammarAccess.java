...
public class StructuredTextGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class Subprog_Ctrl_StmtElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cFBCallParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		...
		//FBCall
		public RuleCall getFBCallParserRuleCall_1() { return cFBCallParserRuleCall_1; }
	...
	public class FBCallElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.fordiac.ide.model.structuredtext.StructuredText.FBCall");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private final FBCallElements pFBCall;
	...
	public StructuredTextGrammarAccess(GrammarProvider grammarProvider) {
		...
		this.pFBCall = new FBCallElements();
	...
	public ParserRule getFBCallRule() {
		return getFBCallAccess().getRule();
	}
