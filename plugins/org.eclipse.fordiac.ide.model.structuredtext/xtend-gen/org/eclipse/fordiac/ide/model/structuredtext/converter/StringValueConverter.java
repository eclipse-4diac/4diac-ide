	...
	protected String internalToValue(final String string, final INode node) {
		try {
			String _xblockexpression = null;
			{
				...
				if (((string.charAt(0) != this.getQuote())
						|| (string.charAt((string.length() - 1)) != this.getQuote()))) {
				...
				for (int i = new Function0<Integer>() {
							...
							char _xblockexpression_1 = (char) 0;
							{
								...
								if (_tripleEquals_7) {
									throw new ValueConverterException(
											"Couldn\'t convert value due to illegal quote character inside string",
											null, null);
								}
					...
					if (!_matched) {
						...
						if (_tripleEquals_7) {
							...
							Object _xblockexpression_2 = null;
							{
								...
								if ((i == (-1))) {
									throw new ValueConverterException(
											"Couldn\'t convert value due to invalid escape sequence", null, null);
								}
					...
					if (!_matched) {
						throw new ValueConverterException("Couldn\'t convert value due to invalid character", null,
								null);
					}
