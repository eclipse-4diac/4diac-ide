...
import org.eclipse.fordiac.ide.fbtester.model.testdata.*;
...
public class TestdataFactoryImpl extends EFactoryImpl implements TestdataFactory {
	...
	public static TestdataFactory init() {
		try {
			TestdataFactory theTestdataFactory = (TestdataFactory)EPackage.Registry.INSTANCE.getEFactory(TestdataPackage.eNS_URI);
