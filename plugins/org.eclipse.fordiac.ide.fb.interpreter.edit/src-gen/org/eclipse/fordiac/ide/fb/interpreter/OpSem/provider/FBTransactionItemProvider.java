 ...
 * {@link org.eclipse.fordiac.ide.fb.interpreter.OpSem.FBTransaction} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class FBTransactionItemProvider extends TransactionItemProvider {
	/**
	...
	protected void addInputVariablesPropertyDescriptor(final Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FBTransaction_inputVariables_feature", //$NON-NLS-1$ //$NON-NLS-2$
								"_UI_FBTransaction_type"), //$NON-NLS-1$
						OperationalSemanticsPackage.Literals.FB_TRANSACTION__INPUT_VARIABLES, true, false, true, null,
						null, null));
	}
