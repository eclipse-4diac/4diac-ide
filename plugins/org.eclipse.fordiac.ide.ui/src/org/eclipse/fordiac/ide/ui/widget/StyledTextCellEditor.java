...
public class StyledTextCellEditor extends CellEditor {
	...
	/** Default StyledTextCellEditor style specify no borders on text widget as cell outline in table already provides
	 * the look of a border. */
	...
	/** The <code>StyledTextCellEditor</code> implementation of this <code>CellEditor</code> framework method returns
	 * the text string.
	 *
	...
	/** The <code>StyledTextCellEditor</code> implementation of this <code>CellEditor</code> framework method accepts a
	 * text string (type <code>String</code>).
	 *
	...
	/** The <code>StyledTextCellEditor</code> implementation of this <code>CellEditor</code> method returns
	 * <code>true</code> if the current selection is not empty. */
	@Override
	...
	/** The <code>StyledTextCellEditor</code> implementation of this <code>CellEditor</code> method returns
	 * <code>true</code> if there is a selection or if the caret is not positioned at the end of the text. */
	@Override
	...
	/** The <code>StyledTextCellEditor</code> implementation of this <code>CellEditor</code> method always returns
	 * <code>true</code>. */
	@Override
	...
	/** The <code>StyledTextCellEditor</code> implementation of this <code>CellEditor</code> method copies the current
	...
	/** The <code>StyledTextCellEditor</code> implementation of this <code>CellEditor</code> method cuts the current
	 * selection to the clipboard. */
	@Override
	...
	/** The <code>StyledTextCellEditor</code> implementation of this <code>CellEditor</code> method deletes the current
	 * selection or, if there is no selection, the character next character from the current position. */
	@Override
	...
	/** The <code>StyledTextCellEditor</code> implementation of this <code>CellEditor</code> method pastes the the
	 * clipboard contents over the current selection. */
	@Override
	...
	/** The <code>StyledTextCellEditor</code> implementation of this <code>CellEditor</code> method selects all of the
	 * current text. */
	@Override
	...
	/** This implementation of {@link CellEditor#dependsOnExternalFocusListener()} returns false if the current
	 * instance's class is StyledTextCellEditor, and true otherwise. Subclasses that hook their own focus listener
	 * should override this method and return false. See also bug 58777.
	 *
	 * @since 3.4 */
	@Override
