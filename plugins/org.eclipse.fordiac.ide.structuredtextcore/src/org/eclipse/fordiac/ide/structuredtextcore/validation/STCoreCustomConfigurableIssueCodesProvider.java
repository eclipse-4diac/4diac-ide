...
public class STCoreCustomConfigurableIssueCodesProvider extends STCoreConfigurableIssueCodesProvider {
	...
	protected void initialize(final IAcceptor<PreferenceKey> acceptor) {
		...
		acceptor.accept(create(STCoreValidator.TRUNCATING_LITERAL_CONVERSION, SeverityConverter.SEVERITY_WARNING));
		...
		acceptor.accept(create(STCoreValidator.FOR_CONTROL_VARIABLE_UNDEFINED, SeverityConverter.SEVERITY_WARNING));
		acceptor.accept(create(STCoreValidator.UNUSED_VARIABLE, SeverityConverter.SEVERITY_WARNING));
		acceptor.accept(create(STCoreValidator.UNREAD_VARIABLE, SeverityConverter.SEVERITY_WARNING));
		acceptor.accept(create(STCoreValidator.UNWRITTEN_VARIABLE, SeverityConverter.SEVERITY_WARNING));
		acceptor.accept(create(STCoreValidator.NO_SIDE_EFFECTS, SeverityConverter.SEVERITY_WARNING));
	}
}
