...
public class AdapterTypeSelectionContentProvider implements ITypeSelectionContentProvider {

	public static final AdapterTypeSelectionContentProvider INSTANCE = new AdapterTypeSelectionContentProvider();

	protected AdapterTypeSelectionContentProvider() {
	}
