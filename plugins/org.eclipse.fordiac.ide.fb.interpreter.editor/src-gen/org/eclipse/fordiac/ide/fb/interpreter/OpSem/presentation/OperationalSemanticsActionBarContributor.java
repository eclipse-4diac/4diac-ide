...
public class OperationalSemanticsActionBarContributor extends EditingDomainActionBarContributor
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		toolBarManager.add(new Separator("operationalsemantics-settings")); //$NON-NLS-1$
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		createChildMenuManager = new MenuManager(
				OperationalSemanticsEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
		submenuManager.insertBefore("additions", createChildMenuManager); //$NON-NLS-1$

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(
				OperationalSemanticsEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item")); //$NON-NLS-1$
