...
public class TestdataAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected TestdataSwitch<Adapter> modelSwitch =
		new TestdataSwitch<Adapter>() {
			@Override
			public Adapter caseTestData(TestData object) {
				return createTestDataAdapter();
			}
			@Override
			public Adapter caseValuedVarDecl(ValuedVarDecl object) {
				return createValuedVarDeclAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.fordiac.ide.fbtester.model.testdata.TestData <em>Test Data</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.fordiac.ide.fbtester.model.testdata.ValuedVarDecl <em>Valued Var Decl</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
