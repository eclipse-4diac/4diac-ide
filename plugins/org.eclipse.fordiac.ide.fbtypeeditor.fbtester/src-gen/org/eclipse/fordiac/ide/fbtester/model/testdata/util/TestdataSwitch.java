...
public class TestdataSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case TestdataPackage.VALUED_VAR_DECL: {
			ValuedVarDecl valuedVarDecl = (ValuedVarDecl) theEObject;
			T result = caseValuedVarDecl(valuedVarDecl);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Test
	 * Data</em>'. <!-- begin-user-doc --> This implementation returns null;
	 * returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Test
	 *         Data</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Valued
	 * Var Decl</em>'. <!-- begin-user-doc --> This implementation returns null;
	 * returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Valued
	 *         Var Decl</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseValuedVarDecl(ValuedVarDecl object) {
		return null;
	}
