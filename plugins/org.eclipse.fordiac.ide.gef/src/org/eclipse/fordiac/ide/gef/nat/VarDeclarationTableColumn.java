...
public enum VarDeclarationTableColumn implements NatTableColumn {
	...
	VISIBLEOUT(FordiacMessages.Visible_OUT), LOCATION(FordiacMessages.Location), PATH(FordiacMessages.Path);
	...
	public static final List<VarDeclarationTableColumn> DEFAULT_COLUMNS_WITH_LOCATION = List.of(LOCATION, PATH, NAME,
			TYPE, COMMENT, INITIAL_VALUE);
