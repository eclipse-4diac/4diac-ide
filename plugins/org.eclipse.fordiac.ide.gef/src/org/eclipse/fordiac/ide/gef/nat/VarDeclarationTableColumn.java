...
public enum VarDeclarationTableColumn implements NatTableColumn {
	...
	VISIBLEOUT(FordiacMessages.Visible_OUT), LOCATION(FordiacMessages.Location), FILE_PATH(FordiacMessages.File_Path);
	...
	public static final List<VarDeclarationTableColumn> DEFAULT_COLUMNS_WITH_LOCATION = List.of(FILE_PATH, LOCATION,
			NAME, TYPE, COMMENT, INITIAL_VALUE);
	...
	public static final Set<VarDeclarationTableColumn> EDITABLE_NO_LOCATION = Set.of(NAME, TYPE, COMMENT,
			INITIAL_VALUE);
