...
public class InitialValueGenericEditorConfiguration<T> extends AbstractRegistryConfiguration {
	...
	private final InitialValueStructuredElementAccessor<T> elementAccessor;

	public InitialValueGenericEditorConfiguration(final IRowDataProvider<? extends T> dataProvider,
