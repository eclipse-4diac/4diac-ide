 ...
 * @generated
 */
public class ExportsImpl extends EObjectImpl implements Exports {
	/**
	...
	public EList<Library> getLibrary() {
		if (library == null) {
			library = new EObjectContainmentEList<Library>(Library.class, this, LibraryPackage.EXPORTS__LIBRARY);
		}
		return library;
	}
