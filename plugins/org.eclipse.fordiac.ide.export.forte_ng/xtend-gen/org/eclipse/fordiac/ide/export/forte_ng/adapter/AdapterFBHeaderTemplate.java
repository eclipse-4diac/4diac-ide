...
public class AdapterFBHeaderTemplate extends ForteFBTemplate {
	...
	public CharSequence generate() {
		...
		_builder.newLineIfNotEmpty();
		_builder.append("  ");
		CharSequence _generateAccessors_1 = this.generateAccessors(this.type.getInterfaceList().getOutputVars(),
				"getDO", "getDI");
		...
		CharSequence _generateAccessors_2 = this.generateAccessors(
				IterableExtensions.<AdapterDeclaration>toList(Iterables.<AdapterDeclaration>concat(_sockets, _plugs)));
		...
		_builder.newLine();
		_builder.append("  ");
		CharSequence _generateEventAccessors = this
				.generateEventAccessors(this.type.getInterfaceList().getEventInputs());
		_builder.append(_generateEventAccessors, "  ");
		_builder.newLineIfNotEmpty();
		_builder.append("  ");
		CharSequence _generateEventAccessors_1 = this
				.generateEventAccessors(this.type.getInterfaceList().getEventOutputs());
	...
	protected CharSequence generateAccessors(final List<VarDeclaration> vars, final String socketFunction,
			final String plugFunction) {
		StringConcatenation _builder = new StringConcatenation();
		{
