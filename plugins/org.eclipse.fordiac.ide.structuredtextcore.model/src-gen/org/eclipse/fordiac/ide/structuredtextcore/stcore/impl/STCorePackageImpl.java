...
public class STCorePackageImpl extends EPackageImpl implements STCorePackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getSTVarDeclaration_Type(), theDataPackage.getDataType(), null, "type", null, 0, 1, STVarDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getSTTypeDeclaration_Type(), theDataPackage.getDataType(), null, "type", null, 0, 1, STTypeDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
