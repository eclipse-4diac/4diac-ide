...
public class STTimeOfDayLiteralImpl extends STExpressionImpl implements STTimeOfDayLiteral {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, STCorePackage.ST_TIME_OF_DAY_LITERAL__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(DataType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, STCorePackage.ST_TIME_OF_DAY_LITERAL__TYPE, oldType, type));
	}
