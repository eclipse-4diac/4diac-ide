 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fordiac.ide.model.monitoring.impl.AdapterMonitoringVarDeclarationImpl#getAnnotations
 ...
 * <em>Type</em>}</li>
 * <li>{@link org.eclipse.fordiac.ide.model.monitoring.impl.AdapterMonitoringVarDeclarationImpl#getTypeName
 * <em>Type Name</em>}</li>
...
public class AdapterMonitoringVarDeclarationImpl extends EObjectImpl implements AdapterMonitoringVarDeclaration {
	...
	public EList<Annotation> getAnnotations() {
		if (annotations == null) {
			annotations = new EObjectResolvingEList<Annotation>(Annotation.class, this,
					MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__ANNOTATIONS);
		}
		return annotations;
	}
	...
	public void setTypeName(String newTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__TYPE_NAME, oldTypeName, typeName));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == I4DIACElement.class) {
			...
			case MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__ANNOTATIONS:
				return LibraryElementPackage.I4DIAC_ELEMENT__ANNOTATIONS;
			default:
				return -1;
			}
		}
		if (baseClass == INamedElement.class) {
			switch (derivedFeatureID) {
			case MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__NAME:
				return LibraryElementPackage.INAMED_ELEMENT__NAME;
			case MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__COMMENT:
				return LibraryElementPackage.INAMED_ELEMENT__COMMENT;
			default:
				return -1;
			}
		}
		if (baseClass == IInterfaceElement.class) {
			switch (derivedFeatureID) {
			case MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__IS_INPUT:
				return LibraryElementPackage.IINTERFACE_ELEMENT__IS_INPUT;
			case MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__INPUT_CONNECTIONS:
				return LibraryElementPackage.IINTERFACE_ELEMENT__INPUT_CONNECTIONS;
			case MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__OUTPUT_CONNECTIONS:
				return LibraryElementPackage.IINTERFACE_ELEMENT__OUTPUT_CONNECTIONS;
			case MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__TYPE:
				return LibraryElementPackage.IINTERFACE_ELEMENT__TYPE;
			case MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__TYPE_NAME:
				return LibraryElementPackage.IINTERFACE_ELEMENT__TYPE_NAME;
			default:
				return -1;
			}
		}
		if (baseClass == VarDeclaration.class) {
			switch (derivedFeatureID) {
			case MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__ARRAY_SIZE:
				return LibraryElementPackage.VAR_DECLARATION__ARRAY_SIZE;
			case MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__WITHS:
				return LibraryElementPackage.VAR_DECLARATION__WITHS;
			case MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__VALUE:
				return LibraryElementPackage.VAR_DECLARATION__VALUE;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == I4DIACElement.class) {
			...
			case LibraryElementPackage.I4DIAC_ELEMENT__ANNOTATIONS:
				return MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__ANNOTATIONS;
			default:
				return -1;
			}
		}
		if (baseClass == INamedElement.class) {
			switch (baseFeatureID) {
			case LibraryElementPackage.INAMED_ELEMENT__NAME:
				return MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__NAME;
			case LibraryElementPackage.INAMED_ELEMENT__COMMENT:
				return MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__COMMENT;
			default:
				return -1;
			}
		}
		if (baseClass == IInterfaceElement.class) {
			...
			case LibraryElementPackage.IINTERFACE_ELEMENT__IS_INPUT:
				return MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__IS_INPUT;
			case LibraryElementPackage.IINTERFACE_ELEMENT__INPUT_CONNECTIONS:
				return MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__INPUT_CONNECTIONS;
			case LibraryElementPackage.IINTERFACE_ELEMENT__OUTPUT_CONNECTIONS:
				return MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__OUTPUT_CONNECTIONS;
			case LibraryElementPackage.IINTERFACE_ELEMENT__TYPE:
				return MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__TYPE;
			case LibraryElementPackage.IINTERFACE_ELEMENT__TYPE_NAME:
				return MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__TYPE_NAME;
			default:
				return -1;
			}
		}
		if (baseClass == VarDeclaration.class) {
			...
			case LibraryElementPackage.VAR_DECLARATION__ARRAY_SIZE:
				return MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__ARRAY_SIZE;
			case LibraryElementPackage.VAR_DECLARATION__WITHS:
				return MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__WITHS;
			case LibraryElementPackage.VAR_DECLARATION__VALUE:
				return MonitoringPackage.ADAPTER_MONITORING_VAR_DECLARATION__VALUE;
			default:
				return -1;
			}
		}
