...
public class MonitoringPackageImpl extends EPackageImpl implements MonitoringPackage {
	...
	public static MonitoringPackage init() {
		...
		MonitoringPackageImpl theMonitoringPackage = registeredMonitoringPackage instanceof MonitoringPackageImpl
	...
	public void initializePackageContents() {
		...
		MonitoringBasePackage theMonitoringBasePackage = (MonitoringBasePackage) EPackage.Registry.INSTANCE
		...
		initEReference(getMonitoringAdapterElement_Elements(), this.getMonitoringElement(), null, "elements", null, 0, //$NON-NLS-1$
				-1, MonitoringAdapterElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
