...
public class LuaConstants {
	...
	public static CharSequence luaFBAdapterConstants(final InterfaceList ifl) {
		StringConcatenation _builder = new StringConcatenation();
		{
			...
			for (final AdapterDeclaration socket : _sockets) {
				CharSequence _luaFBAdapterInterfaceConstants = LuaConstants.luaFBAdapterInterfaceConstants(socket,
						ifl.getSockets(), ifl.getPlugs().size());
		...
		}
		{
			...
			for (final AdapterDeclaration plug : _plugs) {
				CharSequence _luaFBAdapterInterfaceConstants_1 = LuaConstants.luaFBAdapterInterfaceConstants(plug,
						ifl.getPlugs(), 0);
	...
	public static CharSequence luaFBAdapterInterfaceConstants(final AdapterDeclaration adapter, final EList<?> ifl,
		...
		_builder.newLineIfNotEmpty();
		{
			...
			for (final Event decl : _eventOutputs) {
				_builder.append("local ");
				CharSequence _luaAdapterOutputEventName = LuaConstants.luaAdapterOutputEventName(decl,
						adapter.getName());
		...
		}
		{
			...
			for (final Event decl_1 : _eventInputs) {
				_builder.append("local ");
				CharSequence _luaAdapterInputEventName = LuaConstants.luaAdapterInputEventName(decl_1,
						adapter.getName());
				_builder.append(_luaAdapterInputEventName);
				_builder.append(" = ");
				_builder.append(
						((LuaConstants.FB_AD_FLAG | (adapterID << 16)) | aifl.getEventInputs().indexOf(decl_1)));
				_builder.newLineIfNotEmpty();
			}
		}
		{
			...
			for (final VarDeclaration decl_2 : _outputVars) {
				_builder.append("local ");
				CharSequence _luaFBAdapterOutputVarName = LuaConstants.luaFBAdapterOutputVarName(decl_2,
						adapter.getName());
				_builder.append(_luaFBAdapterOutputVarName);
				_builder.append(" = ");
				_builder.append((((LuaConstants.FB_AD_FLAG | LuaConstants.FB_DO_FLAG) | (adapterID << 16))
						| aifl.getOutputVars().indexOf(decl_2)));
				_builder.newLineIfNotEmpty();
			}
		}
		{
			...
			for (final VarDeclaration decl_3 : _inputVars) {
				_builder.append("local ");
				CharSequence _luaFBAdapterInputVarName = LuaConstants.luaFBAdapterInputVarName(decl_3,
						adapter.getName());
				_builder.append(_luaFBAdapterInputVarName);
				_builder.append(" = ");
				_builder.append((((LuaConstants.FB_AD_FLAG | LuaConstants.FB_DI_FLAG) | (adapterID << 16))
						| aifl.getInputVars().indexOf(decl_3)));
				_builder.newLineIfNotEmpty();
			}
		}
		return _builder;
	...
	public static CharSequence luaFBAdapterVariablesPrefix(final Iterable<AdapterVariable> variables) {
		StringConcatenation _builder = new StringConcatenation();
		{
			for (final AdapterVariable av : variables) {
				...
				_builder.newLineIfNotEmpty();
				{
					boolean _not = (!(ListExtensions.<AdapterVariable, VarDeclaration>map(sublist,
							((Function1<AdapterVariable, VarDeclaration>) (AdapterVariable it) -> {
								return it.getVar();
							})).contains(av.getVar())
							&& ListExtensions.<AdapterVariable, AdapterDeclaration>map(sublist,
									((Function1<AdapterVariable, AdapterDeclaration>) (AdapterVariable it) -> {
										return it.getAdapter();
									})).contains(av.getAdapter())));
					if (_not) {
						_builder.append("local ");
						CharSequence _luaAdapterVariable = LuaConstants.luaAdapterVariable(av.getVar().getName(),
								av.getAdapter().getName());
						_builder.append(_luaAdapterVariable);
						_builder.append(" = fb[");
						CharSequence _xifexpression = null;
						boolean _isIsInput = av.getVar().isIsInput();
						if (_isIsInput) {
							_xifexpression = LuaConstants.luaFBAdapterInputVarName(av.getVar(),
									av.getAdapter().getName());
						} else {
							_xifexpression = LuaConstants.luaFBAdapterOutputVarName(av.getVar(),
									av.getAdapter().getName());
						}
	...
	public static CharSequence luaInterfaceSpec(final InterfaceList ifl) {
		CharSequence _xblockexpression = null;
		{
			...
			CharSequence _luaStringList = LuaUtils
					.luaStringList(ListExtensions.<Event, String>map(ifl.getEventInputs(), _function));
			...
			CharSequence _luaStringList_1 = LuaUtils
					.luaStringList(ListExtensions.<Event, String>map(ifl.getEventOutputs(), _function_1));
			...
			CharSequence _luaStringList_2 = LuaUtils
					.luaStringList(ListExtensions.<VarDeclaration, String>map(ifl.getInputVars(), _function_2));
			...
			CharSequence _luaStringList_3 = LuaUtils
					.luaStringList(ListExtensions.<VarDeclaration, String>map(ifl.getOutputVars(), _function_3));
			...
			String _join = IterableExtensions
					.join(ListExtensions.<AdapterDeclaration, String>map(ifl.getPlugs(), _function_4), ",\n");
			...
			String _join_1 = IterableExtensions
					.join(ListExtensions.<AdapterDeclaration, String>map(ifl.getSockets(), _function_5), ",\n");
	...
	public static CharSequence luaInternalVarsInformation(final BasicFBType type) {
		...
		CharSequence _luaStringList = LuaUtils
				.luaStringList(ListExtensions.<VarDeclaration, String>map(type.getInternalVars(), _function));
		_builder.append(_luaStringList, "  ");
		_builder.append(",");
		_builder.newLineIfNotEmpty();
		_builder.append("  ");
