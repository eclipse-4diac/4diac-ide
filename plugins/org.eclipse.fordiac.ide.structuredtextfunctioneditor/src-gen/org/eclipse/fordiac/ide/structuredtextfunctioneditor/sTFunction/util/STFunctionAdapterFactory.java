...
public class STFunctionAdapterFactory extends AdapterFactoryImpl
{
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.fordiac.ide.structuredtextfunctioneditor.sTFunction.FunctionDefinition <em>Function Definition</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
