...
/**
 * @brief Action to move one event backwards in the replay navigator
 */
public class MoveOneEventBackwards extends Action {

	private final GraphicalViewer viewer;

	public MoveOneEventBackwards(final GraphicalViewer viewer) {
		this.viewer = viewer;
	}
