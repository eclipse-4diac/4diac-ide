...
public final class ContractKeywords {
	...
	static final String INTERVAL_DIVIDER = ","; //$NON-NLS-1$
	...
	static final String ASSUMPTION = "ASSUMPTION"; //$NON-NLS-1$
	static final String UNIT_OF_TIME = "ms"; //$NON-NLS-1$
	...
	static final String GUARANTEE = "GUARANTEE"; //$NON-NLS-1$
