...
public class FordiacNatureMarkerResolutionGenerator implements IMarkerResolutionGenerator2 {
	...
	public IMarkerResolution[] getResolutions(final IMarker marker) {
		...
		case FordiacNature.MISSING_PROJECT_BUILDER ->
			new IMarkerResolution[] { new MissingProjectBuilderMarkerResolution() };
	...
	public boolean hasResolutions(final IMarker marker) {
		...
		return FordiacNature.class.getName().equals(FordiacErrorMarker.getSource(marker))
				&& (FordiacNature.MISSING_EXPORT_BUILDER == code || FordiacNature.MISSING_PROJECT_BUILDER == code);
	}
}
