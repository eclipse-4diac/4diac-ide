...
public class SubAppNetworkBreadCrumbEditorDescriptor implements ITypeEditorPageDescriptor {

	@Override
	public boolean handlesType(final LibraryElement type) {
		return type instanceof SubAppType;
	}

	@Override
	public ITypeEditorPage createEditorPage() {
		return new SubAppNetworkBreadCrumbEditor();
	}
