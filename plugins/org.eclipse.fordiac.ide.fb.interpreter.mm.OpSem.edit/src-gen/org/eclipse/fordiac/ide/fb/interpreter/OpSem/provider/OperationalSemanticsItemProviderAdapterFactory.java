...
public class OperationalSemanticsItemProviderAdapterFactory extends OperationalSemanticsAdapterFactory
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link org.eclipse.fordiac.ide.fb.interpreter.OpSem.TransferData} instances.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 */
	protected TransferDataItemProvider transferDataItemProvider;
	...
	public Adapter createTransferDataAdapter() {
		if (transferDataItemProvider == null) {
			transferDataItemProvider = new TransferDataItemProvider(this);
		}

		return transferDataItemProvider;
	}
	...
	public void dispose() {
		...
		if (transferDataItemProvider != null)
			transferDataItemProvider.dispose();
		if (fbTransactionItemProvider != null)
