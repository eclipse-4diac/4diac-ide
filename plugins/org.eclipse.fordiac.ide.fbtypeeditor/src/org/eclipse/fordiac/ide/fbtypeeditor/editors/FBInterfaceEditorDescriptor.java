...
public class FBInterfaceEditorDescriptor implements ITypeEditorPageDescriptor {

	@Override
	public boolean handlesType(final LibraryElement type) {
		return type instanceof FBType && !(type instanceof SubAppType);
	}

	@Override
	public ITypeEditorPage createEditorPage() {
		return new FBInterfaceEditor();
	}
