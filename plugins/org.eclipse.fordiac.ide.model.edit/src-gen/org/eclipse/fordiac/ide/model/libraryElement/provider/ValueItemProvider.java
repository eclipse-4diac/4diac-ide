...
/** This is the item provider adapter for a {@link org.eclipse.fordiac.ide.model.libraryElement.Value} object. <!--
...
public class ValueItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Value_value_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Value_value_feature", "_UI_Value_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						LibraryElementPackage.Literals.VALUE__VALUE, true, false, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Value_type") : //$NON-NLS-1$
