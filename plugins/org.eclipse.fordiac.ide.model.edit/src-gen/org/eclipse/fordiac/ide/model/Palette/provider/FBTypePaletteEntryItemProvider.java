...
public class FBTypePaletteEntryItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FBTypePaletteEntry"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_FBTypePaletteEntry_type") :
			getString("_UI_FBTypePaletteEntry_type") + " " + label;
	}
