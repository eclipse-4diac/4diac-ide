...
/**
 * This is the item provider adapter for a {@link org.eclipse.fordiac.ide.model.libraryElement.TextSourceElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextSourceElementItemProvider 
	 ...
	 * @generated
	 */
	public TextSourceElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((TextSourceElement)object).getText();
		return label == null || label.length() == 0 ?
			getString("_UI_TextSourceElement_type") : //$NON-NLS-1$
			getString("_UI_TextSourceElement_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TextSourceElement.class)) {
