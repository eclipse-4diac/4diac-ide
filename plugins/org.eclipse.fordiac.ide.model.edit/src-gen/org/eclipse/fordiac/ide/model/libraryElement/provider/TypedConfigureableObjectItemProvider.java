...
public class TypedConfigureableObjectItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypedConfigureableObject_paletteEntry_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TypedConfigureableObject_paletteEntry_feature", "_UI_TypedConfigureableObject_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TypedConfigureableObject"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_TypedConfigureableObject_type") :
			getString("_UI_TypedConfigureableObject_type") + " " + label;
	}
