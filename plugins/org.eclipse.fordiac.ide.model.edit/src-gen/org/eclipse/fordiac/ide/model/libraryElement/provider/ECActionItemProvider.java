 ...
 * @generated
 */
public class ECActionItemProvider extends BaseECActionItemProvider {
	/**
	...
	public String getText(final Object object) {
		final ECAction action = (ECAction) object;
		String label = " "; //$NON-NLS-1$
		if ((null != action.getAlgorithm()) && (action.getAlgorithm() != null && !action.getAlgorithm().isEmpty())) {
			label += action.getAlgorithm() + "/"; //$NON-NLS-1$
		}

		if ((null != action.getOutput())
				&& (action.getOutput().getName() != null && !action.getOutput().getName().isEmpty())) {
