...
/**
 * This is the item provider adapter for a {@link org.eclipse.fordiac.ide.model.buildpath.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BuildpathPackage.Literals.ATTRIBUTE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BuildpathPackage.Literals.ATTRIBUTE__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		...
		try {
			return overlayImage(object, getResourceLocator().getImage("full/obj16/Attribute_" + attribute.getName())); //$NON-NLS-1$
	...
	public String getText(Object object) {
		final Attribute attribute = (Attribute) object;
		try {
			final String name = getString("_UI_Attribute_name_" + attribute.getName()); //$NON-NLS-1$
			final String value = attribute.getValue();
			return name + ": " + (value != null && value.length() != 0 ? value : "(empty)"); //$NON-NLS-1$ //$NON-NLS-2$
		} catch(final MissingResourceException e) {
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Attribute.class)) {
			case BuildpathPackage.ATTRIBUTE__NAME:
			case BuildpathPackage.ATTRIBUTE__VALUE:
