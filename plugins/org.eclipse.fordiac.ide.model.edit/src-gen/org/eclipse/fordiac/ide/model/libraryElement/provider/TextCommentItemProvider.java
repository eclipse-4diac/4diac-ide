...
/**
 * This is the item provider adapter for a {@link org.eclipse.fordiac.ide.model.libraryElement.TextComment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextCommentItemProvider 
	 ...
	 * @generated
	 */
	public TextCommentItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((TextComment)object).getText();
		return label == null || label.length() == 0 ?
			getString("_UI_TextComment_type") : //$NON-NLS-1$
			getString("_UI_TextComment_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TextComment.class)) {
