 ...
 * @generated
 */
public class SegmentTypeItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SegmentType"));
	}
	...
	public String getText(Object object) {
		String label = ((SegmentType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SegmentType_type") :
			getString("_UI_SegmentType_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LibraryElementPackage.Literals.SEGMENT_TYPE__VAR_DECLARATION,
