...
public class DirectlyDerivedTypeItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DirectlyDerivedType"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_DirectlyDerivedType_type") :
			getString("_UI_DirectlyDerivedType_type") + " " + label;
	}
