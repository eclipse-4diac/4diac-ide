...
/** This is the item provider adapter for a {@link org.eclipse.fordiac.ide.model.libraryElement.ConfigurableObject}
 * object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated */
public class ConfigurableObjectItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/** This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated */
	public ConfigurableObjectItemProvider(AdapterFactory adapterFactory) {
	...
	/** This returns ConfigurableObject.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated */
	@Override
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ConfigurableObject_type") : //$NON-NLS-1$
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConfigurableObject.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(LibraryElementPackage.Literals.CONFIGURABLE_OBJECT__ATTRIBUTES,
