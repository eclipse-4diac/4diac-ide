...
public class GlobalConstantsSyntacticSequencer extends AbstractSyntacticSequencer {

	protected GlobalConstantsGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (GlobalConstantsGrammarAccess) access;
