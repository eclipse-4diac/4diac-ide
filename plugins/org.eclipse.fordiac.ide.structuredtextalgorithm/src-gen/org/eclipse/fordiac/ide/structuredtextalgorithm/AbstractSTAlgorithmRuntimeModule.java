...
import org.eclipse.fordiac.ide.structuredtextalgorithm.scoping.STAlgorithmScopeProvider;
...
public abstract class AbstractSTAlgorithmRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/eclipse/fordiac/ide/structuredtextalgorithm/STAlgorithm.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.eclipse.fordiac.ide.structuredtextalgorithm.STAlgorithm");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("stalg");
	}
	...
	public Class<? extends IGrammarAccess> bindIGrammarAccess() {
		return STAlgorithmGrammarAccess.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISemanticSequencer> bindISemanticSequencer() {
		return STAlgorithmSemanticSequencer.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISyntacticSequencer> bindISyntacticSequencer() {
		return STAlgorithmSyntacticSequencer.class;
	}
	...
	public Class<? extends IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return STAlgorithmAntlrTokenFileProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Class<? extends Lexer> bindLexer() {
		return InternalSTAlgorithmLexer.class;
	}
	...
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Provider<? extends InternalSTAlgorithmLexer> provideInternalSTAlgorithmLexer() {
		return LexerProvider.create(InternalSTAlgorithmLexer.class);
	}
	...
	public Class<? extends IScopeProvider> bindIScopeProvider() {
		return STAlgorithmScopeProvider.class;
	}
