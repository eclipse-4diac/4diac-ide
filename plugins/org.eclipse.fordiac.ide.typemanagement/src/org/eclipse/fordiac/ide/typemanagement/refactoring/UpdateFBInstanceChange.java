...
public class UpdateFBInstanceChange extends AbstractCommandChange<BlockFBNetworkElement> {

	protected final TypeEntry typeEntry;

	public UpdateFBInstanceChange(final BlockFBNetworkElement instance, final TypeEntry typeEntry) {
