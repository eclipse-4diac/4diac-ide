...
public class CopyTypeChange extends AbstractCommandChange<LibraryElement> {

	private final String newPackageName;
	private String oldPackageName;

	protected CopyTypeChange(final String newPackageName, final String name, final URI uri) {
