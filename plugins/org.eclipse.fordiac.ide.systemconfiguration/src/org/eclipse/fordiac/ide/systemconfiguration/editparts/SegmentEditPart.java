...
public class SegmentEditPart extends AbstractViewEditPart implements NodeEditPart {
	...
	public class SegmentFigure extends BorderedRoundedRectangle implements InteractionStyleFigure, IFontUpdateListener {
		...
		public SegmentFigure() {
			...
			setOutline(false);
			setCornerDimensions(
					new Dimension(GefPreferenceConstants.CORNER_DIM * 2, GefPreferenceConstants.CORNER_DIM * 2));
			setBorder(new RectangleDropShadowBorder(GefPreferenceConstants.CORNER_DIM * 2));
			final GridLayout rectLayout = new GridLayout(3, false);
			rectLayout.marginHeight = 2;
			rectLayout.marginWidth = 0;
			setLayoutManager(rectLayout);
			...
			setConstraint(typeLabel, new GridData(GridData.HORIZONTAL_ALIGN_BEGINNING | GridData.GRAB_HORIZONTAL));
