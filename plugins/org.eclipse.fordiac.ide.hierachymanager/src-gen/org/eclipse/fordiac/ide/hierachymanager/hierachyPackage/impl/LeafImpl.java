 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fordiac.ide.hierachymanager.hierachyPackage.impl.LeafImpl#getRef <em>Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LeafImpl extends NodeImpl implements Leaf {
	...
	protected EClass eStaticClass() {
		return HierachPackagePackage.Literals.LEAF;
	}
	...
	public void setRef(String newRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HierachPackagePackage.LEAF__REF, oldRef, ref));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HierachPackagePackage.LEAF__REF:
				return getRef();
		}
