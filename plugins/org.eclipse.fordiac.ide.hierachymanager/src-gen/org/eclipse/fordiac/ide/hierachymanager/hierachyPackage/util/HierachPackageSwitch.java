 ...
 *  *******************************************************************************
 */
package org.eclipse.fordiac.ide.hierachymanager.hierachyPackage.util;
...
import org.eclipse.fordiac.ide.hierachymanager.hierachyPackage.*;
 ...
 * @generated
 */
public class HierachPackageSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static HierachPackagePackage modelPackage;
	 ...
	 * @generated
	 */
	public HierachPackageSwitch() {
		if (modelPackage == null) {
			modelPackage = HierachPackagePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HierachPackagePackage.LEVEL: {
			...
			case HierachPackagePackage.ROOT_LEVEL: {
				RootLevel rootLevel = (RootLevel)theEObject;
				T result = caseRootLevel(rootLevel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HierachPackagePackage.NODE: {
				Node node = (Node)theEObject;
				T result = caseNode(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HierachPackagePackage.LEAF: {
