...
:
	(
		{ before(grammarAccess.getFunctionDefinitionAccess().getCodeSTStatementsParserRuleCall_4_0()); }
		ruleSTStatements
		{ after(grammarAccess.getFunctionDefinitionAccess().getCodeSTStatementsParserRuleCall_4_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
