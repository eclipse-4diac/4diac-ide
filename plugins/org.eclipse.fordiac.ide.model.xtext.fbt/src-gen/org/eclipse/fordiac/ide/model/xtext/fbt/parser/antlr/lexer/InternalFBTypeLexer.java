package org.eclipse.fordiac.ide.model.xtext.fbt.parser.antlr.lexer;
...
public class InternalFBTypeLexer extends Lexer {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            ...
            // InternalFBTypeLexer.g:14:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalFBTypeLexer.g:14:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
