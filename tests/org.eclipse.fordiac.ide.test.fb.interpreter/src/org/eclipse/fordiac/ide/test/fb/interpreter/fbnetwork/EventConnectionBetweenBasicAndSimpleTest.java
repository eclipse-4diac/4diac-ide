 ...
 * parallel by E_SPLIT) */
public class EventConnectionBetweenBasicAndSimpleTest extends AbstractInterpreterTest {
	...
	public void test() throws IllegalTraceException {
		...
		final SubApp subApp = network.getSubAppNamed("Ex5a"); //$NON-NLS-1$
		...
		expectedTs.add(new FBTransactionBuilder("SimpleIO.REQ").addOutputEvent("SimpleIO.CNF", "DO1:=1")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
