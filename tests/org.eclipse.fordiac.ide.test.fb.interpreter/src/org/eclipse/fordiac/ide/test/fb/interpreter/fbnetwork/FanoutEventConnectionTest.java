 ...
 * parallel by E_SPLIT) */
public class FanoutEventConnectionTest extends AbstractInterpreterTest {
	...
	public void test() throws IllegalTraceException {
		...
		final SubApp subApp = network.getSubAppNamed("Ex2a"); //$NON-NLS-1$
		...
		expectedTs.add(new FBTransactionBuilder("E_MERGE.EI1").addOutputEvent("E_MERGE.EO"));//$NON-NLS-1$ //$NON-NLS-2$
		expectedTs.add(new FBTransactionBuilder("E_MERGE.EI2").addOutputEvent("E_MERGE.EO"));//$NON-NLS-1$ //$NON-NLS-2$
